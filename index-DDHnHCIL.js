...
var kn = (n,t,s)=>xr(n, typeof t != "symbol" ? t + "" : t, s);
import {j as e, r as p, R as ae} from "https://app.notpx.app/assets/react-DjWS3H3h.js";
import {r as Ze, c as yr} from "https://app.notpx.app/assets/react-dom-DCoj3sTC.js";
import {c as ie, a as B, b as Lt, d as Ta, e as Vt, i as ce, f as vr} from "https://app.notpx.app/assets/@reduxjs-K2ahyHOo.js";
...
import {d as ge} from "https://app.notpx.app/assets/@ton-CABtnvlX.js";
import {u as l, a as _, P as br} from "https://app.notpx.app/assets/react-redux-uubI8uR8.js";
import {c as R} from "https://app.notpx.app/assets/classnames-D-x1NdaJ.js";
import {u as bn, a as jn, b as jr, c as Pr, T as Cr, d as Nr} from "https://app.notpx.app/assets/@tonconnect-5rsNs4Y3.js";
import {u as Ps, e as Cs, a as Ns} from "https://app.notpx.app/assets/@react-spring-BiYD2lL6.js";
...
import {u as J, S as Tr, a as G, b as Qs} from "https://app.notpx.app/assets/react-router-skDq-tWz.js";
import {c as Ft} from "https://app.notpx.app/assets/chroma-js-CHvE9HB5.js";
import {m as gn, A as Ea} from "https://app.notpx.app/assets/framer-motion-BggZOsGS.js";
...
const Gt = Oo
  ...
  , rc = n=>`${n.includes("@") ? "" : "@"}${n}`
  , Ka = n=>n.replace("@", "")
  , Pn = (n,t=18,s=!0)=>n.slice(0, t) + (n.length > t && s ? "..." : "")
  , Cn = n=>{
  ...
  , pn = n=>new Promise(t=>setTimeout(t, n))
  , cc = n=>{
  ...
  , Ho = ie({
    ...
    reducers: {
        addColor: (n,t)=>{
            ...
            a !== t.payload && Gt.save("colors", JSON.stringify(n.latest))
        }
        ,
        setColors: (n,t)=>{
            n.latest = t.payload
  ...
  , {addColor: mc, setColors: Ac, setActiveColor: ka} = Ho.actions
  , hc = Ho.reducer;
class Q {
...
const Pc = {
  ...
  , qn = B("shop/getProducts", async()=>(await Q.getProducts()).data)
  , Ln = B("shop/useProduct", async({pixelId: n, productId: t, color: s})=>(await Q.useProduct({
    pixelId: n,
    productId: t,
    color: s
})).data)
  ...
  , {setProductCard: qe, showProductCard: Le, hideProductCard: Ra, increaseAmount: mB, decreaseAmount: AB, setAmount: zs, setAvailable: Cc, addAvailable: Un, subAvailable: Hs, setSelectedCurrency: _n, setLimitedGoods: hB, clearLimitedGoods: gB, showLimitedGoodsPopup: Nc, hideLimitedGoodsPopup: _B} = Xo.actions
  , Ua = n=>n.shop.crypto
  , Sc = Xo.reducer
  , qs = {
    getProducts: qn,
  ...
  , Sn = ({fontSize: n=18, className: t="", style: s={}})=>e.jsx("span", {
  ...
  , ei = (n,t)=>sa[n] ? sa[n](n, t) : sa.default()
  ...
  , rl = ()=>!1
  , ti = ()=>window.location.hostname.includes("dev")
  , cl = ()=>ti() ? rn.VITE_ADSGRAM_BLOCK_ID : il() ? "4853" : "4995"
  , fn = {
    isDev: rl(),
    devServer: ti(),
    devUserInitData: rn.VITE_INIT_DATA || null,
    devWallet: rn.VITE_DEV_WALLET || null,
  ...
  , ul = {
    ...
    os: "unknown",
    platform: "unknown",
    fullscreen: window.Telegram.WebApp.isVersionAtLeast("8.0") || fn.isDev,
    safeAreaInset: ll(),
  ...
  , {setDeviceInfo: pl, setFullscreen: ml} = ni.actions
  , $e = n=>n.device.platform
  , Al = n=>n.device.os
  , Jt = n=>n.device.fullscreen
...
, ()=>!1)
  ...
  , Vn = B("user/getVerificatedWallet", async()=>(await Q.getVerificatedWallet()).data)
  , Gn = B("user/checkCaptcha", async({wallet: n, captcha: t})=>(await Q.checkCaptcha({
    wallet: n,
    captcha: t
})).data)
  , Xn = B("user/checkHasCaptchaCode", async()=>(await Q.checkHasCaptchaCode()).data)
  , Jn = B("user/getUserPixels", async({offset: n, limit: t})=>(await Q.getUserPixels({
    offset: n,
    limit: t
})).data)
  , Yn = B("user/getPixelsForSaleTotal", async()=>(await Q.getUserPixelsCount()).data)
  , Wn = B("user/getUserPixelsSold", async({offset: n, limit: t},s)=>(await Q.getUserPixelsSold({
    offset: n,
    limit: t
})).data)
  , Kn = B("user/getUser", async(n,{rejectWithValue: t})=>{
    try {
  ...
  , ai = ie({
    ...
    extraReducers: n=>{
        n.addCase(Jn.pending, t=>{
            t.pixelsForSaleFetchStatus = u.pending
        }
        ).addCase(Jn.fulfilled, (t,s)=>{
            Ss.upsertMany(t.pixelsForSale, s.payload.pixels),
            ...
            Is.upsertMany(t.pixelsSold, s.payload.pixels),
  ...
  , {setLanguageCode: ad, setVerificatedWallet: od, setPixelsForSaleOffset: fB, setPixelsForSaleTotal: id, setPixelsForSaleFetchStatus: xB, removePixelsForSale: yB, setPixelsSoldOffset: vB, setPixelsSoldTotal: wB, setPixelsSoldFetchStatus: bB, removePixelsSold: jB, setShowRobotPopup: rd, addPixelCoins: PB, subtractPixelCoins: cd, setPixelCoins: oi, updateUserSquad: ld} = ai.actions
  , dt = n=>n.user.user
  , dd = ai.reducer
  , ze = {
    getPixelsForSale: Jn,
    ...
    getPixelsSold: Wn,
    getVerificatedWallet: Vn,
    checkCaptcha: Gn,
    checkHasCaptchaCode: Xn,
    getUser: Kn
}
  , ud = ()=>{
    const n = _()
  ...
  , {addToast: M, removeToast: so} = ii.actions
  , hd = ii.reducer
  , gd = ()=>{
    const n = _()
      , t = l($e)
...
const Zn = B("mining/info", async()=>(await Ls.info()).data)
  , $n = B("mining/claim", async()=>(await Ls.claim()).data)
  , es = B("mining/checkTask", async({key: n})=>(await Ls.checkTask({
    key: n
})).data)
  , ts = B("mining/checkBoost", async({key: n})=>(await Ls.checkBoost({
    key: n
})).data)
  , Kd = {
    info: null,
  ...
  , {setCheckError: CB, setActiveTab: Zd, setToggleAction: $d, setAllToggleActions: eu, setMaxCharges: tu, setRechargeSpeed: nu, setCharges: su, addCharges: ci, addAddedCharges: au, subCharges: ou, restoreCharges: NB, setTask: iu} = ri.actions
  , ru = ri.reducer
  , vt = {
    info: Zn,
    claim: $n,
  ...
  , xn = ({size: n=11, className: t="", style: s={}, color: a="white", ...o})=>e.jsx("img", {
    alt: "",
    className: t,
    style: {
        width: `${n}px`,
  ...
  , Yt = ({show: n, setShow: t, children: s})=>{
...
const Fa = Ts.getSelectors(n=>n.daily.list);
Qa.getSelectors(n=>n.reward.list);
const pu = Es.getSelectors(n=>n.ratings.pixanos)
  , li = mn.getSelectors(n=>n.tournament.approvedTemplatesList)
  ...
  , ct = ({x: n, y: t})=>n + t * T.width + 1
  , yn = ({x: n, y: t, width: s, blockSize: a=4})=>(n + t * s) * a
  ...
  , Ht = (n,t,s)=>("#" + (1 << 24 | n << 16 | t << 8 | s).toString(16).slice(1)).toUpperCase()
  , vn = n=>!(n.x < 0 || n.y < 0 || n.x > T.width - 1 || n.y > T.height - 1)
  , ns = B("canvas/repaint", async({pixelId: n, newColor: t})=>(await Q.startRepaint({
    pixelId: n,
    newColor: t
})).data);
let Mt = null;
const va = B("canvas/getPixelInfo", async({id: n})=>(Mt !== null && (Mt.abort(),
Mt = null),
...
(await Q.getPixelInfo({
  ...
  , ss = B("canvas/getPrices", async()=>(await Q.getPrices()).data)
  , as = B("canvas/getPriceMask", async({price: n})=>{
  ...
  , gu = ()=>Mo() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"),
!0) : !0
  , _u = {
    coords: null,
    animations: gu(),
  ...
  , di = ie({
    ...
    reducers: {
        setCoords: (n,t)=>{
            vn(t.payload) && (n.coords = t.payload)
        }
        ,
        ...
        ,
        addPaintCoords: (n,t)=>{
            vn(t.payload) && (n.stats = ct(t.payload) ^ 3201282)
        }
    },
    extraReducers: n=>{
        n.addCase(va.pending, t=>{
  ...
  , {setCoords: qt, enableAnimations: fu, disableAnimations: xu, addPaintCoords: yu, setPriceMask: SB, setSelectedPrice: IB, updatePixelInfo: TB} = di.actions
  , vu = di.reducer
  , Vs = {
    getPixelInfo: va,
    getPriceMask: as,
...
class wu {
    ...
    drawLine({x: t, y: s}) {
        ...
        this.line.moveTo(T.width - .5, s).lineTo(t + .5, s),
        this.line.moveTo(t, T.width - .5).lineTo(t, s + .5),
        this.line.zIndex = 10,
...
const Pe = {
  ...
  , {setProgressCommand: We} = ui.actions
  , ju = ui.reducer
...
const Qu = "_order_panel_dvy5p_1"
  ...
  , pi = n=>n ? n.friends >= ac.friendsForTemplateCreation || n.isContractor : !1
  , Ke = {
    create: "create",
    main: "main",
    result: "result",
...
class De {
    static async uploadTemplate({blob: t, posX: s, posY: a}) {
        ...
        return s && s !== "" && (o.posX = s),
        a && a !== "" && (o.posY = a),
        C.post("/image/template/upload", t, {
            headers: o
        })
    }
...
const os = B("tournament/getPeriods", async()=>(await mi.getPeriods()).data)
  , is = B("tournament/getResults", async()=>(await mi.getResults()).data)
  , rs = B("tournament/getMyTemplate", async({id: n})=>(await De.getTournamentTemplateById({
    id: n
})).data)
  , cs = B("tournament/getSelectedTemplate", async()=>(await De.getSelectedTemplate()).data)
  , ls = B("tournament/getApprovedTemplatesList", async({offset: n, limit: t})=>(await De.getApprovedTemplatesList({
    offset: n,
    limit: t
})).data)
  , ds = B("tournament/getRandomTemplatesList", async()=>(await De.getRandomTemplates()).data)
  , us = B("tournament/selectTemplate", async({id: n})=>(await De.subscribeToTournamentTemplate({
    id: n
})).data)
  , dp = {
    activeTab: Ke.result,
    ...
    approvedTemplatesList: mn.getInitialState(),
  ...
  , Ai = ie({
    ...
    reducers: {
        ...
        clearApprovedTemplateList: n=>{
            n.approvedTemplatesList = mn.getInitialState(),
    ...
    extraReducers: n=>{
        n.addCase(rs.pending, t=>{}
            ...
            s.payload && s.payload.list && (mn.addMany(t.approvedTemplatesList, s.payload.list.map(a=>({
                ...a,
                url: `${a.url}${en}`
            }))),
            ...
            s.payload && s.payload.list && mn.setAll(t.approvedTemplatesList, s.payload.list.map(a=>({
                ...a,
                url: `${a.url}${en}`
            }))),
  ...
  , {setActiveTournamentTab: oo, setActiveTournamentTemplate: up, hideTournamentTemplates: pp, setShowTournamentDetailsPopup: hi, setShowRoundRewardsPopup: gi, changeTemplateCoordsIfNeeded: _i, setMyTournamentTemplate: BB, clearApprovedTemplateList: fi, showTournamentTemplateInfoPopup: za, closeTournamentTemplateInfoPopup: ca, setSelectedTemplate: xi} = Ai.actions
  , Fe = {
    getMyTemplate: rs,
...
const yp = (n,t,s)=>{
    ...
    Ue = new Sr(Da.replace("https", "wss").replace("api/v1/", "connection/websocket"),o),
    Ue.on("connected", function(i) {
        ...
        c.onload = ()=>{
            j.mainImage.loadFromCentrifuge(c).then(()=>{
                ...
                j.mainImage.selectedPixel.draw(m),
                Xe.dispatch(qt(m)))
            }
            )
        }
    ...
    Ue.on("publication", function(i) {
        if (i.channel === "event:message") {
            JSON.parse(new TextDecoder().decode(i.data)).forEach(d=>{
                ...
                if (d.type === ta.pixanos && Xe.dispatch(jp(m)),
                m.user.userId === t || !wn)
                    return;
                const h = Xe.getState().canvas.animations;
                if (d.type === ta.bomb) {
                    const g = Bs(m.info.pixelId);
  ...
  , yi = ie({
    ...
    reducers: {
        ...
        setLastShowChargesPopupTs: (n,t)=>{
            ...
            Gt.save("lastShowChargesPopupTs", JSON.stringify(t.payload))
        }
        ,
  ...
  , {setTimeLimit: DB, updateSettings: kB, enableFastMode: vi, disableFastMode: Js, enableFastType: Ys, disableFastType: wt, enableFastEnergy: bp, disableFastEnergy: wi, setShowPixanosRating: da, showPixanosEvent: jp, hidePixanosEvent: Pp, setPixanosProcessing: io, setShowIntro: RB, setShowBetaTestIntro: UB, setShowMiniPopup: OB, addFlyingReward: MB, removeFlyingReward: QB, showNoChargesPopup: FB, hideNoChargesPopup: ua, setLastShowChargesPopupTs: zB, setShowMiningDetailsPopup: Cp, setShowBoostDetailsPopup: HB, setActiveBoostDetails: qB, addItemToUserAndSquadPopupStack: Tn, removeItemFromUserAndSquadPopupStack: bi, setShowNoFlagsPopup: LB, setReferrerSquadId: ja} = yi.actions
  , Np = yi.reducer;
Ta(n=>n.main.settings, n=>{
...
const Sp = "_layout_oxfjd_1"
  ...
  , Mp = ()=>{
    ...
    return p.useEffect(()=>{
        const A = ()=>{
            ...
            const g = Date.now()
              , x = Math.floor((g - i) / r) - o.current;
            x > 0 && s.current < c && (n(ci(x)),
            n(au(x)));
            let v = (g - i) % r;
            m(v * 100 / r),
            h = requestAnimationFrame(A)
  ...
  , En = ({number: n, fontSize: t=16, fontWeight: s=600, gap: a=6, addSpace: o=!0})=>{
    if (n === void 0)
        return null;
  ...
  , {setIsTMA: pm, setIsAuth: mm, setAuthData: Am} = ji.actions
  , Ha = n=>n.auth.isTMA
  , ke = n=>n.auth.isAuth
  , hm = ji.reducer;
let pa = !1;
const gm = async({dispatch: n, amount: t, charges: s, maxCharges: a, status: o, state: i})=>{
  ...
  , {setShowSideMenu: gt} = Pi.actions
  , Ci = n=>n.layout.isShowSideMenu
  , xm = Pi.reducer;
let Tt = null
  , Et = null;
class qa {
...
const ps = B("ratings/personal", async({league: n, offset: t, limit: s})=>(await qa.personal({
    league: n,
    offset: t,
    limit: s
})).data)
  , ms = B("ratings/squad", async({league: n, offset: t, limit: s})=>(await qa.squad({
    league: n,
    offset: t,
    limit: s
})).data)
  , As = B("ratings/pixanos", async({offset: n, limit: t})=>(await qa.pixanos({
    offset: n,
    limit: t
})).data)
  , ym = {
  ...
  , Ni = ie({
    ...
    extraReducers: n=>{
        n.addCase(ps.pending, (t,s)=>{
            ...
            s.payload.rating && Es.setMany(t.pixanos, s.payload.rating),
  ...
  , {setActiveLeague: Si, clearRatingList: Ii, setSelectedSection: Ti, clearPixanosRatingList: vm} = Ni.actions
  , ft = {
    personal: ps,
    squad: ms,
    pixanos: As
  ...
  , wm = Ni.reducer
  , hs = B("history/get", async({offset: n, limit: t})=>(await Q.getHistory({
    offset: n,
    limit: t
})).data)
  , bm = {
...
bt.startListening({
    ...
    effect: (n,t)=>{
        ...
        t.dispatch(oi(n.payload.userBalance))),
...
bt.startListening({
    ...
    effect: (n,t)=>{
        ...
        Gt.save("boosts1", JSON.stringify(a))
    }
});
const Ws = Vt();
Ws.startListening({
...
Bi.startListening({
    ...
    effect: (n,t)=>{
        t.dispatch(Si(n.payload.data.league))
    }
});
const Bn = Vt();
Bn.startListening({
...
const Pm = {
  ...
  , gs = B("squad/getSquadInfo", async({id: n})=>(await Q.getSquadInfo({
    id: n
})).data)
  , Di = ie({
    name: "squad",
...
const Cm = Di.reducer
  ...
  , _s = B("template/getTemplateList", async({offset: n, limit: t})=>(await De.getTemplatesList({
    offset: n,
    limit: t
})).data)
  ...
  , fs = B("template/getReferredTemplate", async()=>(await De.getReferredTemplate()).data)
  , Pa = B("template/getMyTemplate", async({id: n})=>(await De.getTemplateById({
    id: n
})).data)
  , xs = B("template/getWorldTemplate", async()=>({
    x: 0,
    y: 0,
    imageSize: T.width,
    url: Nm,
  ...
  , ki = ie({
    ...
    reducers: {
        setActiveTemplate: (n,t)=>{
            ...
            j.mainImage.worldTemplate.show(t.payload)
        }
        ,
  ...
  , {setActiveTemplate: VB, setActiveTemplateTab: ro, hideTemplates: Ri, setTemplateOpacity: GB, setReferredTemplate: Em, setMyTemplate: Bm, setTemplateListOffset: XB, clearTemplatesListData: Dm, setShowTemplateDetailsPopup: Ui, setShowTemplateInfoPopup: Ca} = ki.actions
  , lt = {
  ...
  , ys = B("daily/getList", async()=>(await Q.getDailyList()).data)
  , vs = B("daily/getFirstDaily", async()=>(await Q.getFirstDaily()).data)
  , Oi = ie({
    name: "daily",
    initialState: Rm,
    reducers: {
    ...
    extraReducers: n=>{
        n.addCase(ys.pending, t=>{
            ...
            Ts.setAll(t.list, s.payload.dailyAvailable),
  ...
  , {setSelectedDaily: Om, updateOneDaily: JB, setShowHowDailyWorksPopup: Mi} = Oi.actions
  , Mm = Oi.reducer
  , Qi = {
    getList: ys,
    getFirstDaily: vs
}
  , ws = B("reward/getList", async({userId: n})=>(await Q.getRewards({
    userId: n
})).data)
  ...
  , {setReward: Fm, clearReward: YB, addReward: WB, removeReward: KB, clearInventoryList: zm, showRewardPopup: Hm, hideRewardPopup: ZB} = Fi.actions
  , qm = {
    getListByUserId: ws
}
  , Lm = Fi.reducer
...
Wt.startListening({
    matcher: ce(Fe.getSelectedTemplate.fulfilled, xi),
    effect: (n,t)=>{
        const s = t.getState();
...
Wt.startListening({
    ...
    effect: n=>{
        ...
        j.mainImage.tournamentTemplates.show(t)
    }
});
Wt.startListening({
    matcher: ce(pp),
...
const Dn = vr({
    ...
    devTools: !1,
    middleware: n=>[Bn.middleware, Bi.middleware, Ws.middleware, bt.middleware, Va.middleware, Wt.middleware, ...n()]
})
  , bs = []
  , Vm = async({dispatch: n, flyCoords: t, paintCoords: s, activeColor: a})=>{
    ...
    try {
        ...
        console.log(c),
        c && c.balance && (n(oi(c.balance)),
        c.reward_user && (j.mainImage.reward.add(s),
        n(Fm({
  ...
  , zi = async({history: n, charges: t, dispatch: s, flyCoords: a, paintCoords: o, pixelInfo: i, user: r, activeColor: c, state: d})=>{
    let m = !1;
    if (t <= 0)
        if (d && d.main.fastEnergy) {
            if (bs.length > 0 && !(await Promise.allSettled(bs)).every(g=>g.status === u.fulfilled || g.status === u.rejected))
                return;
            const A = await gm({
                dispatch: s,
                state: d
...
class Ym {
    constructor({app: t, viewport: s, store: a, mainImage: o}) {
        kn(this, "isCoordsInExtraRewardZone", ({coords: t, x1: s, y1: a, imageSize: o})=>{
            const {x: i, y: r} = t
              , c = s + o
              , d = a + o;
    ...
    isExtraRepaintReward({coords: t, repaintColor: s}) {
        for (let a = 0; a < this.items.length; a++) {
            ...
            const i = yn({
              ...
              , r = Ht(o.imageData[i], o.imageData[i + 1], o.imageData[i + 2])
              , c = o.imageData[i + 3]
            ...
            for (let o = 0; o < s.imageSize; o++) {
                ...
                for (let i = 0; i < s.imageSize; i++) {
                    const r = yn({
                      ...
                      , c = Ht(s.imageData[r], s.imageData[r + 1], s.imageData[r + 2]);
...
const Wm = async({coords: n, dispatch: t, repaintReward: s, amount: a, state: o})=>{
  ...
  , Km = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      ...
      , c = [S.button, S.fast_type_button];
    return o === "bomb" && c.push(S.fast_mode_button_enabled),
    s ? e.jsxs("button", {
        className: `${c.join(" ")} ${S.shop_button}`,
        onPointerUp: ()=>{
            if (o === "bomb") {
  ...
  , $m = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      , r = 10 + String(a).length * 6
      , c = [S.button, S.fast_type_button];
    return o === "paintcan" && c.push(S.fast_mode_button_enabled),
    s ? e.jsxs("button", {
        className: `${c.join(" ")} ${S.shop_button}`,
        onPointerUp: ()=>{
            if (o === "paintcan") {
...
const vA = async({coords: n, dispatch: t, repaintReward: s, amount: a, state: o})=>{
  ...
  , wA = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      , r = 10 + String(a).length * 6
      , c = [S.button, S.fast_type_button];
    return o === "pumpkin" && c.push(S.fast_mode_button_enabled),
...
class PA {
    ...
    addBackdrop() {
        ...
        this.backdrop.drawRect(0, 0, T.width, T.height),
    ...
    getRepaintRewardType({coords: t, repaintColor: s}) {
        ...
        for (let i = 0; i < this.items.length; i++) {
            ...
            const c = yn({
              ...
              , d = Ht(r.imageData[c], r.imageData[c + 1], r.imageData[c + 2])
              , m = r.imageData[c + 3]
...
class NA {
    ...
    async loadChunk({chunkIndex: t}) {
        const s = T.chunkOrder[t]
          , a = await this.loadImage(`${Da}image/block?block_id=${s}`)
    ...
    paintSquare({x: t, y: s, size: a, colors: o}) {
        for (let i = 0; i < o.length; i++) {
            ...
            if (c.x < 0 || c.y < 0 || c.x > T.width || c.y > T.height)
                continue;
            const d = yn({
                x: c.x,
                y: c.y,
...
Ze.createPortal(e.jsx("canvas", {
    ...
    return p.useEffect(()=>{
        function a(o) {
            o.ctrlKey && o.altKey && o.keyCode === 67 && (async()=>{
                try {
                    await Nn(window.Telegram.WebApp.initData),
                    await n(M({
                        id: performance.now(),
                        text: "Copied!"
                    }))
  ...
  , th = ({selectedSection: n, setSelectedSection: t})=>e.jsx("div", {
    className: Aa.panel,
    children: [Ds.squad, Ds.user].map(s=>e.jsx("div", {
...
null)
  ...
  , Wh = ()=>{
    ...
    return e.jsxs(ee, {
        children: [e.jsx(Lh, {}), e.jsx(th, {
            ...
            children: [t === Ds.squad && e.jsx(Fh, {}), t === Ds.user && e.jsx(Bh, {}), a !== u.fulfilled && o === 0 && e.jsx(zh, {}), e.jsx(Yh, {
                selectedSection: t
            })]
        })]
    })
  ...
  , Kh = ()=>{
    ...
    , []);
    const s = ()=>{
        performance.now() - t.current < 200 && j.viewport.zoomIn(),
        clearInterval(n.current)
    }
    ;
    return e.jsx("button", {
  ...
  , Zh = ()=>{
    const n = p.useRef(null)
      , t = p.useRef(null)
      , s = ()=>{
        performance.now() - t.current < 200 && j.viewport.zoomOut(),
        clearInterval(n.current)
    }
    ;
    return p.useEffect(()=>()=>{
...
, backgroundColor: a})=>{
  ...
  , Ig = ()=>{
    ...
    if (!t)
        return null;
    const o = [S.button, S.shop_button, S.fast_type_button];
    return e.jsxs("button", {
        className: o.join(" "),
        onPointerUp: ()=>{
            if (s || a)
  ...
  , Eg = ()=>l(t=>t.canvas.coords) ? e.jsx("div", {
    className: po.layout,
    children: e.jsxs("div", {
        className: po.container + " " + S.container__bottom,
    ...
    e.jsxs("div", {
        ...
        children: [n && e.jsxs("div", {
            ...
            onPointerUp: async r=>{
                var d, m;
                r.stopPropagation(),
                await Nn(`${yt}?startapp=x${o.x}_y${o.y}`) ? (m = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || m.notificationOccurred("success") : a(!0),
                t(!1),
  ...
  , jt = ({address: n, limit: t=0, display: s=null})=>{
    ...
    e.jsx("span", {
        ...
        onPointerUp: i=>{
            i.stopPropagation(),
            a ? ue(`https://t.me/${Ka(n)}`) : Cn(`https://t.me/${Ka(n)}`)
        }
        ,
        children: o
    })
  ...
  , s_ = ()=>{
    ...
    const o = Pn(n.owner.firstName || "No name");
    return (()=>{
  ...
  , Vi = ({colors: n})=>e.jsx("div", {
    className: Li.color_line,
  ...
  , M_ = ()=>{
    ...
    return t !== u.fulfilled ? null : e.jsxs(ae.Fragment, {
        children: ["  ", e.jsx(D, {
            size: 14,
            className: a ? we.winning : we.loosing,
            children: ""
        }), " ", e.jsx("span", {
            className: a ? we.winning : we.loosing,
            children: i
            ...
            size: 14,
            className: s ? we.winning : we.loosing,
            children: ""
        }), " ", e.jsx("span", {
            className: s ? we.winning : we.loosing,
            children: o
  ...
  , Q_ = ()=>{
    const n = l(et)
      , t = l(mp)
      , s = t ? Gi(new Date(t.EndTime)) : null;
    return e.jsxs("span", {
        className: we.text,
        children: [e.jsxs("span", {
            className: we.gold,
  ...
  , F_ = ()=>{
    const n = J()
      , t = l(et)
      , s = l(Ap);
    return Gi(s ? new Date(s.StartTime) : null),
    e.jsx("div", {
        className: we.layout,
        onPointerUp: ()=>{
            n.push("/tournament")
  ...
  , uf = ({item: n})=>e.jsxs("div", {
    ...
    children: [e.jsxs("div", {
        ...
        className: f.value_container,
        children: ["-", n.details.price, " ", e.jsx(Sn, {
            fontSize: 14
        })]
    })]
})
...
null)
                ...
                children: [e.jsx("div", {
                    ...
                    children: e.jsxs("ol", {
                        children: [e.jsx("li", {
                            ...
                            children: ["Get rewarded in", " ", e.jsx(xn, {
                                size: 14,
                                style: {
  ...
  , Yf = ()=>e.jsxs(ee, {
    children: [e.jsx("div", {
        ...
        children: e.jsxs("button", {
            className: an.button,
            onPointerUp: ()=>{
                Cn("https://ton.org/en/open-league")
            }
            ,
  ...
  , Kt = ({url: n, className: t="", text: s="Copy referral link"})=>{
...
e.jsx("div", {
    ...
    children: e.jsx("div", {
        ...
        children: Lx.map((n,t)=>{
            ...
            return e.jsx("div", {
                className: Fn.stars,
                style: {
                    animation: `${Fn.animStar} ${n.speed}s linear infinite`,
                    boxShadow: s
                }
            }, t)
        }
    ...
    return p.useEffect(()=>{
        try {
            ...
            Q.getMoreStats().then(v=>{
                ...
                A(y.daily_users),
                g(y.daily_repaints),
                x(Object.keys(y.top_countries).map(N=>({
                    key: N,
  ...
  , Ji = "/assets/button_dog_200x200-DtCBiZdv.gif"
  , dy = n=>{
    const t = n / 1e3
      , s = Math.floor(t / 60)
      , a = t % 60;
  ...
  , Vy = ({secondsLeft: n})=>{
    ...
    p.useEffect(()=>{
        ...
        if (x) {
            ...
            v.dailyId === a.id && Date.now() - v.ts < 10 * 60 * 1e3 ? h(!0) : h(!1),
            Date.now() - v.ts >= 10 * 60 * 1e3 && localStorage.removeItem(s)
        }
    }
    , [a]);
    const b = async()=>{
    ...
    if (r) {
        ...
        return n && (v = `Claim in ${dc(n)}`),
        A && (v = "Pending transaction..."),
        e.jsxs("div", {
            className: k.content,
            children: [e.jsx("div", {
  ...
  , lv = ()=>{
    ...
    return p.useEffect(()=>{
        (i === u.idle || i === u.rejected) && n(Qi.getList())
    }
    , [i]),
    p.useEffect(()=>{
        let r = 0;
            ...
            children: [e.jsx("div", {
                ...
                children: e.jsx("div", {
                    ...
                    children: t.map((r,c)=>{
                        ...
                        d && g.push(k.reward_item_title_premium),
                        d && !r.active && h.push(k.reward_item_amount_premium);
                        let b = Gy;
                        return c >= 8 && c <= 15 && (b = Xy),
                        c >= 16 && c <= 23 && (b = Jy),
                        c >= 24 && c <= 31 && (b = Yy),
                        e.jsxs("div", {
                            className: A.join(" "),
        ...
        children: [e.jsx("div", {
            ...
            children: i.map(r=>{
                ...
                e.jsx("div", {
                    className: c.join(" "),
                    onPointerUp: ()=>{
                        o >= Rs[r] || a.isContractor ? t(r) : s(M({
                            id: performance.now(),
                            text: `To unlock this size, invite ${Rs[r] - o} more frens.`
                        }))
                    }
                    ,
                    children: `${r} X ${r}`
  ...
  , Jv = ()=>{
    const n = J()
      ...
      , s = l(o=>o.user.user)
      , a = s && s.friends >= Rs[16] || s.isContractor;
    return t !== null ? null : e.jsxs("div", {
        ...
        children: [a && e.jsx("span", {
            ...
            className: "gray",
            children: ["To unlock template creation, ", e.jsx("br", {}), " invite", " ", s && s.friends || 0, "/", Rs[16], " friends"]
        }), a && e.jsx("button", {
  ...
  , Yi = ({item: n, style: t={}})=>{
    const s = _();
    return e.jsx("div", {
        className: on.template_item_container,
        style: {
            ...t
        },
        onPointerUp: async()=>{
            n.templateId && n.templateId !== 0 && s(Ca({
                show: !0,
        ...
        ,
        children: e.jsxs("div", {
            className: on.template_item_inner,
            children: [e.jsx("img", {
                alt: "image",
                className: on.template_image,
                src: n.url
            }), e.jsx("div", {
                className: on.template_image_info_layout,
                children: e.jsxs("div", {
                    className: on.template_image_info_container,
                    children: [e.jsx(D, {
                        children: ""
                    }), e.jsx("span", {
                ...
                try {
                    if (t && t !== 0) {
                        ...
                        (await n(lt.subscribe({
                            ...
                            n(Em(A)),
                            j.mainImage.worldTemplate.deleteTemplate(i.id),
                            j.mainImage.worldTemplate.add(A),
                            n(Ri())
                        } else
                            await n(M({
  ...
  , d1 = ({isPopupContent: n=!0})=>{
    ...
    const o = Pn(t.firstName || "No name");
    return e.jsx("div", {
        className: U.text_container,
        children: e.jsx("span", {
            className: U.user_name,
  ...
  , $i = ({data: n, ready: t})=>{
    ...
    const a = (()=>{
        var o;
        return Pn(((o = n == null ? void 0 : n.squad) == null ? void 0 : o.name) || "No name")
    }
    )();
    return e.jsx("div", {
        className: E.text_container,
  ...
  , Pb = n=>{
    ...
    for (let s = 0; s < t.length; s += 4) {
        ...
        let c = Te[0]
          , d = 1 / 0;
        for (const A of Te) {
            const h = Ft.deltaE(Ft(Ht(a, o, i)), Ft(A));
            h < d && (d = h,
            c = A)
        }
        const m = ht(c);
            ...
            onPointerUp: async()=>{
                try {
                    ...
                    if ((await De.uploadTemplate({
                        ...
                        o(Bm(b)),
                        o(Ri()),
                        await j.mainImage.worldTemplate.add(b),
                        o(M({
                            id: performance.now(),
  ...
  , Nb = ({templateSize: n, setTemplateSize: t, coords: s, setCoords: a})=>(p.useState([16, 32, 64, 128]),
e.jsxs("div", {
  ...
  , lj = ({show: n, setShow: t})=>{
    const s = _()
      ...
      , i = bn()
      , r = Fo(i)
      , c = l(v=>v.mining.tasks[P.walletVerification])
      , d = l(v=>v.user.verificatedWallet)
      , m = zo(d)
      , A = ya(m)
      , h = l(v=>v.user.hasCaptchaCode)
      , [g,b] = p.useState("")
      , x = async()=>{
        try {
            if (d !== r) {
                s(M({
                    id: performance.now(),
                    text: `Use ${ya(A)} wallet`
                })),
                await o.disconnect();
                return
            }
            const v = ge.beginCell().storeUint(0, 32).endCell()
              , y = {
                validUntil: Math.floor(Date.now() / 1e3) + 600,
                messages: [{
            ...
            children: [e.jsxs("div", {
                ...
                onPointerUp: async()=>{
                    ...
                    if (!(!g || g === "")) {
                        ...
                        try {
                            const y = await s(ze.checkCaptcha({
                                wallet: r,
                                captcha: g
                            }));
                            if (y.meta.requestStatus === u.rejected)
                                throw new Error("error");
                            if ((v = y.payload) != null && v.success)
                                s(M({
                                    id: performance.now(),
                                    text: "Success!",
                                    icon: ""
  ...
  , sr = ()=>{
    ...
    return p.useEffect(()=>{
        ...
        !i || s !== u.fulfilled || r && m && (g = r == null ? void 0 : r.connectItems) != null && g.tonProof && !("error"in r.connectItems.tonProof) && Q.checkTonProof(r.connectItems.tonProof.proof, r.account).then(b=>{
            if (b.status === 200 && b.data.success)
                n(od(Fo(c))),
                n(M({
                    id: performance.now(),
                    text: "Success!",
                ...
                b.data && b.data.error && (x = b.data.error),
                n(M({
                    id: performance.now(),
                    text: x
                }))
  ...
  , gj = ()=>{
    const {handleConnect: n, formattedVerificatedWalletUQ: t} = sr()
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: e.jsxs("div", {
                                children: ["Total balance: 100 000 ", e.jsx(xn, {})]
                            })
                        }), e.jsx(fo, {
                            success: r
                        })]
  ...
  , r0 = ({dataUrl: n, loading: t, templateSize: s})=>e.jsx("div", {
  ...
  , c0 = ({templateSize: n, setTemplateSize: t})=>{
    ...
    return p.useEffect(()=>{
        if (s !== null) {
            ...
            const x = async()=>{
                ...
                v.width = d,
                v.height = d,
                y.drawImage(s, z, Re, pe, xe);
                const Pt = y.getImageData(0, 0, d, d);
                Bj(Pt),
                y.putImageData(Pt, 0, 0),
                i(Pt),
                c(v.toDataURL())
            }
            ;
  ...
  , rr = ({children: n, variant: t=hn.dark, onPointerUp: s=()=>{}
, style: a={}, className: o=void 0, disabled: i=!1})=>e.jsx("button", {
  ...
  , vP = ({children: n, variant: t=hn.dark, onPointerUp: s=()=>{}
, style: a={}, className: o=void 0, disabled: i=!1, status: r=u.idle, offset: c, limit: d, total: m})=>{
    const A = c >= m && r !== u.pending
      , h = r === u.pending
      , g = A ? hn.disabled : h ? hn.loading : t;
    return e.jsx(rr, {
        variant: g,
        onPointerUp: A ? ()=>{}
        : s,
  ...
  , eC = ({template: n, style: t={}, onPointerUp: s=()=>{}
})=>{
    const a = _()
        ...
        onPointerUp: async()=>{
            try {
                ...
                (await a(Fe.selectTemplate({
                    id: n.id
                }))).meta.requestStatus === u.fulfilled && a(xi(n))
            } catch (r) {
  ...
  , lC = ({size: n, style: t={}, animation: s=!1})=>e.jsx("img", {
    alt: "image",
    src: cC,
...
, ()=>!1)
  ...
  , NC = ()=>{
    const n = _()
      , s = l(Jt) ? "calc(12px + var(--safe-area-top))" : "calc(12px + var(--header-height))";
    return e.jsxs("button", {
        className: vo.button,
        style: {
            top: s
    ...
    p.useEffect(()=>{
        (async()=>{
            ...
            y.status === 200 && y.data && y.data.forEach(N=>{
                N.group_name === zn.Ghost && d({
                    count: N.usage_count,
                    limit: N.limit
                }),
                N.group_name === zn.Mythical && A({
                    count: N.usage_count,
                    limit: N.limit
                }),
                N.group_name === zn.Magical && g({
                    count: N.usage_count,
                    limit: N.limit
                }),
                N.group_name === zn.Dogs && x({
                    count: N.usage_count,
                    limit: N.limit
                })
            }
...
const UN = ()=>{
    ...
    return p.useEffect(()=>{
        ...
        n.pathname !== Po && (n.pathname === "/" ? window.Telegram.WebApp.BackButton.hide() : window.Telegram.WebApp.BackButton.show(),
        Po = n.pathname),
        ()=>{
  ...
  , QN = ()=>{
    ...
    return p.useEffect(()=>{
        ...
        const A = h=>{
            a === null && (a = h);
            const b = (h - a) / r;
            i !== h && (o = Math.min(b * c, c),
            n.current && (n.current.style.width = `${o}%`)),
            i = h,
            o < c && (d = requestAnimationFrame(A))
        }
        ;
        return t === Pe.start && (d = requestAnimationFrame(A),
        n.current && (n.current.style.display = "block")),
        t === Pe.finish && (n.current && (n.current.style.width = "100%"),
        m = setTimeout(()=>{
  ...
  , j2 = p.memo(({runParticle: n, setRunParticle: t})=>{
    const [s,a] = p.useState(b2())
      , [o,i] = p.useState(!1);
    return p.useEffect(()=>{
        n && setTimeout(()=>{
            i(!0),
  ...
  , S2 = ({setError: n, setRunParticle: t})=>{
    var xe;
    const s = _()
      ...
      , x = (xe = l(z=>z.shop.products[a]).prices.filter(z=>z.currency_id === o)[0]) == null ? void 0 : xe.price
      , v = bn();
    if (l(z=>z.shop.selectedCurrency) === 1 || v === "")
        return null;
    const N = async z=>{
      ...
      , pe = async z=>{
        const Re = new ea.HttpProvider("https://toncenter.com/api/v2/jsonRPC")
          ...
          , mr = ge.Address.parse(v)
          , Ar = ge.Address.parse(xa)
          , hr = ge.beginCell().storeUint(0, 32).storeStringTail(z.txMemCode).endCell();
        let $s = ge.toNano(z.strAmount);
        Number(o) === 4 && ($s = $s / 1000n);
        const gr = ge.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins($s).storeAddress(Ar).storeAddress(mr).storeBit(0).storeCoins(ge.toNano("0.01")).storeBit(1).storeRef(hr).endCell()
          , _r = {
            validUntil: Math.floor(Date.now() / 1e3) + 600,
            messages: [{
  ...
  , E2 = ({setError: n, setRunParticle: t})=>{
    const s = _()
            ...
            try {
                ...
                v.status === 200 && ((x = v == null ? void 0 : v.data) == null ? void 0 : x.ok) === !0 && window.Telegram.WebApp.openInvoice(v.data.result, y=>{
                    ...
                    if (y === "paid") {
                        ...
                        m(!0),
                        (xe = (pe = window.Telegram.WebApp) == null ? void 0 : pe.HapticFeedback) == null || xe.notificationOccurred("error"),
                        t(!0)
                    } else
                        n("Error, try again.")
                }
...
const M2 = ()=>{
    ...
    return o ? null : e.jsxs("div", {
        ...
        children: [e.jsx(fa.Range, {
            ...
            onChange: x,
            onFinalChange: v,
            renderTrack: ({props: y, children: N})=>e.jsx("div", {
            ...
            renderThumb: ({props: y, isDragged: N})=>p.createElement("div", {
                ...y,
                key: y.key,
                style: {
                    ...y.style,
...
async function pS() {
    ...
    w.viewport(0, 0, w.canvas.width, w.canvas.height),
    ve = await mS(w),
    w.useProgram(ve)
}
...
function hS(n) {
    ...
    w.texImage2D(w.TEXTURE_2D, 0, w.RGBA, w.RGBA, w.UNSIGNED_BYTE, t);
    const a = w.getUniformLocation(ve, "u_Texture");
    w.uniform1i(a, 0)
}
function gS() {
    const n = new ImageData(T.width,T.height);
    return n.data.set(j.mainImage.imageData.slice(0)),
    n
}
function _S(n) {
...
function fS(n) {
    const {viewportWidth: t, viewportHeight: s, textureWidth: a, textureHeight: o, textureLeft: i, textureTop: r, min: c} = _S(n);
    js = c * c,
    Je(w, ve, "u_AnimationDuration", lr),
    Je(w, ve, "u_ParticleSize", lS),
    Je(w, ve, "u_ViewportWidth", t),
    Je(w, ve, "u_ViewportHeight", s),
    Je(w, ve, "u_TextureWidth", a),
    Je(w, ve, "u_TextureHeight", o),
    Je(w, ve, "u_TextureLeft", i),
    Je(w, ve, "u_TextureTop", r);
    const d = new Array(js);
    for (let h = 0; h < js; h++)
        d[h] = h;
    const m = w.createBuffer();
    w.bindBuffer(w.ARRAY_BUFFER, m),
    w.bufferData(w.ARRAY_BUFFER, new Float32Array(d), w.STATIC_DRAW);
    const A = w.getAttribLocation(ve, "a_ParticleIndex");
    w.enableVertexAttribArray(A),
    w.vertexAttribPointer(A, 1, w.FLOAT, !1, 0, 0)
}
function dr() {
...
function xS(n) {
    ...
    Je(w, ve, "u_ElapsedTime", s),
    w.drawArrays(w.POINTS, 0, js),
    dr()
}
function Je(n, t, s, a) {
...
const yS = ()=>{
    ...
    if (p.useEffect(()=>{
        s && a && (async()=>{
            ...
            n.push("/"),
            j.mainImage.pixanosRepaint(a.info.seed, T.width, a.info.percentage, a.info.color),
            (d = (c = window.Telegram.WebApp) == null ? void 0 : c.HapticFeedback) == null || d.notificationOccurred("error")
        }
        )()
    }
  ...
  , KS = ()=>{
    ...
    return e.jsx(ut, {
        ...
        children: e.jsxs("div", {
            ...
            ,
            children: [t.dataSource === Ie.userFromPixelInfo && e.jsx(Sa, {
                isPopupContent: s
            }), t.dataSource === Ie.userFromRating && e.jsx(Sa, {
                isPopupContent: s
  ...
  , BI = ({values: n, setValues: t})=>e.jsx("div", {
    className: Do.layout,
    children: e.jsx("div", {
...
null)
        ...
        children: e.jsxs("div", {
            ...
            children: [e.jsx("div", {
                ...
                children: e.jsx("button", {
                    className: fe.button,
                    onPointerUp: ()=>{
                        n ? ue("https://t.me/notpixel_channel") : Cn("https://t.me/notpixel_channel")
                    }
                    ,
  ...
  , HT = ()=>e.jsxs("div", {
    className: cn.loading_container,
    children: [e.jsx("div", {
        className: cn.image_container,
        children: e.jsx("img", {
            alt: "img",
            src: zT,
            className: cn.image
  ...
  , VT = ()=>{
    const n = J();
    p.useEffect(()=>{
        Mo() ? localStorage.getItem("skipIntro") || (n.push("/welcome"),
        localStorage.setItem("skipIntro", "true")) : Gt.get("skipIntro", (t,s)=>{
  ...
  , WT = ()=>{
    ...
    p.useEffect(()=>{
        if (j) {
            ...
            j.app.renderer.resize(a, o),
            j.viewport.viewport.resize(a, o)
        }
    }
    , [s]),
    null
...
const ln = window.Telegram.WebApp.Accelerometer
  , dn = window.Telegram.WebApp.DeviceOrientation
  , un = window.Telegram.WebApp.Gyroscope
  , KT = new Promise(n=>{
    ln.start(null, t=>n(t))
}
)
...
const tE = ()=>{
  ...
  , nE = ({children: n})=>{
    ...
    const t = l(c=>c.main.timeLimit)
      ...
      , a = s === u.rejected && !fn.app.disableBetaError
      , o = s === u.pending || s === u.idle
      , i = t;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(sc) && ST(),
    qT(),
    LT(),
    VT(),
    a || i ? e.jsx(FT, {}) : o ? e.jsx(HT, {}) : e.jsx(e.Fragment, {
        children: n
    })
}
  , sE = ()=>{
...
function aE() {
    ...
    window.Telegram.WebApp.isVersionAtLeast("8.0") || window.Telegram.WebApp.version === "6.0" && window.Telegram.WebApp.platform === "unknown" ? e.jsx(nE, {
        children: e.jsx(CT, {})
    }) : e.jsx(sE, {})
}
const oE = {
...
ic(Dn);
xp(Dn);
const lE = yr.createRoot(document.getElementById("root"));
