...
import {r as st, c as dc} from "https://app.notpx.app/assets/react-dom-DCoj3sTC.js";
import {c as ge, a as z, b as Dn, d as Ya, e as sn, i as xe, f as uc} from "https://app.notpx.app/assets/@reduxjs-K2ahyHOo.js";
import {a as mc} from "https://app.notpx.app/assets/axios-BdInfei4.js";
...
import {u as c, a as g, s as Ac, P as pc} from "https://app.notpx.app/assets/react-redux-BljSBgeC.js";
import {c as R} from "https://app.notpx.app/assets/classnames-D-x1NdaJ.js";
import {u as kn, a as hc, b as gc, c as Hs, T as _c, d as fc} from "https://app.notpx.app/assets/@tonconnect-C4go9-2N.js";
import {d as $e} from "https://app.notpx.app/assets/@ton-CABtnvlX.js";
import {u as Ds, e as ks, a as Rs} from "https://app.notpx.app/assets/@react-spring-BiYD2lL6.js";
import {C as xc} from "https://app.notpx.app/assets/centrifuge-B3TpHLNx.js";
import {d as vc} from "https://app.notpx.app/assets/fflate-DRb3BoOD.js";
import {u as J, S as yc, a as ae, b as Ys} from "https://app.notpx.app/assets/react-router-skDq-tWz.js";
import {c as en} from "https://app.notpx.app/assets/chroma-js-CHvE9HB5.js";
import {m as Sn, A as Xa} from "https://app.notpx.app/assets/framer-motion-BggZOsGS.js";
import {u as ze, T as la, i as wc} from "https://app.notpx.app/assets/react-i18next-DUbAQzaN.js";
import {l as kt} from "https://app.notpx.app/assets/react-range-COVt_hlT.js";
import {T as da} from "https://app.notpx.app/assets/tonweb-BaiZR3hJ.js";
import {B as jc} from "https://app.notpx.app/assets/react-router-dom-DSUFG-Qy.js";
import {i as bc} from "https://app.notpx.app/assets/i18next-vSwsns86.js";
...
const an = mo
  ...
  , Ao = t=>new Promise(n=>setTimeout(n, t))
  , Kc = t=>{
  ...
  , ho = ge({
    ...
    reducers: {
        addColor: (t,n)=>{
            ...
            a !== n.payload && an.save("colors", JSON.stringify(t.latest))
        }
        ,
        setColors: (t,n)=>{
            t.latest = n.payload
  ...
  , {addColor: sl, setColors: al, setActiveColor: Za} = ho.actions
  , il = ho.reducer;
class V {
...
z("main/startTransaction", async({pixelId: t, newColor: n, buyerWallet: s})=>(await V.startTransaction({
    pixelId: t,
    newColor: n,
    buyerWallet: s
})).data);
const hl = {
  ...
  , Kn = z("shop/useProduct", async({pixelId: t, productId: n, color: s})=>(await V.useProduct({
    pixelId: t,
    productId: n,
    color: s
})).data)
  ...
  , {setProductCard: at, showProductCard: it, hideProductCard: Ka, increaseAmount: G3, decreaseAmount: L3, setAmount: Xs, setAvailable: gl, addAvailable: $t, subAvailable: Vs, setSelectedCurrency: Tn, setLimitedGoods: q3, clearLimitedGoods: H3, showLimitedGoodsPopup: _l, hideLimitedGoodsPopup: Y3} = vo.actions
  , Ws = t=>t.shop.crypto
  , fl = vo.reducer
  , Js = {
    getProducts: Zn,
  ...
  , rn = ({fontSize: t=18, className: n="", style: s={}})=>e.jsx("span", {
  ...
  , Hl = ({item: t, active: n, amount: s=1, type: a="sale"})=>{
    var d;
    const i = g()
  ...
  , {setDeviceInfo: nd, setFullscreen: sd} = Po.actions
...
, ()=>!1)
  ...
  , es = z("user/getUserPixels", async({offset: t, limit: n})=>(await V.getUserPixels({
    offset: t,
    limit: n
})).data)
  , ts = z("user/getPixelsForSaleTotal", async()=>(await V.getUserPixelsCount()).data)
  , ns = z("user/getUserPixelsSold", async({offset: t, limit: n},s)=>(await V.getUserPixelsSold({
    offset: t,
    limit: n
})).data)
  , ss = z("user/getUser", async(t,{rejectWithValue: n})=>{
    try {
  ...
  , To = ge({
    ...
    extraReducers: t=>{
        t.addCase(es.pending, n=>{
            ...
            Us.upsertMany(n.pixelsForSale, s.payload.pixels),
  ...
  , {setLanguageCode: Yd, setPixelsForSaleOffset: Bo, setPixelsForSaleTotal: Xd, setPixelsForSaleFetchStatus: Vd, removePixelsForSale: Wd, setPixelsSoldOffset: X3, setPixelsSoldTotal: V3, setPixelsSoldFetchStatus: W3, removePixelsSold: J3, addPixelCoins: St, subtractPixelCoins: Jd, setPixelCoins: Eo, updateUserSquad: Zd} = To.actions
  , Do = t=>{
    const n = t.user.user;
  ...
  , {addToast: H, removeToast: Pi} = ko.actions
  , au = ko.reducer
  , iu = ()=>{
    const t = g()
      , n = c(ot)
...
const as = z("mining/info", async()=>(await $s.info()).data)
  ...
  , os = z("mining/checkTask", async({key: t})=>(await $s.checkTask({
    key: t
})).data)
  , rs = z("mining/checkBoost", async({key: t})=>(await $s.checkBoost({
    key: t
})).data)
  , Gu = {
    info: null,
  ...
  , {setCheckError: Lu, setActiveTab: ka, setToggleAction: Mo, setAllToggleActions: qu, setMaxCharges: Hu, setRechargeSpeed: Yu, setCharges: Xu, addCharges: Uo, addAddedCharges: Vu, subCharges: Wu, restoreCharges: Z3, setTask: K3} = Ro.actions
  , Ju = Ro.reducer
  , fe = {
    info: as,
    claim: is,
  ...
  , F = ({size: t=11, className: n="", style: s={}, color: a="white", ...i})=>e.jsx("img", {
    alt: "",
    className: n,
    style: {
        width: `${t}px`,
  ...
  , em = ({left: t, secFromInit: n, setRunParticle: s})=>{
    const a = g()
  ...
  , Oo = m.memo(({runParticle: t, setRunParticle: n})=>{
    const [s,a] = m.useState(cm())
      , [i,o] = m.useState(!1);
    return m.useEffect(()=>{
        t && setTimeout(()=>{
            o(!0),
  ...
  , Be = ({num: t})=>isNaN(t) ? null : new Intl.NumberFormat("en-US").format(t)
  , qm = ()=>{
    const t = J()
      , n = x.invite1fren;
  ...
  , cn = ({show: t, setShow: n, children: s})=>{
    ...
    , [t]),
    a ? st.createPortal(e.jsxs(se.Fragment, {
    ...
    !_A || h || s !== "mobile" || o === !1 ? null : e.jsxs(K, {
        ...
        action: ()=>{
            d === 0 && n.show().then(w=>{
                ...
                localStorage.setItem("adsgramNextView", `${Date.now() + hA}`),
                l("task_adsgram1", {
                    props: {
                        country: r,
                        result: !0
    ...
    return m.useEffect(()=>{
        function a(i) {
            i.ctrlKey && i.altKey && i.keyCode === 67 && (async()=>{
                try {
                    await Mn(window.Telegram.WebApp.initData),
                    await t(H({
                        id: performance.now(),
                        text: "Copied!"
                    }))
...
const Lo = Nn.getSelectors(t=>t.tournament.approvedTemplatesList)
  ...
  , Tp = ({coords: t})=>e.jsxs("div", {
    className: oe.pixelCoords,
    children: [t.x, ", ", t.y]
})
  , Bp = ({color: t})=>e.jsx("div", {
  ...
  , ht = ({x: t, y: n})=>t + n * T.width + 1
  , Bn = ({x: t, y: n, width: s, blockSize: a=4})=>(t + n * s) * a
  , xa = ({index: t, width: n, blockSize: s=4})=>{
  ...
  , cs = z("canvas/repaint", async({pixelId: t, newColor: n})=>(await V.startRepaint({
    pixelId: t,
    newColor: n
})).data);
let Kt = null;
const Ra = z("canvas/getPixelInfo", async({id: t})=>(Kt !== null && (Kt.abort(),
Kt = null),
...
(await V.getPixelInfo({
  ...
  , ds = z("canvas/getPriceMask", async({price: t})=>{
  ...
  , kp = ()=>Ja() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"),
!0) : !0
  , Rp = {
    coords: null,
    animations: kp(),
  ...
  , {setCoords: Ot, enableAnimations: Mp, disableAnimations: Up, addPaintCoords: Qp, setPriceMask: $3, setSelectedPrice: Op, updatePixelInfo: eM} = Xo.actions
  , Fp = Xo.reducer
  , ea = {
    getPixelInfo: Ra,
    getPriceMask: ds,
...
class zp {
    ...
    drawLine({x: n, y: s}) {
        ...
        this.line.moveTo(T.width - .5, s).lineTo(n + .5, s),
        this.line.moveTo(n, T.width - .5).lineTo(n, s + .5),
        this.line.zIndex = 10,
...
const Oe = {
  ...
  , {setProgressCommand: mt} = Vo.actions
  , Lp = Vo.reducer
...
let sh = class {
    constructor({app: n, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 5,
        this.bombs = [qp, Hp, Yp, Xp, Vp, Wp, Jp, Zp, Kp, $p, eh, th, nh],
        this.textureArray = [];
        for (let i = 0; i < 13; i++) {
...
const ah = "_order_panel_dvy5p_1"
  ...
  , dn = ({children: t, className: n="", style: s={}})=>e.jsx("div", {
...
const us = z("tournament/getPeriods", async()=>(await Jo.getPeriods()).data)
  ...
  , As = z("tournament/getMyTemplate", async({id: t})=>(await qe.getTournamentTemplateById({
    id: t
})).data)
  , ps = z("tournament/getSelectedTemplate", async()=>(await qe.getSelectedTemplate()).data)
  , hs = z("tournament/getApprovedTemplatesList", async({offset: t, limit: n})=>(await qe.getApprovedTemplatesList({
    offset: t,
    limit: n
})).data)
  , gs = z("tournament/getRandomTemplatesList", async()=>(await qe.getRandomTemplates()).data)
  , _s = z("tournament/selectTemplate", async({id: t})=>(await qe.subscribeToTournamentTemplate({
    id: t
})).data)
  , Sh = {
    activeTab: Me.main,
  ...
  , Zo = ge({
    ...
    reducers: {
        ...
        clearApprovedTemplateList: t=>{
            t.approvedTemplatesList = Nn.getInitialState(),
  ...
  , {setActiveTournamentTab: In, setActiveTournamentTemplate: ai, hideTournamentTemplates: ii, setShowTournamentDetailsPopup: Ko, setShowRoundRewardsPopup: $o, changeTemplateCoordsIfNeeded: er, setMyTournamentTemplate: nM, clearApprovedTemplateList: tr, showTournamentTemplateInfoPopup: oi, closeTournamentTemplateInfoPopup: va, setSelectedTemplate: nr} = Zo.actions
  , Je = {
    getMyTemplate: As,
...
const Mh = (t,n,s)=>{
    ...
    ut = new xc(Wa.replace("https", "wss").replace("api/v1/", "connection/websocket"),i),
    ut.on("connected", function(o) {
    ...
    ut.on("publication", function(o) {
        if (o.channel === "event:message") {
            JSON.parse(new TextDecoder().decode(o.data)).forEach(d=>{
                ...
                if (d.type === ua.pixanos && lt.dispatch(zh(u)),
                u.user.userId === n || !En)
                    return;
  ...
  , ar = ge({
    ...
    reducers: {
        ...
        setLastShowChargesPopupTs: (t,n)=>{
            ...
            an.save("lastShowChargesPopupTs", JSON.stringify(n.payload))
        }
        ,
  ...
  , {setTimeLimit: Oh, updateSettings: sM, enableFastMode: ir, disableFastMode: ta, enableFastType: na, disableFastType: Ft, enableFastEnergy: Fh, disableFastEnergy: or, setShowPixanosRating: xs, showPixanosEvent: zh, hidePixanosEvent: Gh, setPixanosProcessing: ki, setShowIntro: aM, setShowBetaTestIntro: iM, addFlyingReward: Lh, removeFlyingReward: qh, showInviteFrensPopup: oM, hideInviteFrensPopup: ya, showNoChargesPopup: rM, hideNoChargesPopup: wa, setLastShowChargesPopupTs: cM, setShowMiningDetailsPopup: rr, setShowBoostDetailsPopup: ri, setActiveBoostDetails: Hh, addItemToUserAndSquadPopupStack: On, removeItemFromUserAndSquadPopupStack: cr, setShowNoFlagsPopup: Yh, setReferrerSquadId: Qa} = ar.actions
  , Xh = ar.reducer
  , Vh = {
    getPixanosRating: fs
}
  ...
  , Eg = ({digit: t=0, fontSize: n=16, fontWeight: s=600, gap: a=6})=>{
  ...
  , {setIsTMA: kg, setIsAuth: Rg, setAuthData: Mg} = dr.actions
  , ci = t=>t.auth.isTMA
  , He = t=>t.auth.isAuth
  , Ug = dr.reducer;
let ja = !1;
const Qg = async({dispatch: t, amount: n, charges: s, maxCharges: a, status: i, state: o})=>{
    var l, d;
    ...
    try {
        (await t(Js.useProduct({
            productId: 1,
            pixelId: 1
        }))).meta.requestStatus === p.fulfilled && (t(Xu(a)),
        t(Vs({
            product: 1,
            amount: 1
        })),
  ...
  , {setShowSideMenu: Mt} = ur.actions
  , mr = t=>t.layout.isShowSideMenu
  , zg = ur.reducer;
let Xt = null
  , Vt = null;
class Ar {
...
const vs = z("ratings/personal", async({league: t})=>(await Ar.personal({
    league: t
})).data)
  , ys = z("ratings/squad", async({league: t})=>(await Ar.squad({
    league: t
})).data)
  , Gg = {
    list: [],
  ...
  , {setActiveLeague: hr, clearRatingList: Lg} = pr.actions
  , li = {
    personal: vs,
    squad: ys
}
  , qg = pr.reducer
  , ws = z("history/get", async({offset: t, limit: n})=>(await V.getHistory({
    offset: t,
    limit: n
})).data)
  , Hg = {
...
Tt.startListening({
    ...
    effect: (t,n)=>{
        t.payload.activated && (n.dispatch(Xd(t.payload.totalUserPixels)),
        n.dispatch(Eo(t.payload.userBalance))),
        n.dispatch(gl(t.payload.goods))
    }
});
Tt.startListening({
    ...
    effect: (t,n)=>{
        ...
        if (o) {
            if (i === he.energyLimit) {
                ...
                n.dispatch(Hu(s.mining.maxCharges + d)),
                n.dispatch(Uo(d))
            }
...
const Xg = {
  ...
  , js = z("squad/getSquadInfo", async({id: t})=>(await V.getSquadInfo({
    id: t
})).data)
  , xr = ge({
    name: "squad",
...
const Vg = xr.reducer
  ...
  , Jg = z("template/subscribe", async({id: t})=>(await qe.subscribeToTemplate({
    id: t
})).data)
  , bs = z("template/getTemplateList", async({offset: t, limit: n})=>(await qe.getTemplatesList({
    offset: t,
    limit: n
})).data)
  , Zg = z("template/getAvailableSizes", async({userId: t})=>(await qe.getAvailableSizes({
    userId: t
})).data)
  , Ns = z("template/getReferredTemplate", async()=>(await qe.getReferredTemplate()).data)
  , Oa = z("template/getMyTemplate", async({id: t})=>(await qe.getTemplateById({
    id: t
})).data)
  ...
  , {setActiveTemplate: $g, setActiveTemplateTab: Ri, hideTemplates: ui, setTemplateOpacity: e_, setReferredTemplate: t_, setMyTemplate: n_, setTemplateListOffset: lM, clearTemplatesListData: s_, setShowTemplateDetailsPopup: yr, setShowTemplateInfoPopup: Fa} = vr.actions
  , It = {
  ...
  , wr = ge({
    ...
    extraReducers: t=>{
        t.addCase(Cs.pending, n=>{
            ...
            Os.setAll(n.list, s.payload.dailyAvailable),
  ...
  , {setSelectedDaily: r_, updateOneDaily: dM, setShowHowDailyWorksPopup: jr} = wr.actions
  , c_ = wr.reducer
  , br = {
    getList: Cs,
    getFirstDaily: Ps
}
  , Ss = z("reward/getList", async({userId: t})=>(await V.getRewards({
    userId: t
})).data)
  , ba = z("reward/getById", async({rewardId: t})=>(await V.getRewardById({
    rewardId: t
})).data)
  , l_ = {
    showPopup: !1,
  ...
  , {setReward: d_, clearReward: u_, addReward: uM, removeReward: mM, clearInventoryList: m_, showRewardPopup: A_, hideRewardPopup: p_} = Nr.actions
  , h_ = {
    getListByUserId: Ss
}
  , g_ = Nr.reducer
...
const Gn = uc({
  ...
  , Ts = []
  , __ = async({dispatch: t, flyCoords: n, paintCoords: s, activeColor: a})=>{
    ...
    try {
        ...
        console.log(d),
        d && d.balance && (t(Eo(d.balance)),
        d.reward_user && d.reward && (b.mainImage.reward.add(s),
        t(d_({
  ...
  , f_ = ({history: t, dispatch: n, paintCoords: s})=>{
    n(ta()),
    t && t.push("/energy-over"),
    n(Ot(s)),
    b.mainImage.selectedPixel.draw(s)
}
  , Ir = async({history: t, charges: n, dispatch: s, flyCoords: a, paintCoords: i, pixelInfo: o, user: r, activeColor: l, state: d})=>{
    let u = !1;
    if (n <= 0)
        if (d && d.main.fastEnergy) {
            if (Ts.length > 0 && !(await Promise.allSettled(Ts)).every(v=>v.status === p.fulfilled || v.status === p.rejected))
                return;
            const h = await Qg({
                dispatch: s,
                state: d
...
class y_ {
    constructor({app: n, viewport: s, store: a, mainImage: i}) {
        Ln(this, "isCoordsInExtraRewardZone", ({coords: n, x1: s, y1: a, imageSize: i})=>{
            const {x: o, y: r} = n
              , l = s + i
              , d = a + i;
...
const w_ = ({x: t, y: n})=>{
  ...
  , j_ = async({coords: t, dispatch: n, repaintReward: s, amount: a, state: i})=>{
    var r, l;
  ...
  , I_ = async({coords: t, dispatch: n, repaintReward: s, activeColor: a, amount: i, state: o})=>{
    var l, d;
...
let V_ = class {
    constructor({app: n, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 7,
        this.images = [P_, S_, T_, B_, E_, D_, k_, R_, M_, U_, Q_, O_, F_, z_, G_, L_, q_, H_, Y_, X_],
        this.textureArray = [];
...
class K_ {
    ...
    async addRewardImage(n) {
        PIXI.Loader.shared.resources.tnt || await this.loadResource("tnt", Ga),
...
class ef {
    ...
    paintSquare({x: n, y: s, size: a, colors: i}) {
        for (let o = 0; o < i.length; o++) {
            ...
            if (l.x < 0 || l.y < 0 || l.x > T.width || l.y > T.height)
                continue;
            const d = Bn({
                x: l.x,
                y: l.y,
...
function mf() {
    b = new rf({
        readyCallback: async t=>{
            ...
            s === "mobile" && i !== "unknown" && (a = await uf()),
            Mh((o = n.user.user) == null ? void 0 : o.websocketToken, (r = n.user.user) == null ? void 0 : r.id, a)
        }
    })
}
...
st.createPortal(e.jsx("canvas", {
  ...
  , pf = ({children: t, coords: n, classes: s=[]})=>{
    const a = J()
      , i = g();
    return e.jsx("div", {
  ...
  , Nf = ({title: t, children: n})=>e.jsxs(se.Fragment, {
    children: [e.jsx("div", {
  ...
  , Qf = ({price: t, isMax: n})=>n ? "Max" : e.jsxs(se.Fragment, {
    children: [e.jsx(F, {}), "  ", e.jsx("span", {
        className: Ue.price_text,
        children: t
    })]
})
  , hi = ({reward: t, level: n, price: s, isMax: a})=>{
    const {t: i} = ze();
    return e.jsx("div", {
  ...
  , ev = ({selectedSection: t, setSelectedSection: n})=>e.jsx("div", {
    className: Na.panel,
  ...
  , Dr = ({position: t, userPic: n})=>e.jsxs("div", {
...
e.jsx("div", {
  ...
  , Uv = ()=>{
    ...
    return e.jsx("button", {
        ...
        onPointerUp: ()=>{
            a !== p.pending && t(Vh.getPixanosRating()),
            t(xs(!0))
        }
        ,
        children: e.jsx("img", {
...
, backgroundColor: a})=>{
  ...
  , Cy = ({show: t, setShow: n})=>t ? st.createPortal(e.jsx("div", {
    style: {
        position: "fixed",
        left: 0,
        right: 0,
  ...
  , Oy = ()=>{
    const t = g()
      ...
      , o = [yt.button]
      , r = c(Pe);
    return c(d=>d.tournament.selectedTemplateStatus) === p.pending ? null : (i && o.push(yt.enabled),
    s || o.push(yt.animation),
    e.jsxs("button", {
        className: o.join(" "),
        onPointerUp: d=>{
            if (!s || !r) {
  ...
  , ew = ({open: t, setOpen: n, active: s, setActive: a})=>{
  ...
  , tw = ({open: t, setOpen: n, active: s, setActive: a})=>{
    const i = g()
      , o = [ce.info_button];
    ...
    e.jsxs("div", {
        ...
        children: [t && e.jsxs("div", {
            ...
            onPointerUp: async r=>{
                var d, u;
                r.stopPropagation(),
                await Mn(`${Ct}?startapp=x${i.x}_y${i.y}`) ? (u = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || u.notificationOccurred("success") : a(!0),
                n(!1),
  ...
  , Ze = ({children: t, show: n})=>n ? e.jsx("div", {
  ...
  , pn = ({address: t, limit: n=0, display: s=null})=>{
    const a = c(ci);
    if (!t || t === "")
        return e.jsx("span", {
            children: "Anon"
    ...
    e.jsx("span", {
        ...
        onPointerUp: o=>{
            o.stopPropagation(),
            a ? ee(`https://t.me/${wi(t)}`) : gt(`https://t.me/${wi(t)}`)
        }
        ,
        children: i
    })
  ...
  , Nj = ({item: t})=>t.action === "buy pixel" ? e.jsx(hj, {
    item: t
...
null)
  ...
  , zt = ({url: t, className: n="", text: s="Copy referral link"})=>{
...
e.jsx("div", {
    ...
    return m.useEffect(()=>{
        try {
            ...
            V.getMoreStats().then(j=>{
                ...
                h(U.daily_users),
                v(U.daily_repaints),
                f(Object.keys(U.top_countries).map(Q=>({
                    key: Q,
  ...
  , n0 = ({secondsLeft: t})=>{
    ...
    m.useEffect(()=>{
        ...
        if (f) {
            ...
            j.dailyId === a.id && Date.now() - j.ts < 10 * 60 * 1e3 ? _(!0) : _(!1),
            ...
            children: [e.jsx("div", {
                ...
                children: e.jsx("div", {
                    ...
                    children: n.map((r,l)=>{
                        ...
                        r.id === s && (h.push(O.reward_item_active),
                        _.push(O.reward_item_amount_active)),
                        d && v.push(O.reward_item_title_premium),
                        d && !r.active && _.push(O.reward_item_amount_premium);
                        let w = s0;
                        return l >= 8 && l <= 15 && (w = a0),
                        l >= 16 && l <= 23 && (w = i0),
                        l >= 24 && l <= 31 && (w = o0),
                        e.jsxs("div", {
                            className: h.join(" "),
  ...
  , aN = ({templateSize: t, setTemplateSize: n})=>{
    const s = g()
      , a = c(Ge)
      , i = a.friends || 64
  ...
  , NI = ({active: t, setActive: n})=>e.jsxs(dn, {
    style: {},
    children: [e.jsx(Fe, {
        active: t === "info",
        setActive: ()=>n("info"),
  ...
  , WI = ({active: t, isPopupContent: n=!0})=>e.jsxs("div", {
  ...
  , CC = ({active: t, setActive: n})=>e.jsx(dn, {
    style: {},
    children: e.jsx(Fe, {
        active: t === "info",
        setActive: ()=>n("info"),
  ...
  , EC = ({isPopupContent: t, active: n, data: s, ready: a})=>e.jsxs("div", {
  ...
  , RC = ({dataUrl: t, loading: n, templateSize: s})=>e.jsx("div", {
  ...
  , UC = ({loading: t, imageData: n, posX: s, posY: a})=>{
    const i = g()
      , o = J()
  ...
  , QC = ({templateSize: t, setTemplateSize: n, coords: s, setCoords: a})=>(m.useState([16, 32, 64, 128]),
e.jsxs("div", {
  ...
  , aS = ({dataUrl: t, loading: n, templateSize: s})=>e.jsx("div", {
  ...
  , iS = ({templateSize: t, setTemplateSize: n})=>{
    ...
    return m.useEffect(()=>{
        if (s !== null) {
            ...
            const f = async()=>{
                ...
                j.width = d,
                j.height = d,
                U.drawImage(s, X, Ke, De, ke);
                const Gt = U.getImageData(0, 0, d, d);
                SP(Gt),
                U.putImageData(Gt, 0, 0),
                o(Gt),
                l(j.toDataURL())
            }
            ;
  ...
  , vi = ({item: t, rank: n, repaints: s, style: a={}})=>{
    const i = g()
  ...
  , Zr = ({template: t, style: n={}, onPointerUp: s=()=>{}
})=>{
    const a = g()
  ...
  , O2 = ()=>{
    ...
    return c(Pe),
    !a || !s ? null : st.createPortal(e.jsx(Ye, {
        onPointerUp: ()=>t(va()),
        show: s,
        children: e.jsx("div", {
            className: ne.layout,
  ...
  , Y2 = ({size: t, style: n={}, animation: s=!1})=>e.jsx("img", {
    alt: "image",
    src: H2,
...
const vB = ()=>{
  ...
  , PE = ({setError: t, setRunParticle: n})=>{
    var ke;
    const s = g()
      ...
      , j = Hs();
    if (c(X=>X.shop.selectedCurrency) === 1 || j === "")
        return null;
    const Q = async X=>{
  ...
  , BE = ({setError: t, setRunParticle: n})=>{
    const s = g()
...
const UE = ()=>{
    ...
    return i ? null : e.jsxs("div", {
        ...
        children: [e.jsx(kt.Range, {
            ...
            onChange: v,
            onFinalChange: w,
            renderTrack: ({props: f, children: j})=>e.jsx("div", {
            ...
            renderThumb: ({props: f, isDragged: j})=>m.createElement("div", {
                ...f,
                key: f.key,
                style: {
                    ...f.style,
...
function _D(t) {
    const {viewportWidth: n, viewportHeight: s, textureWidth: a, textureHeight: i, textureLeft: o, textureTop: r, min: l} = gD(t);
    Es = l * l,
    dt(N, Se, "u_AnimationDuration", Kr),
    dt(N, Se, "u_ParticleSize", cD),
    dt(N, Se, "u_ViewportWidth", n),
    dt(N, Se, "u_ViewportHeight", s),
    dt(N, Se, "u_TextureWidth", a),
    dt(N, Se, "u_TextureHeight", i),
    dt(N, Se, "u_TextureLeft", o),
    dt(N, Se, "u_TextureTop", r);
...
function fD(t) {
    ...
    dt(N, Se, "u_ElapsedTime", s),
    N.drawArrays(N.POINTS, 0, Es),
    $r()
}
function dt(t, n, s, a) {
...
const Tk = "_container_gb8eq_1"
  ...
  , Kk = ()=>{
    ...
    return m.useEffect(()=>(Ja() && (localStorage.getItem(i) || a(!0)),
    ()=>{}
    ), [n]),
    e.jsx(Ye, {
        show: s,
...
, ()=>!1)
  , v4 = ()=>{
      ...
      , l = async()=>{
        if (i)
            ...
            a && a.user.reward_id && a.type === "goods") {
                ...
                a && a.type === "px" ? t(St(0)) : a && a.user && a.user.token
    }
    ;
    if (m.useEffect(()=>{
        const w = setTimeout(()=>{
    ...
    if (a.user.token !== "") {
        ...
        d = a.user.token,
        u = "Yo, you hit the crypto jackpot! Nice one, fam!",
        r.forEach(f=>{
...
null)
  ...
  , yR = ()=>{
    ...
    m.useEffect(()=>{
        ...
        n("colors", s=>{
            ...
            t(Za(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
        }
        ),
        n("boosts", s=>{
            t(qu(s))
  ...
  , jR = ()=>{
    ...
    m.useEffect(()=>{
        ...
        localStorage.setItem("skipIntro", "true")) : an.get("skipIntro", (n,s)=>{
  ...
  , SR = ({children: t})=>{
    ...
    const n = c(l=>l.main.timeLimit)
      ...
      , o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Xc) && oR(),
    yR(),
    wR(),
    jR(),
    a || o ? e.jsx(fR, {}) : i ? e.jsx(vR, {}) : e.jsx(e.Fragment, {
        children: t
    })
}
  , TR = ()=>{
...
function BR() {
    ...
    window.Telegram.WebApp.isVersionAtLeast("8.0") || window.Telegram.WebApp.version === "6.0" && window.Telegram.WebApp.platform === "unknown" ? e.jsx(SR, {
        children: e.jsx(sR, {})
    }) : e.jsx(TR, {})
}
const ER = {
