...
import {j as e, r as u, R as se} from "https://app.notpx.app/assets/react-DjWS3H3h.js";
import {r as Ve, c as Br} from "https://app.notpx.app/assets/react-dom-DCoj3sTC.js";
import {c as ce, a as B, b as Pt, d as za, e as tn, i as de, f as Dr} from "https://app.notpx.app/assets/@reduxjs-K2ahyHOo.js";
import {a as kr} from "https://app.notpx.app/assets/axios-BdInfei4.js";
...
import {d as xe} from "https://app.notpx.app/assets/@ton-CABtnvlX.js";
import {u as l, a as _, P as Rr} from "https://app.notpx.app/assets/react-redux-uubI8uR8.js";
import {c as R} from "https://app.notpx.app/assets/classnames-D-x1NdaJ.js";
import {C as Ur} from "https://app.notpx.app/assets/centrifuge-B3TpHLNx.js";
import {u as $, S as Or, a as G, b as Ws} from "https://app.notpx.app/assets/react-router-skDq-tWz.js";
import {d as Mr} from "https://app.notpx.app/assets/fflate-DRb3BoOD.js";
import {u as Us, e as Os, a as Ms} from "https://app.notpx.app/assets/@react-spring-BiYD2lL6.js";
import {u as Fr, a as Qr, b as nn, c as sn, T as zr, d as Hr} from "https://app.notpx.app/assets/@tonconnect-AV74pAQg.js";
import {c as Jt} from "https://app.notpx.app/assets/chroma-js-CHvE9HB5.js";
import {m as Wt, A as Ha} from "https://app.notpx.app/assets/framer-motion-BggZOsGS.js";
import {l as ut} from "https://app.notpx.app/assets/react-range-COVt_hlT.js";
import {u as Wo, i as qr} from "https://app.notpx.app/assets/react-i18next-4MQgfZKk.js";
import {T as da} from "https://app.notpx.app/assets/tonweb-BaiZR3hJ.js";
import {B as Lr} from "https://app.notpx.app/assets/react-router-dom-DSUFG-Qy.js";
import {i as Vr} from "https://app.notpx.app/assets/i18next-vSwsns86.js";
...
const an = $o
  ...
  , bn = n=>new Promise(t=>setTimeout(t, n))
  , yc = n=>{
  ...
  , Re = ["#E46E6E", "#FFD635", "#7EED56", "#00CCC0", "#51E9F4", "#94B3FF", "#E4ABFF", "#FF99AA", "#FFB470", "#FFFFFF", "#BE0039", "#FF9600", "#00CC78", "#009EAA", "#3690EA", "#6A5CFF", "#B44AC0", "#FF3881", "#9C6926", "#898D90", "#6D001A", "#BF4300", "#00A368", "#00756F", "#2450A4", "#493AC1", "#811E9F", "#A00357", "#6D482F", "#000000"]
  , ho = Re[V(0, Re.length - 1)]
  , jc = {
    active: ho,
    id: btoa(ho),
  ...
  , ai = ce({
    ...
    reducers: {
        addColor: (n,t)=>{
            ...
            a !== t.payload && an.save("colors", JSON.stringify(n.latest))
        }
        ,
        setColors: (n,t)=>{
            n.latest = t.payload
  ...
  , {addColor: Pc, setColors: Cc, setActiveColor: Ga} = ai.actions
  , Nc = ai.reducer;
class F {
...
B("main/startTransaction", async({pixelId: n, newColor: t, buyerWallet: s})=>(await F.startTransaction({
    pixelId: n,
    newColor: t,
    buyerWallet: s
})).data);
const Oc = {
  ...
  , $n = B("shop/useProduct", async({pixelId: n, productId: t, color: s})=>(await F.useProduct({
    pixelId: n,
    productId: t,
    color: s
})).data)
  ...
  , {setProductCard: Ge, showProductCard: Xe, hideProductCard: Xa, increaseAmount: ED, decreaseAmount: BD, setAmount: Ks, setAvailable: Mc, addAvailable: Gn, subAvailable: Zs, setSelectedCurrency: Sn, setLimitedGoods: DD, clearLimitedGoods: kD, showLimitedGoodsPopup: Fc, hideLimitedGoodsPopup: RD} = li.actions
  , Ya = n=>n.shop.crypto
  , Qc = li.reducer
  , $s = {
    getProducts: Zn,
  ...
  , Un = ({fontSize: n=18, className: t="", style: s={}})=>e.jsx("span", {
  ...
  , re = ({num: n})=>isNaN(n) ? null : new Intl.NumberFormat("ru-RU").format(n)
  ...
  , pl = ({item: n, active: t, amount: s=1, type: a="sale"})=>{
    var d;
    const o = _()
  ...
  , {setDeviceInfo: jl, setFullscreen: Pl} = fi.actions
...
, ()=>!1)
  ...
  , At = ({x: n, y: t})=>n + t * T.width + 1
  , In = ({x: n, y: t, width: s, blockSize: a=4})=>(n + t * s) * a
  , Aa = ({index: n, width: t, blockSize: s=4})=>{
  ...
  , es = B("canvas/repaint", async({pixelId: n, newColor: t})=>(await F.startRepaint({
    pixelId: n,
    newColor: t
})).data);
let Gt = null;
const Ba = B("canvas/getPixelInfo", async({id: n})=>(Gt !== null && (Gt.abort(),
Gt = null),
Gt = new AbortController,
(await F.getPixelInfo({
    id: n,
    signal: Gt.signal
})).data))
  , ts = B("canvas/getPrices", async()=>(await F.getPrices()).data)
  , ns = B("canvas/getPriceMask", async({price: n})=>{
  ...
  , _d = ()=>ei() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"),
!0) : !0
  , fd = {
    coords: null,
    animations: _d(),
  ...
  , yi = ce({
    ...
    extraReducers: n=>{
        n.addCase(Ba.pending, t=>{
            ...
            t.getPixelInfoFetchStatus = m.fulfilled,
            Gt = null
        }
  ...
  , {setCoords: en, enableAnimations: xd, disableAnimations: yd, addPaintCoords: vd, setPriceMask: UD, setSelectedPrice: OD, updatePixelInfo: MD} = yi.actions
  , wd = yi.reducer
  , ea = {
    getPixelInfo: Ba,
    getPriceMask: ns,
...
const ss = B("mining/info", async()=>(await ta.info()).data)
  ...
  , os = B("mining/checkTask", async({key: n})=>(await ta.checkTask({
    key: n
})).data)
  , is = B("mining/checkBoost", async({key: n})=>(await ta.checkBoost({
    key: n
})).data)
  , jd = {
    info: null,
  ...
  , {setCheckError: FD, setActiveTab: Pd, setToggleAction: Cd, setAllToggleActions: Nd, setMaxCharges: Sd, setRechargeSpeed: Id, setCharges: Td, addCharges: wi, addAddedCharges: Ed, subCharges: Bd, restoreCharges: QD, setTask: Dd} = vi.actions
  , kd = vi.reducer
  , St = {
    info: ss,
    claim: as,
  ...
  , {setProgressCommand: $e} = bi.actions
  , Ud = bi.reducer
...
let Wd = class {
    constructor({app: t, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 5,
        this.bombs = [Od, Md, Fd, Qd, zd, Hd, qd, Ld, Vd, Gd, Xd, Yd, Jd],
        this.textureArray = [];
        for (let o = 0; o < 13; o++) {
...
const Kd = {
  ...
  , {addToast: U, removeToast: xo} = ji.actions
  , Zd = ji.reducer
  ...
  , Pi = ce({
    ...
    reducers: {
        ...
        setLastShowChargesPopupTs: (n,t)=>{
            ...
            an.save("lastShowChargesPopupTs", JSON.stringify(t.payload))
        }
        ,
    ...
    extraReducers: n=>{
        n.addCase(_a.pending, (t,s)=>{
            ...
            t.pixanosRatingStatus = m.fulfilled,
  ...
  , {setTimeLimit: HD, updateSettings: qD, enableFastMode: Ci, disableFastMode: na, enableFastType: sa, disableFastType: It, enableFastEnergy: wu, disableFastEnergy: Ni, setShowPixanosRating: fa, showPixanosEvent: bu, hidePixanosEvent: ju, setPixanosProcessing: yo, setShowIntro: LD, setShowBetaTestIntro: VD, setShowMiniPopup: GD, addFlyingReward: XD, removeFlyingReward: YD, showNoChargesPopup: JD, hideNoChargesPopup: xa, setLastShowChargesPopupTs: WD, setShowMiningDetailsPopup: KD, setShowBoostDetailsPopup: ZD, setActiveBoostDetails: $D, addItemToUserAndSquadPopupStack: Fn, removeItemFromUserAndSquadPopupStack: Si, setShowNoFlagsPopup: ek, setReferrerSquadId: Da} = Pi.actions
  , Pu = Pi.reducer;
...
const Cu = "_layout_oxfjd_1"
  ...
  , cm = ({digit: n=0, fontSize: t=16, fontWeight: s=600, gap: a=6})=>{
    const [o,i] = u.useState(!0)
      , [r,c] = u.useState(0)
  ...
  , Qn = ({number: n, fontSize: t=16, fontWeight: s=600, gap: a=6, addSpace: o=!0})=>{
    if (n === void 0)
        return null;
  ...
  , {setIsTMA: dm, setIsAuth: um, setAuthData: mm} = Ii.actions
  , Ka = n=>n.auth.isTMA
  , Oe = n=>n.auth.isAuth
  , pm = Ii.reducer;
let ya = !1;
const hm = async({dispatch: n, amount: t, charges: s, maxCharges: a, status: o, state: i})=>{
    var c, d;
    ...
    try {
        (await n($s.useProduct({
            productId: 1,
            pixelId: 1
        }))).meta.requestStatus === m.fulfilled && (n(Td(a)),
        n(Zs({
            product: 1,
            amount: 1
        })),
  ...
  , Am = ()=>{
    ...
    return r && c.push(I.fast_mode_button_enabled),
    t ? e.jsxs("button", {
  ...
  , rs = B("reward/getList", async({userId: n})=>(await F.getRewards({
    userId: n
})).data)
  , va = B("reward/getById", async({rewardId: n})=>(await F.getRewardById({
    rewardId: n
})).data)
  , gm = {
    showPopup: !1,
  ...
  , {setReward: _m, clearReward: tk, addReward: nk, removeReward: sk, clearInventoryList: fm, showRewardPopup: xm, hideRewardPopup: ak} = Ti.actions
  , ym = {
    getListByUserId: rs
}
  , vm = Ti.reducer;
...
const wm = n=>{
  ...
  , cs = []
  , bm = async({dispatch: n, flyCoords: t, paintCoords: s, activeColor: a})=>{
  ...
  , jm = ({history: n, dispatch: t, paintCoords: s})=>{
    t(na()),
    n && n.push("/energy-over"),
    t(en(s)),
    b.mainImage.selectedPixel.draw(s)
}
  , Bi = async({history: n, charges: t, dispatch: s, flyCoords: a, paintCoords: o, pixelInfo: i, user: r, activeColor: c, state: d})=>{
    let p = !1;
    if (t <= 0)
        if (d && d.main.fastEnergy) {
            if (cs.length > 0 && !(await Promise.allSettled(cs)).every(g=>g.status === m.fulfilled || g.status === m.rejected))
                return;
            const A = await hm({
                dispatch: s,
                state: d
...
class Nm {
    constructor({app: t, viewport: s, store: a, mainImage: o}) {
        Ln(this, "isCoordsInExtraRewardZone", ({coords: t, x1: s, y1: a, imageSize: o})=>{
            const {x: i, y: r} = t
              , c = s + o
              , d = a + o;
        ...
        this.items.forEach((s,a)=>{
            for (let o = 0; o < s.imageSize; o++) {
                ...
                for (let i = 0; i < s.imageSize; i++) {
                    ...
                    Re.includes(c) || (t[t.length - 1][c] || (t[t.length - 1][c] = 0),
                    t[t.length - 1][c] += 1)
                }
            }
        }
...
const Sm = async({coords: n, dispatch: t, repaintReward: s, amount: a, state: o})=>{
    var r, c;
  ...
  , Im = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      ...
      , c = [I.button, I.fast_type_button];
    return o === "bomb" && c.push(I.fast_mode_button_enabled),
    s ? e.jsxs("button", {
        className: `${c.join(" ")} ${I.shop_button}`,
        onPointerUp: ()=>{
            if (o === "bomb") {
  ...
  , Tm = async({coords: n, dispatch: t, repaintReward: s, activeColor: a, amount: o, state: i})=>{
    var c, d;
  ...
  , Em = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      , r = 10 + String(a).length * 6
      , c = [I.button, I.fast_type_button];
    return o === "paintcan" && c.push(I.fast_mode_button_enabled),
    s ? e.jsxs("button", {
        className: `${c.join(" ")} ${I.shop_button}`,
        onPointerUp: ()=>{
            if (o === "paintcan") {
...
let Zm = class {
    constructor({app: t, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 7,
        this.images = [Bm, Dm, km, Rm, Um, Om, Mm, Fm, Qm, zm, Hm, qm, Lm, Vm, Gm, Xm, Ym, Jm, Wm, Km],
        this.textureArray = [];
...
;
const $m = async({coords: n, dispatch: t, repaintReward: s, amount: a, state: o})=>{
    var r, c;
  ...
  , ep = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      , r = 10 + String(a).length * 6
      , c = [I.button, I.fast_type_button];
    return o === "pumpkin" && c.push(I.fast_mode_button_enabled),
...
class sp {
    ...
    async addRewardImage(t) {
        PIXI.Loader.shared.resources.tnt || await this.loadResource("tnt", np),
...
function mp() {
    b = new up({
        readyCallback: async n=>{
            ...
            ((s = t.user.user) == null ? void 0 : s.websocketToken) === "" && n.dispatch(Rp(!0)),
            Tp((a = t.user.user) == null ? void 0 : a.websocketToken, (o = t.user.user) == null ? void 0 : o.id)
        }
    })
}
...
Ve.createPortal(e.jsx("canvas", {
  ...
  , aa = ({children: n, className: t="", style: s={}})=>e.jsx("div", {
  ...
  , et = ({active: n, setActive: t, children: s})=>e.jsx("div", {
...
const ls = B("tournament/getPeriods", async()=>(await Za.getPeriods()).data)
  ...
  , us = B("tournament/getFinalResults", async({offset: n, limit: t})=>(await Za.getFinalResults({
    offset: n,
    limit: t
})).data)
  , ms = B("tournament/getMyTemplate", async({id: n})=>(await Me.getTournamentTemplateById({
    id: n
})).data)
  , ps = B("tournament/getSelectedTemplate", async()=>(await Me.getSelectedTemplate()).data)
  , hs = B("tournament/getApprovedTemplatesList", async({offset: n, limit: t})=>(await Me.getApprovedTemplatesList({
    offset: n,
    limit: t
})).data)
  , As = B("tournament/getRandomTemplatesList", async()=>(await Me.getRandomTemplates()).data)
  , gs = B("tournament/selectTemplate", async({id: n})=>(await Me.subscribeToTournamentTemplate({
    id: n
})).data)
  , xp = {
    activeTab: Se.result,
  ...
  , Di = ce({
    ...
    reducers: {
        ...
        clearApprovedTemplateList: n=>{
            n.approvedTemplatesList = jn.getInitialState(),
    ...
    extraReducers: n=>{
        n.addCase(ms.pending, t=>{}
            ...
            t.finalResultsStatus = m.fulfilled,
            t.finalResultsTotal = s.payload.total,
            t.finalResultsOffset += s.meta.arg.limit,
            Wa.addMany(t.finalResults, s.payload.rating)
        }
            ...
            t.approvedTemplatesListStatus = m.fulfilled
        }
  ...
  , {setActiveTournamentTab: wa, setActiveTournamentTemplate: yp, hideTournamentTemplates: vp, setShowTournamentDetailsPopup: ki, setShowRoundRewardsPopup: wp, changeTemplateCoordsIfNeeded: Ri, setMyTournamentTemplate: ik, clearApprovedTemplateList: Ui, showTournamentTemplateInfoPopup: $a, closeTournamentTemplateInfoPopup: ba, setSelectedTemplate: Oi} = Di.actions
  , st = {
    getMyTemplate: ms,
...
const Tp = (n,t,s)=>{
    ...
    ze = new Ur(La.replace("https", "wss").replace("api/v1/", "connection/websocket"),o),
    ze.on("connected", function(i) {
    ...
    ze.on("publication", function(i) {
        if (i.channel === "event:message") {
            JSON.parse(new TextDecoder().decode(i.data)).forEach(d=>{
                ...
                if (d.type === ua.pixanos && We.dispatch(bu(p)),
                p.user.userId === t || !En)
                    return;
  ...
  , fs = B("user/checkCaptcha", async({wallet: n, captcha: t})=>(await F.checkCaptcha({
    wallet: n,
    captcha: t
})).data)
  , xs = B("user/checkHasCaptchaCode", async()=>(await F.checkHasCaptchaCode()).data)
  , ys = B("user/getUserPixels", async({offset: n, limit: t})=>(await F.getUserPixels({
    offset: n,
    limit: t
})).data)
  , vs = B("user/getPixelsForSaleTotal", async()=>(await F.getUserPixelsCount()).data)
  , ws = B("user/getUserPixelsSold", async({offset: n, limit: t},s)=>(await F.getUserPixelsSold({
    offset: n,
    limit: t
})).data)
  , bs = B("user/getUser", async(n,{rejectWithValue: t})=>{
    try {
  ...
  , Mi = ce({
    ...
    extraReducers: n=>{
        n.addCase(ys.pending, t=>{
            ...
            Fs.upsertMany(t.pixelsForSale, s.payload.pixels),
            t.totalPrice = s.payload.totalPrice,
            t.pixelsForSaleTotal = s.payload.total,
            t.pixelsForSaleFetchStatus = m.fulfilled
        }
            ...
            t.verificatedWalletStatus = m.fulfilled
        }
            ...
            t.hasCaptchaCodeStatus = m.fulfilled
        }
            ...
            Qs.upsertMany(t.pixelsSold, s.payload.pixels),
            t.pixelsSoldTotal = s.payload.total,
            t.pixelsSoldFetchStatus = m.fulfilled
        }
            ...
            t.getUserFetchStatus = m.fulfilled
        }
  ...
  , {setLanguageCode: Bp, setVerificatedWallet: Dp, setPixelsForSaleOffset: rk, setPixelsForSaleTotal: kp, setPixelsForSaleFetchStatus: ck, removePixelsForSale: lk, setPixelsSoldOffset: dk, setPixelsSoldTotal: uk, setPixelsSoldFetchStatus: mk, removePixelsSold: pk, setShowRobotPopup: Rp, addPixelCoins: hk, subtractPixelCoins: Up, setPixelCoins: Fi, updateUserSquad: Op, setShareBalancePercent: Mp} = Mi.actions
  , ot = n=>n.user.user
  , Fp = Mi.reducer
  , Ee = {
    getPixelsForSale: ys,
...
, ()=>!1)
  ...
  , Tt = ({show: n, setShow: t, children: s})=>{
    ...
    , [n]),
    a ? Ve.createPortal(e.jsxs(se.Fragment, {
    ...
    return u.useEffect(()=>{
        ...
        !i || s !== m.fulfilled || r && p && (g = r == null ? void 0 : r.connectItems) != null && g.tonProof && !("error"in r.connectItems.tonProof) && F.checkTonProof(r.connectItems.tonProof.proof, r.account).then(v=>{
            if (v.status === 200 && v.data.success)
                ...
                v.data && v.data.error && (y = v.data.error),
                n(U({
                    id: performance.now(),
                    text: y
                }))
  ...
  , Qi = ()=>{
    const {handleConnect: n, formattedVerificatedWalletUQ: t} = eo()
  ...
  , ht = ({children: n, variant: t=Cn.dark, onPointerUp: s=()=>{}
...
const iA = Wa.getSelectors(n=>n.tournament.finalResults)
  ...
  , Hi = ce({
    ...
    extraReducers: n=>{
        n.addCase(js.pending, t=>{
            ...
            zs.setAll(t.list, s.payload.dailyAvailable),
            t.getDailyListFetchStatus = m.fulfilled
        }
  ...
  , {setSelectedDaily: dA, updateOneDaily: Ak, setShowHowDailyWorksPopup: qi} = Hi.actions
  , uA = Hi.reducer
  , no = {
    getList: js,
    getFirstDaily: Ps
  ...
  , HA = ()=>{
    const n = _()
      , [t] = sn()
      , s = nn()
      , {handleConnect: a, verificatedWalletUQ: o, formattedVerificatedWalletUQ: i} = eo()
      , r = Va(s)
                ...
                onPointerUp: async()=>{
                    ...
                    if (!(!p || p === "")) {
                        ...
                        try {
                            ...
                            if (g.meta.requestStatus === m.rejected)
                                throw new Error("error");
                            if ((h = g.payload) != null && h.success)
                                s(U({
                                    id: performance.now(),
                                    text: "Success!",
                                    icon: ""
  ...
  , XA = ({selectedSection: n, setSelectedSection: t})=>e.jsx("div", {
    className: Pa.panel,
...
const Cs = B("ratings/personal", async({league: n, offset: t, limit: s})=>(await so.personal({
    league: n,
    offset: t,
    limit: s
})).data)
  , Ns = B("ratings/squad", async({league: n, offset: t, limit: s})=>(await so.squad({
    league: n,
    offset: t,
    limit: s
})).data)
  , Ss = B("ratings/pixanos", async({offset: n, limit: t})=>(await so.pixanos({
    offset: n,
    limit: t
})).data)
  , YA = {
  ...
  , Vi = ce({
    ...
    extraReducers: n=>{
        n.addCase(Cs.pending, (t,s)=>{
            ...
            t.pixanosStatus = m.fulfilled,
            s.payload.rating && Hs.setMany(t.pixanos, s.payload.rating),
  ...
  , {setActiveLeague: Gi, clearRatingList: Xi, setSelectedSection: Yi, clearPixanosRatingList: JA} = Vi.actions
  , jt = {
    personal: Cs,
    squad: Ns,
    pixanos: Ss
  ...
  , ao = ({position: n, userPic: t})=>e.jsxs("div", {
...
null)
  ...
  , Is = B("squad/getSquadInfo", async({id: n})=>(await F.getSquadInfo({
    id: n
})).data)
  , Ki = ce({
    name: "squad",
    ...
    extraReducers: n=>{
        n.addCase(Is.pending, t=>{
            ...
            t.info = s.payload,
            t.getInfoFetchStatus = m.fulfilled
        }
...
const Dg = Ki.reducer
  ...
  , Gg = ({selectedSection: n})=>n === "Painters" ? e.jsx(Lg, {}) : n === "Squads" ? e.jsx(Vg, {}) : null
  , Xg = ()=>{
    const n = _()
  ...
  , _t = ({children: n, show: t, onPointerUp: s=()=>{}
, backgroundColor: a})=>{
  ...
  , x_ = ()=>{
    ...
    return t && a.push(I.fast_mode_button_enabled),
    e.jsx("button", {
        className: a.join(" "),
        onPointerUp: ()=>{
            n(t ? na() : Ci())
  ...
  , b_ = ({open: n, setOpen: t, active: s, setActive: a})=>{
  ...
  , j_ = ({open: n, setOpen: t, active: s, setActive: a})=>{
    const o = _()
      , i = [Z.info_button];
    ...
    e.jsxs("div", {
        ...
        children: [n && e.jsxs("div", {
            ...
            onPointerUp: async r=>{
                var d, p;
                r.stopPropagation(),
                await Rn(`${Ct}?startapp=x${o.x}_y${o.y}`) ? (p = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || p.notificationOccurred("success") : a(!0),
                t(!1),
  ...
  , Ue = ({children: n, show: t})=>t ? e.jsx("div", {
  ...
  , Et = ({address: n, limit: t=0, display: s=null})=>{
    const a = l(Ka);
    if (!n || n === "")
        return e.jsx("span", {
            children: "Anon"
    ...
    e.jsx("span", {
        ...
        onPointerUp: i=>{
            i.stopPropagation(),
            a ? he(`https://t.me/${po(n)}`) : kn(`https://t.me/${po(n)}`)
        }
        ,
        children: o
    })
  ...
  , Df = ()=>{
    const n = $()
      , t = l(at)
      , s = l(jp);
    return tr(s ? new Date(s.StartTime) : null),
    e.jsx("div", {
        className: je.layout,
        onPointerUp: ()=>{
            n.push("/tournament")
  ...
  , Qf = B("template/subscribe", async({id: n})=>(await Me.subscribeToTemplate({
    id: n
})).data)
  , Ts = B("template/getTemplateList", async({offset: n, limit: t})=>(await Me.getTemplatesList({
    offset: n,
    limit: t
})).data)
  , zf = B("template/getAvailableSizes", async({userId: n})=>(await Me.getAvailableSizes({
    userId: n
})).data)
  , Es = B("template/getReferredTemplate", async()=>(await Me.getReferredTemplate()).data)
  , Oa = B("template/getMyTemplate", async({id: n})=>(await Me.getTemplateById({
    id: n
})).data)
  ...
  , {setActiveTemplate: qf, setActiveTemplateTab: Io, hideTemplates: io, setTemplateOpacity: Lf, setReferredTemplate: Vf, setMyTemplate: Gf, setTemplateListOffset: gk, clearTemplatesListData: Xf, setShowTemplateDetailsPopup: ar, setShowTemplateInfoPopup: Ma} = sr.actions
  , gt = {
  ...
  , Yf = sr.reducer
  , Jf = ({show: n, setShow: t})=>n ? Ve.createPortal(e.jsx("div", {
    style: {
        position: "fixed",
        left: 0,
        right: 0,
  ...
  , Kf = ({rtl: n=!0})=>{
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx(Jf, {
            ...
            onChange: i=>{
                t(Lf(i)),
                b.mainImage.worldTemplate.setOpacity(Number(i[0])),
                b.mainImage.tournamentTemplates.setOpacity(Number(i[0]))
            }
            ,
            renderTrack: ({props: i, children: r})=>e.jsx("div", {
            ...
            renderThumb: ({props: i, isDragged: r})=>u.createElement("div", {
                ...i,
                key: i.key,
                style: {
                    ...i.style,
  ...
  , Ex = ({item: n})=>n.action === "buy pixel" ? e.jsx(vx, {
    item: n
...
null)
  , Ds = B("history/get", async({offset: n, limit: t})=>(await F.getHistory({
    offset: n,
    limit: t
})).data)
  , Bx = {
...
const ro = {
  ...
  , Bn = ({size: n=11, className: t="", style: s={}, color: a="white", ...o})=>e.jsx("img", {
    alt: "",
    className: t,
    style: {
        width: `${n}px`,
  ...
  , cn = ({url: n, className: t="", text: s="Copy referral link"})=>{
  ...
  , qe = ({num: n})=>isNaN(n) ? null : new Intl.NumberFormat("en-US").format(n)
  , iv = "_layout_1ulm2_1"
...
e.jsx("div", {
    ...
    return u.useEffect(()=>{
        try {
            ...
            F.getMoreStats().then(f=>{
                ...
                A(N.daily_users),
                g(N.daily_repaints),
                y(Object.keys(N.top_countries).map(j=>({
                    key: j,
  ...
  , mw = ({secondsLeft: n})=>{
    ...
    u.useEffect(()=>{
        ...
        if (y) {
            ...
            f.dailyId === a.id && Date.now() - f.ts < 10 * 60 * 1e3 ? h(!0) : h(!1),
            Date.now() - f.ts >= 10 * 60 * 1e3 && localStorage.removeItem(s)
        }
    }
    , [a]);
    const v = async()=>{
    ...
    if (r) {
        ...
        return n && (f = `Claim in ${wc(n)}`),
        A && (f = "Pending transaction..."),
        e.jsxs("div", {
            className: k.content,
            children: [e.jsx("div", {
  ...
  , hb = ({templateSize: n, setTemplateSize: t})=>{
    const s = _()
      , a = l(ot)
      , o = a.friends || 64
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx("div", {
            ...
            children: i.map(r=>{
                ...
                return n === r && c.push(Y.template_size_item_active),
                e.jsx("div", {
                    className: c.join(" "),
                    onPointerUp: ()=>{
  ...
  , E1 = ({isPopupContent: n=!0})=>{
    const {data: t, ready: s} = ft(n);
    if (!s)
        return e.jsx(Ue, {
            show: !s,
            children: e.jsx("div", {
  ...
  , R1 = ({active: n, setActive: t})=>e.jsxs(aa, {
    style: {},
    children: [e.jsx(et, {
        active: n === "info",
        setActive: ()=>t("info"),
  ...
  , V1 = ({completed: n, item: t})=>e.jsxs("div", {
  ...
  , oj = ({active: n, isPopupContent: t=!0})=>e.jsxs("div", {
  ...
  , Oj = ({active: n, setActive: t})=>e.jsx(aa, {
    style: {},
    children: e.jsx(et, {
        active: n === "info",
        setActive: ()=>t("info"),
  ...
  , Hj = ({isPopupContent: n, active: t, data: s, ready: a})=>e.jsxs("div", {
  ...
  , Vj = ({dataUrl: n, loading: t, templateSize: s})=>e.jsx("div", {
  ...
  , Xj = ({loading: n, imageData: t, posX: s, posY: a})=>{
    const o = _()
      , i = $()
            ...
            onPointerUp: async()=>{
                try {
                    ...
                    if ((await Me.uploadTemplate({
                        ...
                        o(Gf(v)),
                        o(io()),
                        await b.mainImage.worldTemplate.add(v),
                        o(U({
                            id: performance.now(),
  ...
  , Yj = ({templateSize: n, setTemplateSize: t, coords: s, setCoords: a})=>(u.useState([16, 32, 64, 128]),
e.jsxs("div", {
  ...
  , q0 = ()=>{
    ...
    let s = Ht.review;
    return t && t.approved && (s = Ht.approved),
    t && (t.deletedAt || t.approved === !1) && (s = Ht.rejected),
    e.jsxs("div", {
  ...
  , L0 = ({dataUrl: n, loading: t, templateSize: s})=>e.jsx("div", {
  ...
  , V0 = ({templateSize: n, setTemplateSize: t})=>{
    ...
    return u.useEffect(()=>{
        if (s !== null) {
            ...
            const y = async()=>{
                ...
                f.width = d,
                f.height = d,
                N.drawImage(s, O, Qe, Ae, ue);
                const Dt = N.getImageData(0, 0, d, d);
                A0(Dt),
                N.putImageData(Dt, 0, 0),
                i(Dt),
                c(f.toDataURL())
            }
            ;
  ...
  , Yt = ({item: n, rank: t, repaints: s, style: a={}, onPointerUp: o=()=>{}
})=>{
    const i = _()
  ...
  , ZP = ({children: n, variant: t=Cn.dark, onPointerUp: s=()=>{}
, style: a={}, className: o=void 0, disabled: i=!1, status: r=m.idle, offset: c, limit: d, total: p})=>{
  ...
  , QC = ({template: n, style: t={}, onPointerUp: s=()=>{}
})=>{
    const a = _()
  ...
  , HC = ()=>{
    ...
    return l(at),
    !a || !s ? null : Ve.createPortal(e.jsx(_t, {
        onPointerUp: ()=>n(ba()),
        show: s,
        children: e.jsx("div", {
            className: X.layout,
  ...
  , JC = ({size: n, style: t={}, animation: s=!1})=>e.jsx("img", {
    alt: "image",
    src: YC,
...
, ()=>!1)
  ...
  , sS = ({values: n, setValues: t})=>e.jsx(ut.Range, {
  ...
  , iS = ({show: n, setShow: t, sharePercent: s})=>{
    const a = _()
      , [o,i] = u.useState(3);
    u.useEffect(()=>{
        let c = null;
        ...
        children: e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                onPointerUp: async()=>{
                    ...
                    c.status === 200 || c.status === 204 ? (a(Mp(s)),
                    a(U({
                        id: performance.now(),
                        text: "Success!"
                    }))) : a(U({
  ...
  , rS = ()=>{
    const [n,t] = u.useState(!1)
      , a = l(ot).balance_share_percent
      , [o,i] = u.useState([a])
      , [r,c] = u.useState(0)
      , d = l(g=>g.user.pixelCoins)
      , p = d - r
      , A = l(Mn)
      , h = l(On);
    return u.useEffect(()=>{
  ...
  , cS = "_layout_1vmy6_1"
  , lS = "_container_1vmy6_12"
  , dS = "_item_1vmy6_17"
  , uS = "_item_video_1vmy6_24"
  , mS = "_overlay_1vmy6_52"
  , pS = "_top_text_1vmy6_61"
  , hS = "_center_text_1vmy6_71"
  , AS = "_bottom_text_1vmy6_81"
  , dt = {
    layout: cS,
    container: lS,
    item: dS,
  ...
  , gS = ({itemHeight: n, translateStep: t, setTranslate: s, item: a, currentNumber: o})=>{
    const i = u.useRef(null)
      , r = u.useRef(o)
      , c = u.useRef(null);
    return u.useEffect(()=>{
        r.current = o,
        i.current && o === a.number && !c.current && (c.current = i.current.play(),
        c.current.then(d=>{
            c.current = null,
            r.current !== o && i.current.pause()
        }
        )),
  ...
  , _S = ()=>{
    ...
    s && s.speedPerSecond && n.push({
        ...
        top: "MINING",
        center: `${re({
            num: (s.speedPerSecond * 86400 / 1e3).toFixed(0)
        })} a day`,
  ...
  , fS = ()=>{
    const [t,s] = u.useState(0)
      , a = l(on)
      , [o,i] = u.useState(window.innerHeight - 20 * 2 - 100 - (a ? 0 : 56))
      , r = u.useRef(null)
      , c = u.useRef(Date.now())
      , d = 600
      , p = o + 20
    ...
    const v = ()=>{
      ...
      , N = j=>{
        Date.now() - c.current < d || (j.deltaY > 0 ? v() : j.deltaY < 0 && y(),
        c.current = Date.now())
    }
    ;
    return e.jsx("div", {
  ...
  , Fo = ()=>{
    const n = l(s=>s.user.user)
      , t = [Ie.league];
    return n !== null && Mo.hasOwnProperty(n.league) ? (t.push(Mo[n.league]),
    e.jsx("div", {
        className: t.join(" ")
    })) : null
}
...
const e2 = ()=>{
    ...
    return u.useEffect(()=>{
        ...
        n.pathname !== Qo && (n.pathname === "/" ? window.Telegram.WebApp.BackButton.hide() : window.Telegram.WebApp.BackButton.show(),
        Qo = n.pathname),
        ()=>{
  ...
  , s2 = ()=>{
    ...
    return u.useEffect(()=>{
        ...
        const A = h=>{
            a === null && (a = h);
            const v = (h - a) / r;
            i !== h && (o = Math.min(v * c, c),
            n.current && (n.current.style.width = `${o}%`)),
            i = h,
            o < c && (d = requestAnimationFrame(A))
        }
        ;
        return t === Te.start && (d = requestAnimationFrame(A),
        n.current && (n.current.style.display = "block")),
        t === Te.finish && (n.current && (n.current.style.width = "100%"),
        p = setTimeout(()=>{
  ...
  , H2 = u.memo(({runParticle: n, setRunParticle: t})=>{
    const [s,a] = u.useState(z2())
      , [o,i] = u.useState(!1);
    return u.useEffect(()=>{
        n && setTimeout(()=>{
            i(!0),
  ...
  , G2 = ({setError: n, setRunParticle: t})=>{
    var ue;
    const s = _()
      ...
      , f = nn();
    if (l(O=>O.shop.selectedCurrency) === 1 || f === "")
        return null;
    const j = async O=>{
  ...
  , J2 = ({setError: n, setRunParticle: t})=>{
    const s = _()
            ...
            try {
                ...
                f.status === 200 && ((y = f == null ? void 0 : f.data) == null ? void 0 : y.ok) === !0 && window.Telegram.WebApp.openInvoice(f.data.result, N=>{
                    ...
                    if (N === "paid") {
                        ...
                        p(!0),
                        (ue = (Ae = window.Telegram.WebApp) == null ? void 0 : Ae.HapticFeedback) == null || ue.notificationOccurred("error"),
                        t(!0)
                    } else
                        n("Error, try again.")
                }
...
const nI = ()=>{
    ...
    return o ? null : e.jsxs("div", {
        ...
        children: [e.jsx(ut.Range, {
            ...
            onChange: y,
            onFinalChange: f,
            renderTrack: ({props: N, children: j})=>e.jsx("div", {
            ...
            renderThumb: ({props: N, isDragged: j})=>u.createElement("div", {
                ...N,
                key: N.key,
                style: {
                    ...N.style,
...
function UI(n) {
    const {viewportWidth: t, viewportHeight: s, textureWidth: a, textureHeight: o, textureLeft: i, textureTop: r, min: c} = RI(n);
    Rs = c * c,
    Ke(w, be, "u_AnimationDuration", yr),
    Ke(w, be, "u_ParticleSize", NI),
    Ke(w, be, "u_ViewportWidth", t),
    Ke(w, be, "u_ViewportHeight", s),
    Ke(w, be, "u_TextureWidth", a),
    Ke(w, be, "u_TextureHeight", o),
    Ke(w, be, "u_TextureLeft", i),
    Ke(w, be, "u_TextureTop", r);
...
function OI(n) {
    ...
    Ke(w, be, "u_ElapsedTime", s),
    w.drawArrays(w.POINTS, 0, Rs),
    vr()
}
function Ke(n, t, s, a) {
...
const MI = ()=>{
    ...
    if (u.useEffect(()=>{
        s && a && (async()=>{
            ...
            n.push("/"),
            b.mainImage.pixanosRepaint(a.info.seed, T.width, a.info.percentage, a.info.color),
            (d = (c = window.Telegram.WebApp) == null ? void 0 : c.HapticFeedback) == null || d.notificationOccurred("error")
        }
        )()
    }
  ...
  , WT = ({values: n, setValues: t})=>e.jsx("div", {
    className: Yo.layout,
    children: e.jsx("div", {
...
null)
  ...
  , rB = ()=>{
    ...
    u.useEffect(()=>{
        ...
        ;
        t("colors", s=>{
            Array.isArray(s) && s.length > 0 ? (n(Cc(s)),
            n(Ga(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
        }
        ),
        t("boosts1", s=>{
            n(Nd(s))
    ...
    const n = _()
      ...
      , s = async()=>{
        try {
            ...
            return console.error("Ошибка при получении данных пользователя:", c),
            !1
        }
    }
      , a = async()=>{
  ...
  , lB = ()=>{
    const n = $();
    u.useEffect(()=>{
        ei() ? localStorage.getItem("skipIntro") || (n.push("/welcome"),
        localStorage.setItem("skipIntro", "true")) : an.get("skipIntro", (t,s)=>{
...
const xB = ()=>{
  ...
  , yB = ({children: n})=>{
    ...
    const t = l(c=>c.main.timeLimit)
      ...
      , i = t;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Ac) && GE(),
    rB(),
    cB(),
    lB(),
    a || i ? e.jsx(aB, {}) : o ? e.jsx(iB, {}) : e.jsx(e.Fragment, {
        children: n
    })
}
  , vB = ()=>{
...
function wB() {
    ...
    window.Telegram.WebApp.isVersionAtLeast("8.0") || window.Telegram.WebApp.version === "6.0" && window.Telegram.WebApp.platform === "unknown" ? e.jsx(yB, {
        children: e.jsx(LE, {})
    }) : e.jsx(vB, {})
}
const Bt = tn();
Bt.startListening({
    ...
    effect: (n,t)=>{
        n.payload.activated && (t.dispatch(kp(n.payload.totalUserPixels)),
        t.dispatch(Fi(n.payload.userBalance))),
        t.dispatch(Mc(n.payload.goods))
    }
});
Bt.startListening({
    ...
    effect: (n,t)=>{
        ...
        if (i) {
            if (o === Ze.energyLimit) {
                ...
                t.dispatch(Sd(s.mining.maxCharges + d)),
                t.dispatch(wi(d))
            }
...
Bt.startListening({
    ...
    effect: (n,t)=>{
        ...
        an.save("boosts1", JSON.stringify(a))
    }
});
const ca = tn();
ca.startListening({
