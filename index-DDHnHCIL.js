...
import {u as qs, e as Ys, a as Xs} from "https://app.notpx.app/assets/@react-spring-BiYD2lL6.js";
...
import {u as ee, S as Rc, a as ie, b as aa} from "https://app.notpx.app/assets/react-router-skDq-tWz.js";
import {c as on} from "https://app.notpx.app/assets/chroma-js-CHvE9HB5.js";
import {m as Qn, A as ii} from "https://app.notpx.app/assets/framer-motion-BggZOsGS.js";
import {u as Le, T as ya, i as Mc} from "https://app.notpx.app/assets/react-i18next-DUbAQzaN.js";
import {l as Ot} from "https://app.notpx.app/assets/react-range-COVt_hlT.js";
import {T as wa} from "https://app.notpx.app/assets/tonweb-BaiZR3hJ.js";
import {B as Uc} from "https://app.notpx.app/assets/react-router-dom-DSUFG-Qy.js";
import {i as Oc} from "https://app.notpx.app/assets/i18next-vSwsns86.js";
...
G("main/startTransaction", async({pixelId: t, newColor: n, buyerWallet: s})=>(await Z.startTransaction({
    pixelId: t,
    newColor: n,
    buyerWallet: s
})).data);
const Tl = {
  ...
  , ls = G("shop/useProduct", async({pixelId: t, productId: n, color: s})=>(await Z.useProduct({
    pixelId: t,
    productId: n,
    color: s
})).data)
  ...
  , {setProductCard: ct, showProductCard: lt, hideProductCard: mi, increaseAmount: $M, decreaseAmount: eU, setAmount: ia, setAvailable: Bl, addAvailable: an, subAvailable: oa, setSelectedCurrency: Fn, setLimitedGoods: tU, clearLimitedGoods: nU, showLimitedGoodsPopup: El, hideLimitedGoodsPopup: sU} = ko.actions
  , ra = t=>t.shop.crypto
  , kl = ko.reducer
  , ca = {
    getProducts: cs,
...
, ()=>!1)
  ...
  , us = G("user/checkCaptcha", async({wallet: t, captcha: n})=>(await Z.checkCaptcha({
    wallet: t,
    captcha: n
})).data)
  , ms = G("user/getUserPixels", async({offset: t, limit: n})=>(await Z.getUserPixels({
    offset: t,
    limit: n
})).data)
  , As = G("user/getPixelsForSaleTotal", async()=>(await Z.getUserPixelsCount()).data)
  , ps = G("user/getUserPixelsSold", async({offset: t, limit: n},s)=>(await Z.getUserPixelsSold({
    offset: t,
    limit: n
})).data)
  , hs = G("user/getUser", async(t,{rejectWithValue: n})=>{
    try {
  ...
  , Ho = _e({
    ...
    extraReducers: t=>{
        t.addCase(ms.pending, n=>{
            ...
            Js.upsertMany(n.pixelsForSale, s.payload.pixels),
            ...
            Zs.upsertMany(n.pixelsSold, s.payload.pixels),
  ...
  , {setLanguageCode: ou, setPixelsForSaleOffset: qo, setPixelsForSaleTotal: ru, setPixelsForSaleFetchStatus: cu, removePixelsForSale: lu, setPixelsSoldOffset: aU, setPixelsSoldTotal: iU, setPixelsSoldFetchStatus: oU, removePixelsSold: rU, setShowRobotPopup: du, addPixelCoins: Et, subtractPixelCoins: uu, setPixelCoins: Yo, updateUserSquad: mu} = Ho.actions
  , Xo = t=>{
    const n = t.user.user;
  ...
  , {addToast: z, removeToast: zi} = Vo.actions
  , xu = Vo.reducer
  , vu = ()=>{
    const t = _()
      , n = c(dt)
...
const gs = G("mining/info", async()=>(await ua.info()).data)
  ...
  , fs = G("mining/checkTask", async({key: t})=>(await ua.checkTask({
    key: t
})).data)
  , xs = G("mining/checkBoost", async({key: t})=>(await ua.checkBoost({
    key: t
})).data)
  , sm = {
    info: null,
  ...
  , {setCheckError: am, setActiveTab: Ya, setToggleAction: Jo, setAllToggleActions: im, setMaxCharges: om, setRechargeSpeed: rm, setCharges: cm, addCharges: Zo, addAddedCharges: lm, subCharges: dm, restoreCharges: cU, setTask: um} = Wo.actions
  , mm = Wo.reducer
  , xe = {
    info: gs,
    claim: _s,
  ...
  , R = ({size: t=11, className: n="", style: s={}, color: a="white", ...i})=>e.jsx("img", {
    alt: "",
    className: n,
    style: {
        width: `${t}px`,
  ...
  , $o = A.memo(({runParticle: t, setRunParticle: n})=>{
    const [s,a] = A.useState(bm())
      , [i,o] = A.useState(!1);
    return A.useEffect(()=>{
        t && setTimeout(()=>{
            o(!0),
  ...
  , Y = ({children: t, boost: n, enableCheck: s=!0, action: a, id: i, reward: o, ...r})=>{
    const l = _()
      , d = [u.info_row]
  ...
  , W = ({boost: t})=>c(s=>s.mining.tasks[t]) ? e.jsx("div", {
...
const Yi = ()=>{
  ...
  , WA = ()=>{
    ...
    return !VA && !n ? null : e.jsx(Y, {
        boost: t,
        action: ()=>{
            V("https://t.me/frogfarmbot/frogfarm?startapp=291096007"),
            a("task_frogApp")
        }
        ,
        reward: s,
  ...
  , sp = ()=>{
    ...
    return !np && !n ? null : e.jsx(Y, {
        boost: t,
        action: ()=>{
            V("https://t.me/DuckChain_bot/quack?startapp=dab7ZIxC"),
            a("task_duckChain")
        }
        ,
        reward: s,
  ...
  , rp = ()=>{
    ...
    return !op && !n ? null : e.jsx(Y, {
        boost: t,
        action: ()=>{
            V("https://t.me/terminalgame_bot/terminalgame?startapp=notpixel&startApp=notpixel"),
            a("task_trmnl")
        }
        ,
        reward: s,
  ...
  , up = ()=>{
    ...
    return !dp && !n ? null : e.jsx(Y, {
        boost: t,
        action: ()=>{
            V("https://t.me/starshash_bot/starshash"),
            a("task_starHash")
        }
        ,
        reward: s,
  ...
  , hp = ()=>{
    ...
    return !pp && !n ? null : e.jsx(Y, {
        boost: t,
        action: ()=>{
            V("https://t.me/sticker_bot?startapp"),
            a("task_stickerStore")
        }
        ,
        reward: s,
  ...
  , xp = ()=>{
    ...
    return e.jsx(Y, {
        action: ()=>{
            V("https://t.me/boinker_bot/boinkapp?startapp=campNotPixelDec"),
            s("task_boink_dec")
        }
        ,
        boost: t,
...
const sr = Rn.getSelectors(t=>t.tournament.approvedTemplatesList)
  ...
  , rh = ({coords: t})=>e.jsxs("div", {
    className: re.pixelCoords,
    children: [t.x, ", ", t.y]
})
  , ch = ({color: t})=>e.jsx("div", {
  ...
  , vs = G("canvas/repaint", async({pixelId: t, newColor: n})=>(await Z.startRepaint({
    pixelId: t,
    newColor: n
})).data);
let sn = null;
const Xa = G("canvas/getPixelInfo", async({id: t})=>(sn !== null && (sn.abort(),
sn = null),
sn = new AbortController,
(await Z.getPixelInfo({
    id: t,
    signal: sn.signal
})).data))
  , ys = G("canvas/getPrices", async()=>(await Z.getPrices()).data)
  , ws = G("canvas/getPriceMask", async({price: t})=>{
  ...
  , uh = ()=>li() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"),
!0) : !0
  , mh = {
    coords: null,
    animations: uh(),
  ...
  , {setCoords: Gt, enableAnimations: Ah, disableAnimations: ph, addPaintCoords: hh, setPriceMask: lU, setSelectedPrice: gh, updatePixelInfo: dU} = rr.actions
  , _h = rr.reducer
  , ma = {
    getPixelInfo: Xa,
    getPriceMask: ws,
...
let Dh = class {
    constructor({app: n, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 5,
        this.bombs = [yh, wh, jh, bh, Nh, Ch, Ih, Ph, Sh, Th, Bh, Eh, kh],
        this.textureArray = [];
        for (let i = 0; i < 13; i++) {
...
const js = G("tournament/getPeriods", async()=>(await dr.getPeriods()).data)
  ...
  , Ns = G("tournament/getMyTemplate", async({id: t})=>(await Ye.getTournamentTemplateById({
    id: t
})).data)
  , Cs = G("tournament/getSelectedTemplate", async()=>(await Ye.getSelectedTemplate()).data)
  , Is = G("tournament/getApprovedTemplatesList", async({offset: t, limit: n})=>(await Ye.getApprovedTemplatesList({
    offset: t,
    limit: n
})).data)
  , Ps = G("tournament/getRandomTemplatesList", async()=>(await Ye.getRandomTemplates()).data)
  , Ss = G("tournament/selectTemplate", async({id: t})=>(await Ye.subscribeToTournamentTemplate({
    id: t
})).data)
  , og = {
    activeTab: Ue.main,
...
const Ag = (t,n,s)=>{
    ...
    Ke.on("publication", function(o) {
        if (o.channel === "event:message") {
            JSON.parse(new TextDecoder().decode(o.data)).forEach(d=>{
                ...
                if (d.type === ja.pixanos && at.dispatch(fg(m)),
                m.user.userId === n || !Gn)
                    return;
  ...
  , {setTimeLimit: gg, updateSettings: AU, enableFastMode: xr, disableFastMode: Aa, enableFastType: pa, disableFastType: Ht, enableFastEnergy: _g, disableFastEnergy: vr, setShowPixanosRating: Bs, showPixanosEvent: fg, hidePixanosEvent: xg, setPixanosProcessing: Xi, setShowIntro: pU, setShowBetaTestIntro: hU, setShowMiniPopup: yr, addFlyingReward: vg, removeFlyingReward: yg, showInviteFrensPopup: gU, hideInviteFrensPopup: Ea, showNoChargesPopup: _U, hideNoChargesPopup: ka, setLastShowChargesPopupTs: fU, setShowMiningDetailsPopup: wr, setShowBoostDetailsPopup: yi, setActiveBoostDetails: wg, addItemToUserAndSquadPopupStack: Wn, removeItemFromUserAndSquadPopupStack: jr, setShowNoFlagsPopup: jg, setReferrerSquadId: Ja} = fr.actions
  , bg = fr.reducer
  , Ng = {
    getPixanosRating: Ts
}
  ...
  , l_ = ({digit: t=0, fontSize: n=16, fontWeight: s=600, gap: a=6})=>{
  ...
  , {setIsTMA: u_, setIsAuth: m_, setAuthData: A_} = Nr.actions
  , wi = t=>t.auth.isTMA
  , Xe = t=>t.auth.isAuth
  , p_ = Nr.reducer;
let Da = !1;
const h_ = async({dispatch: t, amount: n, charges: s, maxCharges: a, status: i, state: o})=>{
    var l, d;
...
const Es = G("ratings/personal", async({league: t})=>(await Pr.personal({
    league: t
})).data)
  , ks = G("ratings/squad", async({league: t})=>(await Pr.squad({
    league: t
})).data)
  , x_ = {
    list: [],
  ...
  , {setActiveLeague: Tr, clearRatingList: v_} = Sr.actions
  , ji = {
    personal: Es,
    squad: ks
}
  , y_ = Sr.reducer
  , Ds = G("history/get", async({offset: t, limit: n})=>(await Z.getHistory({
    offset: t,
    limit: n
})).data)
  , w_ = {
...
const b_ = {
  ...
  , Rs = G("squad/getSquadInfo", async({id: t})=>(await Z.getSquadInfo({
    id: t
})).data)
  , Dr = _e({
    name: "squad",
...
const N_ = Dr.reducer
  ...
  , I_ = G("template/subscribe", async({id: t})=>(await Ye.subscribeToTemplate({
    id: t
})).data)
  , Ms = G("template/getTemplateList", async({offset: t, limit: n})=>(await Ye.getTemplatesList({
    offset: t,
    limit: n
})).data)
  , P_ = G("template/getAvailableSizes", async({userId: t})=>(await Ye.getAvailableSizes({
    userId: t
})).data)
  ...
  , {setActiveTemplate: T_, setActiveTemplateTab: Vi, hideTemplates: Ni, setTemplateOpacity: B_, setReferredTemplate: E_, setMyTemplate: k_, setTemplateListOffset: xU, clearTemplatesListData: D_, setShowTemplateDetailsPopup: Mr, setShowTemplateInfoPopup: Ka} = Rr.actions
  , Pt = {
  ...
  , Ur = _e({
    ...
    extraReducers: t=>{
        t.addCase(Qs.pending, n=>{
            ...
            Ks.setAll(n.list, s.payload.dailyAvailable),
  ...
  , {setSelectedDaily: O_, updateOneDaily: vU, setShowHowDailyWorksPopup: Or} = Ur.actions
  , Q_ = Ur.reducer
  , Qr = {
    getList: Qs,
    getFirstDaily: Fs
}
  , zs = G("reward/getList", async({userId: t})=>(await Z.getRewards({
    userId: t
})).data)
  , Ra = G("reward/getById", async({rewardId: t})=>(await Z.getRewardById({
    rewardId: t
})).data)
  , F_ = {
    showPopup: !1,
  ...
  , {setReward: z_, clearReward: G_, addReward: yU, removeReward: wU, clearInventoryList: L_, showRewardPopup: H_, hideRewardPopup: q_} = Fr.actions
  , Y_ = {
    getListByUserId: zs
}
  , X_ = Fr.reducer
...
const Kn = Nc({
  ...
  , Gs = []
  , V_ = async({dispatch: t, flyCoords: n, paintCoords: s, activeColor: a})=>{
  ...
  , W_ = ({history: t, dispatch: n, paintCoords: s})=>{
    n(Aa()),
  ...
  , zr = async({history: t, charges: n, dispatch: s, flyCoords: a, paintCoords: i, pixelInfo: o, user: r, activeColor: l, state: d})=>{
    ...
    if (n <= 0)
        if (d && d.main.fastEnergy) {
            if (Gs.length > 0 && !(await Promise.allSettled(Gs)).every(x=>x.status === p.fulfilled || x.status === p.rejected))
                return;
            const h = await h_({
                dispatch: s,
                state: d
...
const $_ = ({x: t, y: n})=>{
  ...
  , ef = async({coords: t, dispatch: n, repaintReward: s, amount: a, state: i})=>{
    var r, l;
  ...
  , sf = async({coords: t, dispatch: n, repaintReward: s, activeColor: a, amount: i, state: o})=>{
    var l, d;
...
let Cf = class {
    constructor({app: n, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 7,
        this.images = [of, rf, cf, lf, df, uf, mf, Af, pf, hf, gf, _f, ff, xf, vf, yf, wf, jf, bf, Nf],
        this.textureArray = [];
...
const If = ({x: t, y: n})=>{
  ...
  , Pf = async({coords: t, dispatch: n, repaintReward: s, amount: a, state: i})=>{
    var r, l;
...
function Qf() {
    b = new Of({
        readyCallback: async t=>{
            ...
            Ag((a = n.user.user) == null ? void 0 : a.websocketToken, (i = n.user.user) == null ? void 0 : i.id)
        }
    })
}
...
Ge.createPortal(e.jsx("canvas", {
  ...
  , zf = ({children: t, coords: n, classes: s=[]})=>{
    const a = ee()
      , i = _();
    return e.jsx("div", {
  ...
  , Kf = ({title: t, children: n})=>e.jsxs(ae.Fragment, {
    children: [e.jsx("div", {
  ...
  , ux = ({price: t, isMax: n})=>n ? "Max" : e.jsxs(ae.Fragment, {
  ...
  , Iv = ({selectedSection: t, setSelectedSection: n})=>e.jsx("div", {
    className: Ma.panel,
...
e.jsx("div", {
  ...
  , dy = ()=>{
    ...
    return e.jsx("button", {
        ...
        onPointerUp: ()=>{
            a !== p.pending && t(Ng.getPixanosRating()),
            t(Bs(!0))
        }
        ,
        children: e.jsx("img", {
...
, backgroundColor: a})=>{
  ...
  , ew = ({show: t, setShow: n})=>t ? Ge.createPortal(e.jsx("div", {
    style: {
        position: "fixed",
        left: 0,
        right: 0,
  ...
  , Pw = ({open: t, setOpen: n, active: s, setActive: a})=>{
    const i = _()
      , o = [le.info_button];
    ...
    e.jsxs("div", {
        ...
        children: [t && e.jsxs("div", {
            ...
            onPointerUp: async r=>{
                var d, m;
                r.stopPropagation(),
                await Yn(`${St}?startapp=x${i.x}_y${i.y}`) ? (m = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || m.notificationOccurred("success") : a(!0),
                n(!1),
  ...
  , fn = ({address: t, limit: n=0, display: s=null})=>{
    ...
    e.jsx("span", {
        ...
        onPointerUp: o=>{
            o.stopPropagation(),
            a ? V(`https://t.me/${Ri(t)}`) : Tt(`https://t.me/${Ri(t)}`)
        }
        ,
        children: i
    })
  ...
  , Zj = ({item: t})=>t.action === "buy pixel" ? e.jsx(zj, {
    item: t
...
e.jsx("div", {
    ...
    return A.useEffect(()=>{
        try {
            ...
            Z.getMoreStats().then(w=>{
                ...
                h(M.daily_users),
                x(M.daily_repaints),
                f(Object.keys(M.top_countries).map(C=>({
                    key: C,
  ...
  , TN = ({templateSize: t, setTemplateSize: n})=>{
    const s = _()
      , a = c(He)
      , i = a.friends || 64
  ...
  , rI = ({completed: t, item: n})=>e.jsxs("div", {
  ...
  , yI = ({active: t, isPopupContent: n=!0})=>e.jsxs("div", {
  ...
  , $I = ({active: t, setActive: n})=>e.jsx(pn, {
    style: {},
    children: e.jsx(ze, {
        active: t === "info",
        setActive: ()=>n("info"),
  ...
  , aP = ({isPopupContent: t, active: n, data: s, ready: a})=>e.jsxs("div", {
  ...
  , rP = ({dataUrl: t, loading: n, templateSize: s})=>e.jsx("div", {
  ...
  , lP = ({loading: t, imageData: n, posX: s, posY: a})=>{
    const i = _()
      , o = ee()
  ...
  , dP = ({templateSize: t, setTemplateSize: n, coords: s, setCoords: a})=>(A.useState([16, 32, 64, 128]),
e.jsxs("div", {
  ...
  , zS = ({dataUrl: t, loading: n, templateSize: s})=>e.jsx("div", {
  ...
  , GS = ({templateSize: t, setTemplateSize: n})=>{
    ...
    return A.useEffect(()=>{
        if (s !== null) {
            ...
            const f = async()=>{
                ...
                w.width = d,
                w.height = d,
                M.drawImage(s, J, st, be, U);
                const Yt = M.getImageData(0, 0, d, d);
                mS(Yt),
                M.putImageData(Yt, 0, 0),
                o(Yt),
                l(w.toDataURL())
            }
            ;
  ...
  , vT = ()=>{
    ...
    return c(Be),
    !a || !s ? null : Ge.createPortal(e.jsx(Ve, {
        onPointerUp: ()=>t(Ba()),
        show: s,
        children: e.jsx("div", {
            className: se.layout,
  ...
  , IT = ({size: t, style: n={}, animation: s=!1})=>e.jsx("img", {
    alt: "image",
    src: CT,
                        ...
                        try {
                            ...
                            if (w.status === 200) {
                                ...
                                if (M.secretWord.success) {
                                    let C = "Success!";
                                    M.secretWord.reward && (C += ` ${M.secretWord.reward} PX earned`),
                                    t(z({
                                        id: performance.now(),
                                        text: C,
                                        icon: ""
...
const tE = ()=>{
  ...
  , lk = ({setError: t, setRunParticle: n})=>{
    var U;
    const s = _()
      ...
      , w = Hn();
    if (c(J=>J.shop.selectedCurrency) === 1 || w === "")
        return null;
    const C = async J=>{
  ...
  , mk = ({setError: t, setRunParticle: n})=>{
    const s = _()
            ...
            try {
                ...
                w.status === 200 && ((f = w == null ? void 0 : w.data) == null ? void 0 : f.ok) === !0 && window.Telegram.WebApp.openInvoice(w.data.result, M=>{
                    ...
                    if (M === "paid") {
                        ...
                        m(!0),
                        (U = (be = window.Telegram.WebApp) == null ? void 0 : be.HapticFeedback) == null || U.notificationOccurred("error"),
                        n(!0)
                    } else
                        t("Error, try again.")
                }
...
const xk = ()=>{
    ...
    return i ? null : e.jsxs("div", {
        ...
        children: [e.jsx(Ot.Range, {
            ...
            renderThumb: ({props: f, isDragged: w})=>A.createElement("div", {
                ...f,
                key: f.key,
                style: {
                    ...f.style,
...
function $k(t) {
    const {viewportWidth: n, viewportHeight: s, textureWidth: a, textureHeight: i, textureLeft: o, textureTop: r, min: l} = Kk(t);
    Hs = l * l,
    pt(N, Ee, "u_AnimationDuration", mc),
    pt(N, Ee, "u_ParticleSize", Hk),
...
const A4 = "_container_gb8eq_1"
  ...
  , R4 = ()=>{
    ...
    return A.useEffect(()=>(li() && (localStorage.getItem(i) || a(!0)),
    ()=>{}
    ), [n]),
    e.jsx(Ve, {
        show: s,
...
const Q3 = ()=>{
  ...
  , F3 = ({children: t})=>{
    ...
    const n = c(l=>l.main.timeLimit)
      ...
      , o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(rl) && m3(),
    I3(),
    P3(),
    S3(),
    a || o ? e.jsx(b3, {}) : i ? e.jsx(C3, {}) : e.jsx(e.Fragment, {
        children: t
    })
}
  , z3 = ()=>{
...
function G3() {
    ...
    window.Telegram.WebApp.isVersionAtLeast("8.0") || window.Telegram.WebApp.version === "6.0" && window.Telegram.WebApp.platform === "unknown" ? e.jsx(F3, {
        children: e.jsx(l3, {})
    }) : e.jsx(z3, {})
}
const L3 = {
