...
var xr = (n,t,s)=>t in n ? fr(n, t, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: s
}) : n[t] = s;
var Rn = (n,t,s)=>xr(n, typeof t != "symbol" ? t + "" : t, s);
import {j as e, r as m, R as ae} from "https://app.notpx.app/assets/react-DjWS3H3h.js";
import {r as Ze, c as yr} from "https://app.notpx.app/assets/react-dom-DCoj3sTC.js";
import {c as ie, a as B, b as Vt, d as Ia, e as Gt, i as ce, f as vr} from "https://app.notpx.app/assets/@reduxjs-K2ahyHOo.js";
import {a as wr} from "https://app.notpx.app/assets/axios-BdInfei4.js";
...
import {d as he} from "https://app.notpx.app/assets/@ton-CABtnvlX.js";
import {u as l, a as g, P as br} from "https://app.notpx.app/assets/react-redux-uubI8uR8.js";
import {c as R} from "https://app.notpx.app/assets/classnames-D-x1NdaJ.js";
import {u as Xt, a as Jt, b as jr, c as Pr, T as Cr, d as Nr} from "https://app.notpx.app/assets/@tonconnect-5rsNs4Y3.js";
import {u as Cs, e as Ns, a as Ss} from "https://app.notpx.app/assets/@react-spring-BiYD2lL6.js";
import {C as Sr} from "https://app.notpx.app/assets/centrifuge-B3TpHLNx.js";
import {d as Ir} from "https://app.notpx.app/assets/fflate-DRb3BoOD.js";
import {u as K, S as Tr, a as G, b as Qs} from "https://app.notpx.app/assets/react-router-skDq-tWz.js";
import {c as Ft} from "https://app.notpx.app/assets/chroma-js-CHvE9HB5.js";
import {m as yn, A as Ta} from "https://app.notpx.app/assets/framer-motion-BggZOsGS.js";
import {u as Fs, i as Er} from "https://app.notpx.app/assets/react-i18next-4MQgfZKk.js";
import {T as ea} from "https://app.notpx.app/assets/tonweb-BaiZR3hJ.js";
import {l as fa} from "https://app.notpx.app/assets/react-range-COVt_hlT.js";
import {B as Br} from "https://app.notpx.app/assets/react-router-dom-DSUFG-Qy.js";
import {i as Dr} from "https://app.notpx.app/assets/i18next-vSwsns86.js";
...
const kr = "_stars_img_container_1wci0_1"
  , Rr = "_stars_img_1wci0_1"
  , Ur = "_scalebubble_1wci0_1"
  , Or = "_squads_img_1wci0_17"
  , Mr = "_title_container_1wci0_22"
  , Qr = "_description_container_1wci0_28"
  , Fr = "_description_1wci0_28"
  , zr = "_info_layout_1wci0_42"
  , Hr = "_info_container_1wci0_52"
  , qr = "_info_row_1wci0_59"
  , Lr = "_info_row_content_1wci0_65"
  , Vr = "_info_row_sale_1wci0_84"
  , Gr = "_not_active_1wci0_100"
  , Xr = "_selected_1wci0_105"
  , Jr = "_row_icon_container_1wci0_110"
  , Yr = "_row_icon_1wci0_110"
  , Wr = "_row_title_1wci0_133"
  , Kr = "_row_amount_1wci0_143"
  , Zr = "_row_price_container_1wci0_156"
  , $r = "_main_info_channel_users_1wci0_166"
  , oe = {
    stars_img_container: kr,
    stars_img: Rr,
    scalebubble: Ur,
    squads_img: Or,
    title_container: Mr,
    description_container: Qr,
    description: Fr,
    info_layout: zr,
    info_container: Hr,
    info_row: qr,
    ...
    main_info_channel_users: $r
}
  , ec = Number(window.getComputedStyle(document.body).getPropertyValue("--header-height").replace("px", ""))
  , u = {
    idle: "idle",
    pending: "pending",
    fulfilled: "fulfilled",
  ...
  , nc = ["/transaction/user/start", "/repaint/finish", "/transaction/user/complete", "/stars/shop/process", "/mining/status/claim", "/mining/claim", "/mining/status/error", "/repaint/complete", "/stars/shop/reject", "/squads/list/get", "/squads/list/update"]
  , Qe = {
    my: "my",
    referred: "referred",
    world: "world"
...
const Yt = Mo
  ...
  , hn = n=>new Promise(t=>setTimeout(t, n))
  , cc = n=>{
  ...
  , lc = ()=>{
    try {
        ...
        for (let o = 0; o < s.length; o++) {
            ...
            !isNaN(i) && (r === "f" ? t.refId = i : r === "s" ? t.squadId = i : r === "x" || r === "y" ? (t.coords || (t.coords = {
                x: 0,
                y: 0
            }),
            t.coords[r] = i) : r === "t" && (t.showTemplate = !0))
        }
        return cc(t.coords) || (t.coords = !1),
  ...
  , Te = ["#E46E6E", "#FFD635", "#7EED56", "#00CCC0", "#51E9F4", "#94B3FF", "#E4ABFF", "#FF99AA", "#FFB470", "#FFFFFF", "#BE0039", "#FF9600", "#00CC78", "#009EAA", "#3690EA", "#6A5CFF", "#B44AC0", "#FF3881", "#9C6926", "#898D90", "#6D001A", "#BF4300", "#00A368", "#00756F", "#2450A4", "#493AC1", "#811E9F", "#A00357", "#6D482F", "#000000"]
  , $a = Te[L(0, Te.length - 1)]
  , pc = {
    active: $a,
    id: btoa($a),
  ...
  , qo = ie({
    ...
    reducers: {
        addColor: (n,t)=>{
            ...
            a !== t.payload && Yt.save("colors", JSON.stringify(n.latest))
        }
        ,
        setColors: (n,t)=>{
            n.latest = t.payload
  ...
  , {addColor: mc, setColors: Ac, setActiveColor: ka} = qo.actions
  , hc = qo.reducer;
class Q {
    ...
    static async startShopTransaction({buyerWallet: t, goodId: s, daily: a=!1, currencyId: o, quantity: i, activeColor: r}) {
        let c = s === 13 ? Te[L(0, 29)] : void 0;
        return r && Te.includes(r) && (c = r),
...
const Pc = {
  ...
  , Vn = B("shop/useProduct", async({pixelId: n, productId: t, color: s})=>(await Q.useProduct({
    pixelId: n,
    productId: t,
    color: s
})).data)
  ...
  , {setProductCard: qe, showProductCard: Le, hideProductCard: Ra, increaseAmount: AB, decreaseAmount: hB, setAmount: zs, setAvailable: Cc, addAvailable: On, subAvailable: Hs, setSelectedCurrency: vn, setLimitedGoods: gB, clearLimitedGoods: _B, showLimitedGoodsPopup: Nc, hideLimitedGoodsPopup: fB} = Jo.actions
  , Ua = n=>n.shop.crypto
  , Sc = Jo.reducer
  , qs = {
    getProducts: Ln,
  ...
  , In = ({fontSize: n=18, className: t="", style: s={}})=>e.jsx("span", {
  ...
  , Se = ({num: n})=>isNaN(n) ? null : new Intl.NumberFormat("ru-RU").format(n)
  ...
  , ti = (n,t)=>sa[n] ? sa[n](n, t) : sa.default()
  , tl = ({item: n, active: t, amount: s=1, type: a="sale"})=>{
    var d;
    const o = g()
  ...
  , rl = ()=>!1
  , ni = ()=>window.location.hostname.includes("dev")
  , cl = ()=>ni() ? dn.VITE_ADSGRAM_BLOCK_ID : il() ? "4853" : "4995"
  , Ht = {
    isDev: rl(),
    devServer: ni(),
  ...
  , si = ie({
    ...
    reducers: {
        setDeviceInfo: (n,t)=>{
            const {deviceType: s, os: a, platform: o} = t.payload;
            n.deviceType = s,
            n.os = a,
            n.platform = o
        }
  ...
  , {setDeviceInfo: pl, setFullscreen: ml} = si.actions
  , $e = n=>n.device.platform
  , Al = n=>n.device.os
  , Kt = n=>n.device.fullscreen
  , Oa = n=>n.device.contentSafeAreaInset
  , Ma = n=>n.device.safeAreaInset
  , hl = si.reducer
  , gl = ()=>{
    const [n,t] = m.useState("Stars")
      , s = l($e);
    return e.jsx("div", {
        className: aa.panel,
  ...
  , D = ({children: n, className: t="", style: s={}, size: a=12})=>n ? e.jsx("span", {
    className: `${ai.telegram_icons} ${t}`,
    style: {
        fontSize: a,
        ...s
    },
...
, ()=>!1)
  ...
  , Xn = B("user/checkCaptcha", async({wallet: n, captcha: t})=>(await Q.checkCaptcha({
    wallet: n,
    captcha: t
})).data)
  , Jn = B("user/checkHasCaptchaCode", async()=>(await Q.checkHasCaptchaCode()).data)
  , Yn = B("user/getUserPixels", async({offset: n, limit: t})=>(await Q.getUserPixels({
    offset: n,
    limit: t
})).data)
  , Wn = B("user/getPixelsForSaleTotal", async()=>(await Q.getUserPixelsCount()).data)
  , Kn = B("user/getUserPixelsSold", async({offset: n, limit: t},s)=>(await Q.getUserPixelsSold({
    offset: n,
    limit: t
})).data)
  , Zn = B("user/getUser", async(n,{rejectWithValue: t})=>{
    try {
  ...
  , oi = ie({
    ...
    extraReducers: n=>{
        n.addCase(Yn.pending, t=>{
            ...
            Is.upsertMany(t.pixelsForSale, s.payload.pixels),
            t.totalPrice = s.payload.totalPrice,
            t.pixelsForSaleTotal = s.payload.total,
            t.pixelsForSaleFetchStatus = u.fulfilled
        }
            ...
            t.verificatedWalletStatus = u.fulfilled
        }
            ...
            t.hasCaptchaCodeStatus = u.fulfilled
        }
            ...
            Ts.upsertMany(t.pixelsSold, s.payload.pixels),
            t.pixelsSoldTotal = s.payload.total,
            t.pixelsSoldFetchStatus = u.fulfilled
        }
            ...
            t.getUserFetchStatus = u.fulfilled
        }
  ...
  , {setLanguageCode: ad, setVerificatedWallet: od, setPixelsForSaleOffset: xB, setPixelsForSaleTotal: id, setPixelsForSaleFetchStatus: yB, removePixelsForSale: vB, setPixelsSoldOffset: wB, setPixelsSoldTotal: bB, setPixelsSoldFetchStatus: jB, removePixelsSold: PB, setShowRobotPopup: rd, addPixelCoins: CB, subtractPixelCoins: cd, setPixelCoins: ii, updateUserSquad: ld} = oi.actions
  , dt = n=>n.user.user
  , dd = oi.reducer
  , ze = {
    getPixelsForSale: Yn,
  ...
  , {addToast: O, removeToast: ao} = ri.actions
  , hd = ri.reducer
  , gd = ()=>{
    const n = g()
      , t = l($e)
...
const $n = B("mining/info", async()=>(await Ls.info()).data)
  ...
  , ts = B("mining/checkTask", async({key: n})=>(await Ls.checkTask({
    key: n
})).data)
  , ns = B("mining/checkBoost", async({key: n})=>(await Ls.checkBoost({
    key: n
})).data)
  , Kd = {
    info: null,
  ...
  , {setCheckError: NB, setActiveTab: Zd, setToggleAction: $d, setAllToggleActions: eu, setMaxCharges: tu, setRechargeSpeed: nu, setCharges: su, addCharges: li, addAddedCharges: au, subCharges: ou, restoreCharges: SB, setTask: iu} = ci.actions
  , ru = ci.reducer
  , vt = {
    info: $n,
    claim: es,
  ...
  , wn = ({size: n=11, className: t="", style: s={}, color: a="white", ...o})=>e.jsx("img", {
    alt: "",
    className: t,
    style: {
        width: `${n}px`,
  ...
  , Me = ({num: n})=>isNaN(n) ? null : new Intl.NumberFormat("en-US").format(n)
  , du = "_blocker_wufj5_1"
  , uu = "_popup_wufj5_11"
  , oo = {
    blocker: du,
  ...
  , Zt = ({show: n, setShow: t, children: s})=>{
    const [a,o] = m.useState(!1)
      , [i,r] = Cs(()=>({
        from: {
...
const Fa = Es.getSelectors(n=>n.daily.list);
Qa.getSelectors(n=>n.reward.list);
const pu = Bs.getSelectors(n=>n.ratings.pixanos)
  , di = gn.getSelectors(n=>n.tournament.approvedTemplatesList)
  ...
  , ct = ({x: n, y: t})=>n + t * I.width + 1
  , bn = ({x: n, y: t, width: s, blockSize: a=4})=>(n + t * s) * a
  , ra = ({index: n, width: t, blockSize: s=4})=>{
  ...
  , jn = n=>!(n.x < 0 || n.y < 0 || n.x > I.width - 1 || n.y > I.height - 1)
  , ss = B("canvas/repaint", async({pixelId: n, newColor: t})=>(await Q.startRepaint({
    pixelId: n,
    newColor: t
})).data);
let Mt = null;
const ya = B("canvas/getPixelInfo", async({id: n})=>(Mt !== null && (Mt.abort(),
Mt = null),
Mt = new AbortController,
(await Q.getPixelInfo({
    id: n,
    signal: Mt.signal
})).data))
  , as = B("canvas/getPrices", async()=>(await Q.getPrices()).data)
  , os = B("canvas/getPriceMask", async({price: n})=>{
  ...
  , gu = ()=>Qo() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"),
!0) : !0
  , _u = {
    coords: null,
    animations: gu(),
  ...
  , ui = ie({
    ...
    reducers: {
        setCoords: (n,t)=>{
            jn(t.payload) && (n.coords = t.payload)
        }
        ,
        ...
        ,
        addPaintCoords: (n,t)=>{
            jn(t.payload) && (n.stats = ct(t.payload) ^ 3201282)
        }
    },
    extraReducers: n=>{
        n.addCase(ya.pending, t=>{
            ...
            t.getPixelInfoFetchStatus = u.fulfilled,
            Mt = null
        }
  ...
  , {setCoords: Lt, enableAnimations: fu, disableAnimations: xu, addPaintCoords: yu, setPriceMask: IB, setSelectedPrice: TB, updatePixelInfo: EB} = ui.actions
  , vu = ui.reducer
  , Vs = {
    getPixelInfo: ya,
    getPriceMask: os,
...
class wu {
    ...
    drawPixel({x: t, y: s}) {
        ...
        this.pixel.drawRect(t - .1, s - .1, 1.2, 1.2),
    ...
    drawLine({x: t, y: s}) {
        ...
        this.line.moveTo(-.5, s).lineTo(t - .5, s),
        this.line.moveTo(t, -.5).lineTo(t, s - .5),
        this.line.moveTo(I.width - .5, s).lineTo(t + .5, s),
        this.line.moveTo(t, I.width - .5).lineTo(t, s + .5),
        this.line.zIndex = 10,
...
const Ce = {
  ...
  , {setProgressCommand: We} = pi.actions
  , ju = pi.reducer
...
let Mu = class {
    constructor({app: t, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 5,
        this.bombs = [Pu, Cu, Nu, Su, Iu, Tu, Eu, Bu, Du, ku, Ru, Uu, Ou],
        this.textureArray = [];
        for (let o = 0; o < 13; o++) {
            let i = PIXI.Texture.from(this.bombs[o]);
            i.baseTexture.scaleMode = PIXI.SCALE_MODES.NEAREST,
            this.textureArray.push(i)
        }
    }
...
const Qu = "_order_panel_dvy5p_1"
  ...
  , Gs = ({children: n, className: t="", style: s={}})=>e.jsx("div", {
  ...
  , it = ({active: n, setActive: t, children: s})=>e.jsx("div", {
  ...
  , mi = n=>n ? n.friends >= ac.friendsForTemplateCreation || n.isContractor : !1
  , Ke = {
    create: "create",
    main: "main",
    result: "result",
  ...
  , lp = ()=>{
    ...
    e.jsxs(Gs, {
        children: [e.jsx(it, {
            active: t === Ke.result,
            setActive: ()=>n(io(Ke.result)),
            children: "My results"
        }), e.jsx(it, {
            active: t === Ke.pixanos,
            setActive: ()=>n(io(Ke.pixanos)),
            children: "Pixanos'"
        })]
    })
}
...
class De {
    static async uploadTemplate({blob: t, posX: s, posY: a}) {
        ...
        return s && s !== "" && (o.posX = s),
        a && a !== "" && (o.posY = a),
        P.post("/image/template/upload", t, {
            headers: o
        })
    }
    ...
    static async getTemplateById({id: t}) {
        return nn !== null && (nn.abort(),
        nn = null),
        nn = new AbortController,
        P.get(`/image/template/${t}`, {
            signal: nn.signal
        })
    }
...
const is = B("tournament/getPeriods", async()=>(await Ai.getPeriods()).data)
  , rs = B("tournament/getResults", async()=>(await Ai.getResults()).data)
  , cs = B("tournament/getMyTemplate", async({id: n})=>(await De.getTournamentTemplateById({
    id: n
})).data)
  , ls = B("tournament/getSelectedTemplate", async()=>(await De.getSelectedTemplate()).data)
  , ds = B("tournament/getApprovedTemplatesList", async({offset: n, limit: t})=>(await De.getApprovedTemplatesList({
    offset: n,
    limit: t
})).data)
  , us = B("tournament/getRandomTemplatesList", async()=>(await De.getRandomTemplates()).data)
  , ps = B("tournament/selectTemplate", async({id: n})=>(await De.subscribeToTournamentTemplate({
    id: n
})).data)
  , dp = {
    activeTab: Ke.result,
  ...
  , hi = ie({
    ...
    reducers: {
        ...
        clearApprovedTemplateList: n=>{
            n.approvedTemplatesList = gn.getInitialState(),
    ...
    extraReducers: n=>{
        n.addCase(cs.pending, t=>{}
            ...
            t.resultsStatus = u.fulfilled,
            t.results = s.payload.rounds.sort((a,o)=>o.round_id - a.round_id)
        }
            ...
            s.payload && s.payload.list && (gn.addMany(t.approvedTemplatesList, s.payload.list.map(a=>({
                ...a,
                url: `${a.url}${sn}`
            }))),
            t.approvedTemplatesListOffset += 16,
            t.approvedTemplatesListTotal = Math.max(s.payload.total, t.approvedTemplatesListTotal)),
            t.approvedTemplatesListStatus = u.fulfilled
        }
            ...
            s.payload && s.payload.list && gn.setAll(t.approvedTemplatesList, s.payload.list.map(a=>({
                ...a,
                url: `${a.url}${sn}`
            }))),
  ...
  , {setActiveTournamentTab: io, setActiveTournamentTemplate: up, hideTournamentTemplates: pp, setShowTournamentDetailsPopup: gi, setShowRoundRewardsPopup: _i, changeTemplateCoordsIfNeeded: fi, setMyTournamentTemplate: DB, clearApprovedTemplateList: xi, showTournamentTemplateInfoPopup: za, closeTournamentTemplateInfoPopup: ca, setSelectedTemplate: yi} = hi.actions
  , Fe = {
    getMyTemplate: cs,
...
const yp = (n,t,s)=>{
    ...
    Ue = new Sr(Ba.replace("https", "wss").replace("api/v1/", "connection/websocket"),o),
    Ue.on("connected", function(i) {
        if (console.log(`connected over ${i.transport}`),
        !Fo())
            return;
        ...
        c.onload = ()=>{
            b.mainImage.loadFromCentrifuge(c).then(()=>{
                const p = Xe.getState().main.startParams.coords;
                ...
                b.mainImage.selectedPixel.draw(p),
                Xe.dispatch(Lt(p)))
            }
            )
        }
    ...
    Ue.on("publication", function(i) {
        if (i.channel === "event:message") {
            JSON.parse(new TextDecoder().decode(i.data)).forEach(d=>{
                ...
                if (d.type === ta.pixanos && Xe.dispatch(jp(p)),
                p.user.userId === t || !Pn)
                    return;
                const h = Xe.getState().canvas.animations;
                if (d.type === ta.bomb) {
                    const _ = Ds(p.info.pixelId);
        ...
        Ir(r, (c,d)=>{
            if (c)
                console.error("Ошибка распаковки данных:", c);
            else {
  ...
  , vi = ie({
    ...
    reducers: {
        ...
        setLastShowChargesPopupTs: (n,t)=>{
            ...
            Yt.save("lastShowChargesPopupTs", JSON.stringify(t.payload))
        }
        ,
    ...
    extraReducers: n=>{
        n.addCase(la.pending, (t,s)=>{
            ...
            t.pixanosRatingStatus = u.fulfilled,
  ...
  , {setTimeLimit: kB, updateSettings: RB, enableFastMode: wi, disableFastMode: Js, enableFastType: Ys, disableFastType: wt, enableFastEnergy: bp, disableFastEnergy: bi, setShowPixanosRating: da, showPixanosEvent: jp, hidePixanosEvent: Pp, setPixanosProcessing: ro, setShowIntro: UB, setShowBetaTestIntro: OB, setShowMiniPopup: MB, addFlyingReward: QB, removeFlyingReward: FB, showNoChargesPopup: zB, hideNoChargesPopup: ua, setLastShowChargesPopupTs: HB, setShowMiningDetailsPopup: Cp, setShowBoostDetailsPopup: qB, setActiveBoostDetails: LB, addItemToUserAndSquadPopupStack: En, removeItemFromUserAndSquadPopupStack: ji, setShowNoFlagsPopup: VB, setReferrerSquadId: ba} = vi.actions
  , Np = vi.reducer;
...
const Sp = "_layout_oxfjd_1"
  ...
  , dm = ({digit: n=0, fontSize: t=16, fontWeight: s=600, gap: a=6})=>{
    const [o,i] = m.useState(!0)
      , [r,c] = m.useState(0)
  ...
  , Bn = ({number: n, fontSize: t=16, fontWeight: s=600, gap: a=6, addSpace: o=!0})=>{
    if (n === void 0)
        return null;
    const i = String(n).split("").reverse();
    let r = [];
    for (let c = 0; c < i.length; c++)
        c % 3 === 0 && c !== 0 && o && r.push("space"),
        r.push(i[c]);
    return r = r.reverse(),
    e.jsx("div", {
        className: om.number,
  ...
  , {setIsTMA: pm, setIsAuth: mm, setAuthData: Am} = Pi.actions
  , Ha = n=>n.auth.isTMA
  , ke = n=>n.auth.isAuth
  , hm = Pi.reducer;
let pa = !1;
const gm = async({dispatch: n, amount: t, charges: s, maxCharges: a, status: o, state: i})=>{
    var c, d;
    if (!t && i && (t = i.shop.available[1],
    s = i.mining.charges,
    a = i.mining.maxCharges,
    o = i.shop.useProductStatus),
    !t || t === 0)
        return n(zs(10)),
        n(qe(1)),
        n(Le()),
    ...
    try {
        (await n(qs.useProduct({
            productId: 1,
            pixelId: 1
        }))).meta.requestStatus === u.fulfilled && (n(su(a)),
        n(Hs({
            product: 1,
            amount: 1
        })),
  ...
  , _m = ()=>{
    ...
    return r && c.push(N.fast_mode_button_enabled),
    t ? e.jsxs("button", {
  ...
  , {setShowSideMenu: gt} = Ci.actions
  , Ni = n=>n.layout.isShowSideMenu
  , xm = Ci.reducer;
let Tt = null
  , Et = null;
class qa {
...
const ms = B("ratings/personal", async({league: n, offset: t, limit: s})=>(await qa.personal({
    league: n,
    offset: t,
    limit: s
})).data)
  , As = B("ratings/squad", async({league: n, offset: t, limit: s})=>(await qa.squad({
    league: n,
    offset: t,
    limit: s
})).data)
  , hs = B("ratings/pixanos", async({offset: n, limit: t})=>(await qa.pixanos({
    offset: n,
    limit: t
})).data)
  , ym = {
  ...
  , Si = ie({
    ...
    extraReducers: n=>{
        n.addCase(ms.pending, (t,s)=>{
            ...
            t.pixanosStatus = u.fulfilled,
            s.payload.rating && Bs.setMany(t.pixanos, s.payload.rating),
  ...
  , {setActiveLeague: Ii, clearRatingList: Ti, setSelectedSection: Ei, clearPixanosRatingList: vm} = Si.actions
  , ft = {
    personal: ms,
    squad: As,
    pixanos: hs
  ...
  , wm = Si.reducer
  , gs = B("history/get", async({offset: n, limit: t})=>(await Q.getHistory({
    offset: n,
    limit: t
})).data)
  , bm = {
...
bt.startListening({
    ...
    effect: (n,t)=>{
        n.payload.activated && (t.dispatch(id(n.payload.totalUserPixels)),
        t.dispatch(ii(n.payload.userBalance))),
        t.dispatch(Cc(n.payload.goods))
    }
});
bt.startListening({
    ...
    effect: (n,t)=>{
        ...
        if (i) {
            if (o === Ye.energyLimit) {
                ...
                t.dispatch(tu(s.mining.maxCharges + d)),
                t.dispatch(li(d))
            }
...
bt.startListening({
    ...
    effect: (n,t)=>{
        ...
        Yt.save("boosts1", JSON.stringify(a))
    }
});
const Ws = Gt();
Ws.startListening({
    matcher: ce(Vs.getPriceMask.pending, ze.getPixelsForSale.pending, ze.getPixelsSold.pending, La.get.pending),
    effect: (n,t)=>{
        t.dispatch(We({
            command: Ce.start
        }))
...
Ws.startListening({
    matcher: ce(Vs.getPriceMask.fulfilled, ze.getPixelsForSale.fulfilled, ze.getPixelsSold.fulfilled, La.get.fulfilled),
    effect: (n,t)=>{
        t.dispatch(We({
            command: Ce.finish
        }))
...
Di.startListening({
    ...
    effect: (n,t)=>{
        t.dispatch(Ii(n.payload.data.league))
    }
});
const Dn = Gt();
Dn.startListening({
...
const Pm = {
  ...
  , _s = B("squad/getSquadInfo", async({id: n})=>(await Q.getSquadInfo({
    id: n
})).data)
  , ki = ie({
    name: "squad",
    ...
    extraReducers: n=>{
        n.addCase(_s.pending, t=>{
            ...
            t.info = s.payload,
            t.getInfoFetchStatus = u.fulfilled
        }
...
const Cm = ki.reducer
  ...
  , Sm = B("template/subscribe", async({id: n})=>(await De.subscribeToTemplate({
    id: n
})).data)
  , fs = B("template/getTemplateList", async({offset: n, limit: t})=>(await De.getTemplatesList({
    offset: n,
    limit: t
})).data)
  , Im = B("template/getAvailableSizes", async({userId: n})=>(await De.getAvailableSizes({
    userId: n
})).data)
  , xs = B("template/getReferredTemplate", async()=>(await De.getReferredTemplate()).data)
  , ja = B("template/getMyTemplate", async({id: n})=>(await De.getTemplateById({
    id: n
})).data)
  ...
  , Ri = ie({
    ...
    reducers: {
        setActiveTemplate: (n,t)=>{
            ...
            b.mainImage.worldTemplate.show(t.payload)
        }
        ,
    ...
    extraReducers: n=>{
        ...
        ).addCase(ja.pending, t=>{}
        ).addCase(ja.fulfilled, (t,s)=>{}
  ...
  , {setActiveTemplate: GB, setActiveTemplateTab: co, hideTemplates: Ui, setTemplateOpacity: XB, setReferredTemplate: Em, setMyTemplate: Bm, setTemplateListOffset: JB, clearTemplatesListData: Dm, setShowTemplateDetailsPopup: Oi, setShowTemplateInfoPopup: Pa} = Ri.actions
  , lt = {
  ...
  , Mi = ie({
    ...
    extraReducers: n=>{
        n.addCase(vs.pending, t=>{
            ...
            Es.setAll(t.list, s.payload.dailyAvailable),
            t.getDailyListFetchStatus = u.fulfilled
        }
  ...
  , Um = n=>{
    ...
    return Fa.selectById(n, t)
}
  , {setSelectedDaily: Om, updateOneDaily: YB, setShowHowDailyWorksPopup: Qi} = Mi.actions
  , Mm = Mi.reducer
  , Fi = {
    getList: vs,
    getFirstDaily: ws
}
  , bs = B("reward/getList", async({userId: n})=>(await Q.getRewards({
    userId: n
})).data)
  , ma = B("reward/getById", async({rewardId: n})=>(await Q.getRewardById({
    rewardId: n
})).data)
  , Qm = {
    showPopup: !1,
  ...
  , zi = ie({
    ...
    reducers: {
        ...
        ,
        setReward: (n,t)=>{
            n.id = t.payload.rewardId,
            n.rewardUserId = t.payload.rewardUserId,
            n.info = {
                ...t.payload.reward,
                user: t.payload.user,
                type: t.payload.type
  ...
  , {setReward: Fm, clearReward: WB, addReward: KB, removeReward: ZB, clearInventoryList: zm, showRewardPopup: Hm, hideRewardPopup: $B} = zi.actions
  , qm = {
    getListByUserId: bs
}
  , Lm = zi.reducer
...
$t.startListening({
    matcher: ce(Fe.getSelectedTemplate.fulfilled, yi),
    effect: (n,t)=>{
        const s = t.getState();
...
$t.startListening({
    ...
    effect: n=>{
        ...
        b.mainImage.tournamentTemplates.show(t)
    }
});
$t.startListening({
    matcher: ce(pp),
...
const kn = vr({
    ...
    devTools: !1,
    middleware: n=>[Dn.middleware, Di.middleware, Ws.middleware, bt.middleware, Va.middleware, $t.middleware, ...n()]
})
  , js = []
  , Vm = async({dispatch: n, flyCoords: t, paintCoords: s, activeColor: a})=>{
    ...
    try {
        ...
        console.log(c),
        c && c.balance && (n(ii(c.balance)),
        c.reward_user && (b.mainImage.reward.add(s),
        n(Fm({
  ...
  , Gm = ({history: n, dispatch: t, paintCoords: s})=>{
    t(Js()),
    n && n.push("/energy-over"),
    t(Lt(s)),
    b.mainImage.selectedPixel.draw(s)
}
  , Hi = async({history: n, charges: t, dispatch: s, flyCoords: a, paintCoords: o, pixelInfo: i, user: r, activeColor: c, state: d})=>{
    let p = !1;
    if (t <= 0)
        if (d && d.main.fastEnergy) {
            if (js.length > 0 && !(await Promise.allSettled(js)).every(_=>_.status === u.fulfilled || _.status === u.rejected))
                return;
            const A = await gm({
                dispatch: s,
                state: d
...
class Ym {
    constructor({app: t, viewport: s, store: a, mainImage: o}) {
        Rn(this, "isCoordsInExtraRewardZone", ({coords: t, x1: s, y1: a, imageSize: o})=>{
            const {x: i, y: r} = t
              , c = s + o
              , d = a + o;
        ...
        this.items.forEach((s,a)=>{
            for (let o = 0; o < s.imageSize; o++) {
                ...
                for (let i = 0; i < s.imageSize; i++) {
                    ...
                    Te.includes(c) || (t[t.length - 1][c] || (t[t.length - 1][c] = 0),
                    t[t.length - 1][c] += 1)
                }
            }
        }
...
const Wm = async({coords: n, dispatch: t, repaintReward: s, amount: a, state: o})=>{
    var r, c;
    if (!a && o && (a = o.shop.available[2]),
    !a || a === 0) {
        t(zs(10)),
        t(qe(2)),
        t(Le()),
  ...
  , Km = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      ...
      , c = [N.button, N.fast_type_button];
    return o === "bomb" && c.push(N.fast_mode_button_enabled),
    s ? e.jsxs("button", {
        className: `${c.join(" ")} ${N.shop_button}`,
        onPointerUp: ()=>{
            if (o === "bomb") {
  ...
  , Zm = async({coords: n, dispatch: t, repaintReward: s, activeColor: a, amount: o, state: i})=>{
    var c, d;
    if (!o && i && (o = i.shop.available[6]),
    !o || o === 0) {
        t(zs(10)),
        t(qe(6)),
        t(Le()),
  ...
  , $m = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      , r = 10 + String(a).length * 6
      , c = [N.button, N.fast_type_button];
    return o === "paintcan" && c.push(N.fast_mode_button_enabled),
    s ? e.jsxs("button", {
        className: `${c.join(" ")} ${N.shop_button}`,
        onPointerUp: ()=>{
            if (o === "paintcan") {
...
let yA = class {
    constructor({app: t, viewport: s, mainImage: a}) {
        ...
        this.mainImage = a,
        this.size = 7,
        this.images = [eA, tA, nA, sA, aA, oA, iA, rA, cA, lA, dA, uA, pA, mA, AA, hA, gA, _A, fA, xA],
        this.textureArray = [];
...
;
const vA = async({coords: n, dispatch: t, repaintReward: s, amount: a, state: o})=>{
    var r, c;
    if (!a && o && (a = o.shop.available[7]),
    !a || a === 0) {
        t(wt());
        return
    }
    b.mainImage.pumpkin.boom(n),
    t(qs.useProduct({
        pixelId: ct(n),
        productId: 7
    })),
  ...
  , wA = ()=>{
    ...
    const o = l(d=>d.main.currentFastType)
      , r = 10 + String(a).length * 6
      , c = [N.button, N.fast_type_button];
    return o === "pumpkin" && c.push(N.fast_mode_button_enabled),
  ...
  , bA = "/assets/particle_rays1-mrHjO6Jg.png"
...
class PA {
    constructor({ticker: t, viewport: s, store: a}) {
        this.ticker = t,
        this.pixiViewport = s.viewport,
        this.viewport = s,
        this.store = a,
    ...
    addBackdrop() {
        ...
        this.backdrop.drawRect(0, 0, I.width, I.height),
    ...
    async addRewardImage(t) {
        PIXI.Loader.shared.resources.tnt || await this.loadResource("tnt", jA),
...
class NA {
    constructor({app: t, viewport: s, store: a, ticker: o, readyCallback: i}) {
    ...
    initImage() {
        ...
        this.texture = t,
        this.sprite = PIXI.Sprite.from(t),
    ...
    async loadAllChunks() {
        const t = await this.loadImage(oc)
    ...
    async loadFromCentrifuge(t) {
        ...
        for (let o = 0; o < a.length; o += 4)
            this.imageData[o + 3] === 0 && (this.imageData[o] = a[o],
            this.imageData[o + 1] = a[o + 1],
            this.imageData[o + 2] = a[o + 2],
            this.imageData[o + 3] = a[o + 3]);
        this.updateTexture(),
        this.store.dispatch(We({
            command: Ce.finish
        })),
    ...
    async loadChunk({chunkIndex: t}) {
        ...
        for (let r = 0; r < o.length; r += 4) {
            ...
            this.imageData[d] = o[r],
            this.imageData[d + 1] = o[r + 1],
            this.imageData[d + 2] = o[r + 2],
            this.imageData[d + 3] = o[r + 3]
        }
        this.updateTexture(),
    ...
    paintSquare({x: t, y: s, size: a, colors: o}) {
        for (let i = 0; i < o.length; i++) {
            ...
            if (c.x < 0 || c.y < 0 || c.x > I.width || c.y > I.height)
                continue;
            const d = bn({
                x: c.x,
                y: c.y,
              ...
              , {r: p, g: A, b: h} = ht(o[i]);
            this.imageData[d] = p,
            this.imageData[d + 1] = A,
            this.imageData[d + 2] = h,
    ...
    paintPixel({id: t, color: s}) {
        ...
        this.imageData[o] = s.r,
        this.imageData[o + 1] = s.g,
        this.imageData[o + 2] = s.b,
        this.imageData[o + 3] = 255
    }
    ...
    getImageData(t, s, a) {
        ...
        return i.drawImage(t, 0, 0, s, a),
        i.getImageData(0, 0, s, a).data
    }
    isCoordsEqual(t, s) {
...
function kA() {
    b = new DA({
        readyCallback: async n=>{
            ...
            ((s = t.user.user) == null ? void 0 : s.websocketToken) === "" && n.dispatch(rd(!0)),
            yp((a = t.user.user) == null ? void 0 : a.websocketToken, (o = t.user.user) == null ? void 0 : o.id)
        }
    })
}
const RA = m.memo(()=>(m.useEffect(()=>{
    lo || (kA(),
    lo = !0)
}
, []),
Ze.createPortal(e.jsx("canvas", {
    ...
    return m.useEffect(()=>{
        function a(o) {
            o.ctrlKey && o.altKey && o.keyCode === 67 && (async()=>{
                try {
                    await Sn(window.Telegram.WebApp.initData),
                    await n(O({
                        id: performance.now(),
                        text: "Copied!"
                    }))
  ...
  , th = ({selectedSection: n, setSelectedSection: t})=>e.jsx("div", {
    className: Aa.panel,
  ...
  , Ga = ({position: n, userPic: t})=>e.jsxs("div", {
...
null)
  ...
  , Yh = ({selectedSection: n})=>n === "Painters" ? e.jsx(Xh, {}) : n === "Squads" ? e.jsx(Jh, {}) : null
  , Wh = ()=>{
    const n = g()
  ...
  , Kh = ()=>{
    ...
    , []);
    const s = ()=>{
        performance.now() - t.current < 200 && b.viewport.zoomIn(),
        clearInterval(n.current)
    }
    ;
    return e.jsx("button", {
  ...
  , Zh = ()=>{
    const n = m.useRef(null)
      , t = m.useRef(null)
      , s = ()=>{
        performance.now() - t.current < 200 && b.viewport.zoomOut(),
        clearInterval(n.current)
    }
    ;
    return m.useEffect(()=>()=>{
...
, backgroundColor: a})=>{
  ...
  , Sg = ()=>{
    ...
    if (!l(o=>o.canvas.coords))
        return null;
    const a = [N.button, N.fast_type_button, N.shop_button];
    return t && a.push(N.fast_mode_button_enabled),
    e.jsx("button", {
        className: a.join(" "),
        onPointerUp: ()=>{
            n(t ? Js() : wi())
  ...
  , Eg = ()=>l(t=>t.canvas.coords) ? e.jsx("div", {
    className: mo.layout,
    children: e.jsxs("div", {
        className: mo.container + " " + N.container__bottom,
        children: [e.jsx($m, {}), e.jsx(Km, {}), e.jsx(wA, {}), e.jsx(_m, {}), e.jsx(Sg, {}), e.jsx(Ig, {}), e.jsx(Tg, {})]
    })
}) : null
  , Bg = ({open: n, setOpen: t, active: s, setActive: a})=>{
  ...
  , Dg = ({open: n, setOpen: t, active: s, setActive: a})=>{
    const o = g()
      , i = [$.info_button];
    return n && s === 2 && i.push($.info_button_active),
    e.jsx("div", {
        className: i.join(" "),
        onPointerUp: r=>{
            r.stopPropagation(),
    ...
    e.jsxs("div", {
        ...
        children: [n && e.jsxs("div", {
            ...
            onPointerUp: async r=>{
                var d, p;
                r.stopPropagation(),
                await Sn(`${yt}?startapp=x${o.x}_y${o.y}`) ? (p = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || p.notificationOccurred("success") : a(!0),
                t(!1),
  ...
  , Fg = ({active: n})=>{
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx("div", {
            className: _n.divider_spacer,
            style: {
                flexGrow: s
            }
        }), e.jsx("div", {
            className: _n.divider_pointer,
            style: {
                width: t
            }
        })]
  ...
  , Ee = ({children: n, show: t})=>t ? e.jsx("div", {
  ...
  , jt = ({address: n, limit: t=0, display: s=null})=>{
    const a = l(Ha);
    if (!n || n === "")
        return e.jsx("span", {
            children: "Anon"
    ...
    e.jsx("span", {
        ...
        onPointerUp: i=>{
            i.stopPropagation(),
            a ? ue(`https://t.me/${Za(n)}`) : Nn(`https://t.me/${Za(n)}`)
        }
        ,
        children: o
    })
  ...
  , A_ = ({color: n})=>{
    ...
    return e.jsx("div", {
        ...
        onPointerUp: ()=>{
            ...
            , 200),
            o(ka(n)),
            (r = (i = window.Telegram.WebApp) == null ? void 0 : i.HapticFeedback) == null || r.notificationOccurred("success")
        }
    })
}
  , Gi = ({colors: n})=>e.jsx("div", {
    className: Vi.color_line,
  ...
  , y_ = ({open: n, setOpen: t, active: s})=>{
    ...
    e.jsxs(Ss.div, {
        ref: a,
        className: _n.expandable_panel_layout,
        style: {
            ...o
        },
        children: [e.jsx(x_, {
  ...
  , P_ = ()=>{
    const [n,t] = m.useState(!1)
      , [s,a] = m.useState(1)
      , o = l(r=>r.main.fastMode)
      , i = l(r=>r.main.currentFastType);
    return m.useEffect(()=>{
        (o || i) && t(!1)
    }
    , [o, i]),
  ...
  , Ji = "/assets/gold_pixel-CRD2C_ap.gif"
  , M_ = ()=>{
    const n = l(hp)
  ...
  , Q_ = ()=>{
    const n = l(et)
      , t = l(mp)
      , s = t ? Xi(new Date(t.EndTime)) : null;
    return e.jsxs("span", {
        className: ye.text,
        children: [e.jsxs("span", {
            className: ye.gold,
  ...
  , F_ = ()=>{
    const n = K()
      , t = l(et)
      , s = l(Ap);
    return Xi(s ? new Date(s.StartTime) : null),
    e.jsx("div", {
        className: ye.layout,
        onPointerUp: ()=>{
            n.push("/tournament")
  ...
  , Af = ({item: n})=>n.action === "buy pixel" ? e.jsx(sf, {
    item: n
...
null)
                ...
                children: [e.jsx("div", {
                    ...
                    children: e.jsxs("ol", {
                        children: [e.jsx("li", {
                            ...
                            children: ["Get rewarded in", " ", e.jsx(wn, {
                                size: 14,
                                style: {
  ...
  , en = ({url: n, className: t="", text: s="Copy referral link"})=>{
    const [a,o] = m.useState(null)
      , i = m.useRef(null);
    return e.jsxs("div", {
        className: `${Nx.link} ${t}`,
        onPointerUp: async r=>{
            ...
            r.stopPropagation(),
            c ? (o("Copied!"),
            (p = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || p.notificationOccurred("success")) : o("Can't copy :-("),
...
e.jsx("div", {
    ...
    return m.useEffect(()=>{
        try {
            ...
            Q.getMoreStats().then(y=>{
                ...
                A(C.daily_users),
                _(C.daily_repaints),
                x(Object.keys(C.top_countries).map(T=>({
                    key: T,
  ...
  , Yi = "/assets/button_dog_200x200-DtCBiZdv.gif"
  , dy = n=>{
    const t = n / 1e3
      , s = Math.floor(t / 60)
      , a = t % 60;
  ...
  , Vy = ({secondsLeft: n})=>{
    ...
    m.useEffect(()=>{
        ...
        if (x) {
            ...
            y.dailyId === a.id && Date.now() - y.ts < 10 * 60 * 1e3 ? h(!0) : h(!1),
    ...
    if (r) {
        ...
        return n && (y = `Claim in ${dc(n)}`),
        A && (y = "Pending transaction..."),
        e.jsxs("div", {
            className: k.content,
            children: [e.jsx("div", {
  ...
  , lv = ()=>{
    ...
    return m.useEffect(()=>{
        (i === u.idle || i === u.rejected) && n(Fi.getList())
    }
    , [i]),
    m.useEffect(()=>{
        let r = 0;
            ...
            children: [e.jsx("div", {
                ...
                children: e.jsx("div", {
                    ...
                    children: t.map((r,c)=>{
                        ...
                        r.id === s && (A.push(k.reward_item_active),
                        h.push(k.reward_item_amount_active)),
                        d && _.push(k.reward_item_title_premium),
                        d && !r.active && h.push(k.reward_item_amount_premium);
                        let w = Gy;
                        return c >= 8 && c <= 15 && (w = Xy),
                        c >= 16 && c <= 23 && (w = Jy),
                        c >= 24 && c <= 31 && (w = Yy),
                        e.jsxs("div", {
                            className: A.join(" "),
  ...
  , Xv = ({templateSize: n, setTemplateSize: t})=>{
    const s = g()
      , a = l(dt)
      , o = a.friends || 64
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx("div", {
            ...
            children: i.map(r=>{
                ...
                return n === r && c.push(X.template_size_item_active),
                e.jsx("div", {
                    className: c.join(" "),
                    onPointerUp: ()=>{
                        o >= Us[r] || a.isContractor ? t(r) : s(O({
                            id: performance.now(),
  ...
  , Wi = ({item: n, style: t={}})=>{
    const s = g();
    return e.jsx("div", {
        className: ln.template_item_container,
        style: {
            ...t
        },
        onPointerUp: async()=>{
        ...
        ,
        children: e.jsxs("div", {
            className: ln.template_item_inner,
            children: [e.jsx("img", {
                alt: "image",
                className: ln.template_image,
                src: n.url
            }), e.jsx("div", {
                className: ln.template_image_info_layout,
                children: e.jsxs("div", {
                    className: ln.template_image_info_container,
                    children: [e.jsx(D, {
                        children: ""
                    }), e.jsx("span", {
    ...
    return m.useEffect(()=>{
        ...
        if (t.current && a === u.fulfilled && !c) {
            const A = {
              ...
              , h = (_,w)=>{
                _.forEach(x=>{
                    x.intersectionRatio >= 1 && (n(lt.getList({
                        offset: o,
                        limit: i
                    })),
            ...
            ;
            p = new IntersectionObserver(h,A),
            p.observe(t.current)
        }
        return ()=>{
  ...
  , cw = ()=>{
    ...
    return m.useEffect(()=>(n(lt.getList({
        offset: t,
        limit: s
    })),
    ()=>{
    ...
    e.jsxs("div", {
        ...
        children: [e.jsx("div", {
            ...
            children: a.map(i=>{
                if (Number(i.templateId) === 0)
                    return null;
                let r = !1;
                return o !== null && Number(o.id) === Number(i.templateId) && (r = !0),
                e.jsx(Wi, {
                    item: i,
                    current: r
                }, i.templateId)
  ...
  , Ja = "/assets/paintings_anim2-nk1iBB8J.gif"
                ...
                try {
                    if (t && t !== 0) {
                        ...
                        (await n(lt.subscribe({
                            ...
                            const p = await n(lt.getTemplateById({
                                id: t
                            }))
                              , A = {
                                ...p.payload,
                            ...
                            n(Em(A)),
                            b.mainImage.worldTemplate.deleteTemplate(i.id),
                            b.mainImage.worldTemplate.add(A),
                            n(Ui())
                        } else
                            await n(O({
  ...
  , l1 = ()=>{
    ...
    if (r.dataSource === Ie.userFromPixelInfo)
        return {
            ready: s === u.fulfilled && n !== null,
            data: n == null ? void 0 : n.owner,
            item: r
        };
    if (r.dataSource === Ie.squadFromData)
        return {
  ...
  , d1 = ({isPopupContent: n=!0})=>{
    const {data: t, ready: s} = pt(n);
    if (!s)
        return e.jsx(Ee, {
            show: !s,
            children: e.jsx("div", {
  ...
  , A1 = ({active: n, setActive: t})=>e.jsxs(Gs, {
    style: {},
    children: [e.jsx(it, {
        active: n === "info",
        setActive: ()=>t("info"),
  ...
  , j1 = ({completed: n, item: t})=>e.jsxs("div", {
  ...
  , M1 = ({active: n, isPopupContent: t=!0})=>e.jsxs("div", {
  ...
  , H1 = ()=>{
    const n = g()
      , t = l(dt);
    return m.useEffect(()=>(t && t.id && n(qm.getListByUserId({
        userId: t.id
    })),
    ()=>{
        n(zm())
  ...
  , gb = ({active: n, setActive: t})=>e.jsx(Gs, {
    style: {},
    children: e.jsx(it, {
        active: n === "info",
        setActive: ()=>t("info"),
  ...
  , vb = ({isPopupContent: n, active: t, data: s, ready: a})=>e.jsxs("div", {
  ...
  , jb = ({dataUrl: n, loading: t, templateSize: s})=>e.jsx("div", {
  ...
  , Cb = ({loading: n, imageData: t, posX: s, posY: a})=>{
    const o = g()
      , i = K()
            ...
            onPointerUp: async()=>{
                try {
                    ...
                    if ((await De.uploadTemplate({
                        ...
                        const _ = await o(lt.getTemplateById({
                            id: c.id
                        }))
                          , w = {
                            ..._.payload,
                        ...
                        o(Bm(w)),
                        o(Ui()),
                        await b.mainImage.worldTemplate.add(w),
                        o(O({
                            id: performance.now(),
  ...
  , Nb = ({templateSize: n, setTemplateSize: t, coords: s, setCoords: a})=>(m.useState([16, 32, 64, 128]),
e.jsxs("div", {
    ...
    return m.useEffect(()=>{
        ...
        !i || s !== u.fulfilled || r && p && (_ = r == null ? void 0 : r.connectItems) != null && _.tonProof && !("error"in r.connectItems.tonProof) && Q.checkTonProof(r.connectItems.tonProof.proof, r.account).then(w=>{
            if (w.status === 200 && w.data.success)
                ...
                w.data && w.data.error && (x = w.data.error),
                n(O({
                    id: performance.now(),
                    text: x
                }))
  ...
  , lj = ()=>{
    const n = g()
      , [t] = Jt()
      , s = Xt()
      , {handleConnect: a, verificatedWalletUQ: o, formattedVerificatedWalletUQ: i} = Ya()
      , r = Da(s)
            ...
            children: [e.jsxs("div", {
                ...
                onPointerUp: async()=>{
                    ...
                    if (!(!p || p === "")) {
                        ...
                        try {
                            const _ = await s(ze.checkCaptcha({
                                wallet: i,
                                captcha: p
                            }));
                            if (_.meta.requestStatus === u.rejected)
                                throw new Error("error");
                            if ((h = _.payload) != null && h.success)
                                s(O({
                                    id: performance.now(),
                                    text: "Success!",
                                    icon: ""
  ...
  , uj = "_container_1g9kx_1"
  , pj = "_title_1g9kx_10"
  , mj = "_wallet_address_1g9kx_15"
  , Aj = "_image_1g9kx_19"
  , hj = "_dot_1g9kx_24"
  , gj = "_text_button_1g9kx_30"
  , Dt = {
    container: uj,
    title: pj,
    wallet_address: mj,
  ...
  , _j = ()=>{
    const {handleConnect: n, formattedVerificatedWalletUQ: t} = Ya()
  ...
  , xj = "_general_info_container_1u2nd_1"
  , yj = "_img_container_1u2nd_7"
  , vj = "_image_1u2nd_17"
  , wj = "_image_cup_1u2nd_23"
  , bj = "_image_glow_container_1u2nd_29"
  , jj = "_image_glow_1u2nd_29"
  , Pj = "_rotate_1u2nd_1"
  , Cj = "_image_glow_reverse_1u2nd_48"
  , Nj = "_title_1u2nd_53"
  , Sj = "_description_container_1u2nd_60"
  , Ij = "_description_1u2nd_60"
  , Tj = "_gold_1u2nd_73"
  , Ne = {
    general_info_container: xj,
    img_container: yj,
    image: vj,
    image_cup: wj,
    image_glow_container: bj,
    image_glow: jj,
    rotate: Pj,
    image_glow_reverse: Cj,
    title: Nj,
    description_container: Sj,
    description: Ij,
    gold: Tj
}
  , Ej = "_info_layout_1p9dg_1"
  , Bj = {
    info_layout: Ej
}
  , Dj = n=>{
  ...
  , kj = "_instruction_container_17lvx_1"
  , Rj = "_img_container_17lvx_9"
  , Uj = "_img_inner_container_17lvx_16"
  , Oj = "_image_17lvx_22"
  , Mj = "_image_status_17lvx_30"
  , Qj = "_image_status_rejected_17lvx_45"
  , Fj = "_image_status_review_17lvx_49"
  , zj = "_image_status_approved_17lvx_53"
  , Hj = "_copy_button_container_17lvx_57"
  , qj = "_button_copy_17lvx_65"
  , Lj = "_gray_17lvx_71"
  , Vj = "_preview_container_17lvx_75"
  , Gj = "_preview_image_container_17lvx_81"
  , Xj = "_preview_image_17lvx_81"
  , Jj = "_preview_image_loader_17lvx_94"
  , Yj = "_template_size_17lvx_109"
  , Wj = "_template_title_17lvx_117"
  , Kj = "_template_size_container_17lvx_122"
  , Zj = "_template_size_item_17lvx_128"
  , $j = "_template_size_item_active_17lvx_136"
  , e0 = "_template_coords_17lvx_141"
  , t0 = "_template_coordinates_title_17lvx_151"
  , n0 = "_template_coords_container_17lvx_156"
  , s0 = "_coords_item_17lvx_163"
  , a0 = "_coords_input_17lvx_169"
  , o0 = "_file_button_container_17lvx_178"
  , i0 = "_file_button_17lvx_178"
  , ne = {
    instruction_container: kj,
    img_container: Rj,
    img_inner_container: Uj,
    image: Oj,
    image_status: Mj,
    image_status_rejected: Qj,
    image_status_review: Fj,
    image_status_approved: zj,
    copy_button_container: Hj,
    button_copy: qj,
    gray: Lj,
    preview_container: Vj,
    preview_image_container: Gj,
    preview_image: Xj,
    preview_image_loader: Jj,
    template_size: Yj,
    template_title: Wj,
    template_size_container: Kj,
    template_size_item: Zj,
    template_size_item_active: $j,
    template_coords: e0,
    template_coordinates_title: t0,
    template_coords_container: n0,
    coords_item: s0,
    coords_input: a0,
    file_button_container: o0,
    file_button: i0
}
  , kt = {
    approved: "approved",
  ...
  , r0 = ()=>{
    ...
    let s = kt.review;
    return t && t.approved && (s = kt.approved),
    t && (t.deletedAt || t.approved === !1) && (s = kt.rejected),
    e.jsxs("div", {
  ...
  , c0 = ({dataUrl: n, loading: t, templateSize: s})=>e.jsx("div", {
  ...
  , l0 = ({templateSize: n, setTemplateSize: t})=>{
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx("div", {
            ...
            children: s.map(a=>{
                ...
                return n === a && o.push(ne.template_size_item_active),
                e.jsx("div", {
                    className: o.join(" "),
                    onPointerUp: ()=>{
                        t(a)
  ...
  , u0 = ()=>{
    ...
    return m.useEffect(()=>{
        if (s !== null) {
            ...
            const x = async()=>{
                ...
                y.width = d,
                y.height = d,
                C.drawImage(s, z, Re, we, be);
                const Pt = C.getImageData(0, 0, d, d);
                Dj(Pt),
                C.putImageData(Pt, 0, 0),
                i(Pt),
                c(y.toDataURL())
            }
            ;
    ...
    e.jsxs("div", {
        ...
        children: [r === null && e.jsx(r0, {}), r !== null && e.jsx(c0, {
            loading: _,
            dataUrl: r,
            templateSize: d
        }), r !== null && e.jsx(l0, {
  ...
  , p0 = "_layout_1c7e5_1"
  , m0 = "_container_1c7e5_5"
  , A0 = "_button_container_1c7e5_11"
  , h0 = "_button_1c7e5_11"
  , g0 = "_end_of_list_button_1c7e5_27"
  , ot = {
    layout: p0,
    container: m0,
    button_container: A0,
    button: h0,
    end_of_list_button: g0
}
  , _0 = "_template_item_container_1c93x_1"
  , f0 = "_template_item_inner_1c93x_12"
  , x0 = "_template_item_picked_1c93x_28"
  , y0 = "_template_item_rejected_1c93x_43"
  , v0 = "_template_item_shadow_1c93x_58"
  , w0 = "_template_rank_1c93x_70"
  , b0 = "_template_recolors_1c93x_90"
  , j0 = "_template_recolors_pixel_1c93x_105"
  , P0 = "_template_image_1c93x_112"
  , Ve = {
    template_item_container: _0,
    template_item_inner: f0,
    template_item_picked: x0,
    template_item_rejected: y0,
    template_item_shadow: v0,
    template_rank: w0,
    template_recolors: b0,
    template_recolors_pixel: j0,
    template_image: P0
}
  , ar = ({item: n, rank: t, repaints: s, style: a={}})=>{
    const o = g()
  ...
  , N0 = ()=>{
    const n = g()
      ...
      , a = l(di.selectAll);
    return m.useEffect(()=>(n(Fe.getApprovedList({
        offset: t,
        limit: s
    })),
    ()=>{
  ...
  , S0 = ()=>{
    ...
    return m.useEffect(()=>(n(Fe.getRandomList()),
    ()=>{
        n(xi())
    }
    ), []),
    e.jsx("div", {
        ...
        children: e.jsx("div", {
            className: ot.container,
            children: t.map((o,i)=>i + 1 > a ? null : e.jsx(ar, {
                item: o
            }, o.id))
        })
    })
}
  , I0 = "_round_info_container_1d52c_1"
  , T0 = "_title_1d52c_7"
  , E0 = "_description_1d52c_12"
  , B0 = "_round_status_container_1d52c_17"
  , nt = {
    round_info_container: I0,
    title: T0,
    description: E0,
    round_status_container: B0
}
  , D0 = "_round_indicator_mgwmo_1"
  , k0 = "_round_indicator_wait_mgwmo_37"
  , or = {
    round_indicator: D0,
    round_indicator_wait: k0
}
  , R0 = ()=>e.jsx("div", {
  ...
  , U0 = ()=>{
    ...
    n ? e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
            children: [e.jsxs("div", {
                className: nt.title,
                children: ["Top ", Uo[n].templateThreshold, " ", "templates will win"]
            }), e.jsx("div", {
  ...
  , O0 = ()=>{
    ...
    return e.jsxs("div", {
        children: [e.jsx(U0, {}), n && t === u.fulfilled && e.jsx(N0, {}), !n && t === u.fulfilled && e.jsx(S0, {})]
    })
}
  , M0 = "_soon_la5q2_1"
  , Q0 = "_active_round_instruction_la5q2_11"
  , F0 = "_not_active_round_instruction_la5q2_19"
  , z0 = "_round_container_la5q2_25"
  , H0 = "_round_title_la5q2_33"
  , q0 = "_round_title_text_la5q2_38"
  , L0 = "_round_indicator_la5q2_43"
  , V0 = "_round_status_success_la5q2_49"
  , G0 = "_round_status_fail_la5q2_60"
  , X0 = "_success_la5q2_71"
  , J0 = "_fail_la5q2_75"
  , Y0 = "_gray_la5q2_79"
  , W0 = "_round_main_info_la5q2_83"
  , K0 = "_round_image_container_la5q2_89"
  , Z0 = "_round_image_la5q2_89"
  , $0 = "_round_lines_container_la5q2_103"
  , eP = "_round_line_la5q2_103"
  , tP = "_divider_la5q2_117"
  , nP = "_pixels_number_la5q2_124"
  , sP = "_pixel_la5q2_124"
  , aP = "_past_rounds_la5q2_136"
  , oP = "_past_rounds_divider_la5q2_145"
  , H = {
    soon: M0,
    active_round_instruction: Q0,
    not_active_round_instruction: F0,
    round_container: z0,
    round_title: H0,
    round_title_text: q0,
    round_indicator: L0,
    round_status_success: V0,
    round_status_fail: G0,
    success: X0,
    fail: J0,
    gray: Y0,
    round_main_info: W0,
    round_image_container: K0,
    round_image: Z0,
    round_lines_container: $0,
    round_line: eP,
    divider: tP,
    pixels_number: nP,
    pixel: sP,
    past_rounds: aP,
    past_rounds_divider: oP
}
  , iP = ({result: n})=>{
    const t = g()
      , s = l(et);
            ...
            children: [e.jsx("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("div", {
                        ...
                        className: R(p ? H.success : H.fail),
                        children: ["👑 ", c]
                    })]
                }), e.jsxs("div", {
  ...
  , lP = "_container_6kfol_1"
  , dP = "_item_6kfol_7"
  , uP = "_rating_main_info_6kfol_21"
  , pP = "_rating_name_6kfol_34"
  , mP = "_rating_value_6kfol_41"
  , AP = "_pixanos_img_6kfol_47"
  , Qt = {
    container: lP,
    item: dP,
    rating_main_info: uP,
  ...
  , fP = "_dark_nc6lj_22"
  , xP = "_blue_nc6lj_36"
  , yP = "_disabled_nc6lj_52"
  , vP = "_loading_nc6lj_57"
  , yo = {
    button: gP,
    decor: _P,
    dark: fP,
  ...
  , rr = ({children: n, variant: t=xn.dark, onPointerUp: s=()=>{}
, style: a={}, className: o=void 0, disabled: i=!1})=>e.jsx("button", {
    disabled: i,
    onPointerUp: s,
  ...
  , wP = ({children: n, variant: t=xn.dark, onPointerUp: s=()=>{}
, style: a={}, className: o=void 0, disabled: i=!1, status: r=u.idle, offset: c, limit: d, total: p})=>{
    const A = c >= p && r !== u.pending
      , h = r === u.pending
      , _ = A ? xn.disabled : h ? xn.loading : t;
    return e.jsx(rr, {
        variant: _,
        onPointerUp: A ? ()=>{}
        : s,
  ...
  , MP = "_layout_17ca7_1"
  , QP = "_container_17ca7_6"
  , FP = "_close_button_17ca7_20"
  , zP = "_title_container_17ca7_28"
  , HP = "_title_17ca7_28"
  , qP = "_image_container_17ca7_39"
  , LP = "_image_17ca7_39"
  , VP = "_image_placeholder_17ca7_53"
  , GP = "_info_container_17ca7_60"
  , XP = "_info_row_17ca7_66"
  , JP = "_info_title_17ca7_71"
  , YP = "_info_value_blue_17ca7_75"
  , WP = "_info_value_white_17ca7_80"
  , KP = "_buttons_container_17ca7_84"
  , ZP = "_button_17ca7_84"
  , $P = "_not_button_17ca7_100"
  , eC = "_button_copy_17ca7_111"
  , V = {
    layout: MP,
    container: QP,
    close_button: FP,
  ...
  , tC = ({template: n, style: t={}, onPointerUp: s=()=>{}
})=>{
    const a = g()
        ...
        onPointerUp: async()=>{
            try {
                ...
                (await a(Fe.selectTemplate({
                    id: n.id
                }))).meta.requestStatus === u.fulfilled && a(yi(n))
            } catch (r) {
  ...
  , sC = ()=>{
    ...
    return l(et),
    !a || !s ? null : Ze.createPortal(e.jsx(ut, {
        onPointerUp: ()=>n(ca()),
        show: s,
        children: e.jsx("div", {
            className: V.layout,
  ...
  , lC = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e"
  , dC = ({size: n, style: t={}, animation: s=!1})=>e.jsx("img", {
    alt: "image",
    src: lC,
...
, ()=>!1)
  , pC = "_container_tuzgg_1"
  , mC = "_column_tuzgg_9"
  , AC = "_column_rev_tuzgg_17"
  , hC = "_title_tuzgg_26"
  , gC = "_table_container_tuzgg_32"
  , _C = "_table_row_tuzgg_38"
  , fC = "_button_tuzgg_45"
  , xC = "_value_tuzgg_52"
  , yC = "_notpixel_icon_tuzgg_58"
  , vC = "_active_row_tuzgg_74"
  , wC = "_row_title_tuzgg_74"
  , me = {
    container: pC,
    column: mC,
    column_rev: AC,
    ...
    return e.jsx(Zt, {
        ...
        children: e.jsxs("div", {
            ...
            children: [e.jsx("img", {
                ...
                className: me.table_container,
                children: jC.map((a,o)=>e.jsxs("div", {
                    className: me.table_row,
                    children: [e.jsx("div", {
                        children: a.name
                    }), e.jsxs("div", {
  ...
  , SC = ()=>{
    const n = g()
      , s = l(Kt) ? "calc(12px + var(--safe-area-top))" : "calc(12px + var(--header-height))";
    return e.jsxs("button", {
        className: wo.button,
        style: {
            top: s
        ...
        children: [e.jsx("span", {
            ...
            className: `telegram_icons ${wo.icon}`,
            children: ""
        })]
    })
}
  ...
  , TC = "_container_16f9l_1"
  , EC = "_image_container_16f9l_9"
  , BC = "_image_16f9l_9"
  , DC = "_title_container_16f9l_18"
  , kC = "_text_container_16f9l_27"
  , RC = "_title_16f9l_18"
  , UC = "_gray_16f9l_39"
  , OC = "_bold_16f9l_43"
  , MC = "_input_16f9l_47"
  , QC = "_catalog_container_16f9l_72"
  , FC = "_catalog_title_16f9l_77"
  , zC = "_catalog_items_container_16f9l_82"
  , HC = "_catalog_item_16f9l_82"
  , qC = "_catalog_item_image_container_16f9l_101"
  , LC = "_catalog_item_image_16f9l_101"
  , VC = "_button_container_16f9l_110"
  , GC = "_button_16f9l_110"
  , XC = "_wrong_helper_text_16f9l_125"
  , JC = "_wrong_button_16f9l_130"
  , YC = "_wrong_button_text2_16f9l_143"
  , S = {
    container: TC,
    image_container: EC,
    image: BC,
    ...
    bold: OC,
    input: MC,
    catalog_container: QC,
    catalog_title: FC,
    catalog_items_container: zC,
    catalog_item: HC,
    catalog_item_image_container: qC,
    catalog_item_image: LC,
    button_container: VC,
    button: GC,
    wrong_helper_text: XC,
    wrong_button: JC,
    wrong_button_text2: YC
}
  , WC = "/assets/box_1-CzUKXu07.gif"
  , KC = "/assets/box_2-wR9cQS7q.gif"
  , ZC = "/assets/box_3-g_PL1kKM.gif"
  , $C = "/assets/dogs-D0jtZggB.gif"
  , eN = "/assets/secret_word-BTKB1fAO.gif"
  , tN = "/assets/cube_youtube_2-BqessN1a.gif"
  , nN = "/assets/cube_twitter_3_m_-Bxf2Qx_E.gif"
  , Hn = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
    ...
    m.useEffect(()=>{
        (async()=>{
            ...
            C.status === 200 && C.data && C.data.forEach(T=>{
                T.group_name === Hn.Ghost && d({
                    count: T.usage_count,
                    limit: T.limit
                }),
                T.group_name === Hn.Mythical && A({
                    count: T.usage_count,
                    limit: T.limit
                }),
                T.group_name === Hn.Magical && _({
                    count: T.usage_count,
                    limit: T.limit
                }),
                T.group_name === Hn.Dogs && x({
                    count: T.usage_count,
                    limit: T.limit
                })
            }
  ...
  , iN = "_layout_1djp8_1"
  , rN = "_loading_container_1djp8_8"
  , cN = "_image_container_1djp8_20"
  , lN = "_image_1djp8_20"
  , dN = "_text_1djp8_29"
  , un = {
    layout: iN,
    loading_container: rN,
    image_container: cN,
    image: lN,
    text: dN
}
  , uN = "_buttons_container_rjvnl_1"
  , pN = "_group_rjvnl_8"
  , mN = "_left_rjvnl_15"
  , AN = "_middle_rjvnl_21"
  , hN = "_right_rjvnl_29"
  , gN = "_number_rjvnl_36"
  , _N = "_button_rjvnl_1"
  , fN = "_ratings_button_rjvnl_55"
  , xN = "_stars_button_rjvnl_62"
  , yN = "_shop_button_rjvnl_70"
  , vN = "_burger_button_rjvnl_79"
  , wN = "_relative_button_rjvnl_89"
  , bN = "_telegram_button_rjvnl_116"
  , jN = "_button_img_rjvnl_124"
  , PN = "_avatar_img_rjvnl_129"
  , CN = "_open_menu_button_rjvnl_134"
  , NN = "_open_menu_button_image_rjvnl_144"
  , SN = "_my_pixels_amount_rjvnl_149"
  , IN = "_header_content_rjvnl_154"
  , ge = {
    ...
    avatar_img: PN,
    open_menu_button: CN,
    open_menu_button_image: NN,
    my_pixels_amount: SN,
    header_content: IN
}
  , TN = ()=>l(ke) ? null : e.jsxs("button", {
  ...
  , Po = ()=>{
    const n = l(s=>s.user.user)
      , t = [Pe.league];
    return n !== null && jo.hasOwnProperty(n.league) ? (t.push(jo[n.league]),
    e.jsx("div", {
        className: t.join(" ")
    })) : null
}
...
const ON = ()=>{
    ...
    return m.useEffect(()=>{
        const s = ()=>{
            aN.includes(n.pathname) ? t.push("/") : t.goBack()
        }
        ;
        return window.Telegram.WebApp.onEvent("backButtonClicked", s),
        n.pathname !== Co && (n.pathname === "/" ? window.Telegram.WebApp.BackButton.hide() : window.Telegram.WebApp.BackButton.show(),
        Co = n.pathname),
        ()=>{
  ...
  , FN = ()=>{
    ...
    return m.useEffect(()=>{
        ...
        const A = h=>{
            a === null && (a = h);
            const w = (h - a) / r;
            i !== h && (o = Math.min(w * c, c),
            n.current && (n.current.style.width = `${o}%`)),
            i = h,
            o < c && (d = requestAnimationFrame(A))
        }
        ;
        return t === Ce.start && (d = requestAnimationFrame(A),
        n.current && (n.current.style.display = "block")),
        t === Ce.finish && (n.current && (n.current.style.width = "100%"),
        p = setTimeout(()=>{
  ...
  , LN = "_title_1cfz6_32"
  , VN = "_body_1cfz6_37"
  , GN = "_image_container_1cfz6_51"
  , XN = "_image_1cfz6_51"
  , JN = "_content_container_1cfz6_62"
  , YN = "_description_container_1cfz6_70"
  , WN = "_description_item_1cfz6_77"
  , KN = "_amount_selector_container_1cfz6_84"
  , ZN = "_amount_selector_button_1cfz6_90"
  , $N = "_amount_selector_count_1cfz6_103"
  , e2 = "_button_container_1cfz6_114"
  , t2 = "_crypto_button_container_1cfz6_120"
  , n2 = "_error_1cfz6_134"
  , s2 = "_not_available_1cfz6_141"
  , a2 = "_button_1cfz6_114"
  , o2 = "_star_color_1cfz6_167"
  , i2 = "_tokens_selector_1cfz6_173"
  , r2 = "_tokens_title_1cfz6_178"
  , c2 = "_connect_wallet_text_title_1cfz6_185"
  , l2 = "_tokens_container_1cfz6_194"
  , d2 = "_token_item_1cfz6_201"
  , u2 = "_token_image_container_1cfz6_212"
  , p2 = "_token_image_1cfz6_212"
  , m2 = "_sale_box_1cfz6_222"
  , A2 = "_sale_text_1cfz6_234"
  , q = {
    container: zN,
    header: HN,
    close: qN,
    ...
    image_container: GN,
    image: XN,
    content_container: JN,
    description_container: YN,
    description_item: WN,
    amount_selector_container: KN,
    amount_selector_button: ZN,
    amount_selector_count: $N,
    button_container: e2,
    crypto_button_container: t2,
    error: n2,
    not_available: s2,
    button: a2,
    star_color: o2,
  ...
  , P2 = m.memo(({runParticle: n, setRunParticle: t})=>{
    const [s,a] = m.useState(j2())
      , [o,i] = m.useState(!1);
    return m.useEffect(()=>{
        n && setTimeout(()=>{
            i(!0),
  ...
  , S2 = ({success: n})=>{
    ...
    if (i)
        return e.jsxs(ae.Fragment, {
            children: ["Buy for ", e.jsx(N2, {}), Math.round(i * (r ? s : 1) * 100) / 100, e.jsx("div", {
  ...
  , I2 = ({setError: n, setRunParticle: t})=>{
    var be;
    const s = g()
      ...
      , y = Xt();
    if (l(z=>z.shop.selectedCurrency) === 1 || y === "")
        return null;
    const T = async z=>{
      ...
      , we = async z=>{
        const Re = new ea.HttpProvider("https://toncenter.com/api/v2/jsonRPC")
          , pr = await new ea.token.jetton.JettonMinter(Re,{
            address: At[o]
        }).getJettonWalletAddress(new ea.utils.Address(y))
          , mr = he.Address.parse(y)
          , Ar = he.Address.parse(xa)
          , hr = he.beginCell().storeUint(0, 32).storeStringTail(z.txMemCode).endCell();
        let $s = he.toNano(z.strAmount);
        Number(o) === 4 && ($s = $s / 1000n);
        const gr = he.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins($s).storeAddress(Ar).storeAddress(mr).storeBit(0).storeCoins(he.toNano("0.01")).storeBit(1).storeRef(hr).endCell()
          , _r = {
            validUntil: Math.floor(Date.now() / 1e3) + 600,
            messages: [{
                address: pr.toString(!0, !0, !0),
                amount: "101000000",
                payload: gr.toBoc().toString("base64")
            }]
        };
        await A.sendTransaction(_r),
        t(!0),
        p(!0),
        c(u.fulfilled)
    }
        ...
        onPointerUp: async z=>{
            ...
            if (r !== u.pending) {
                ...
                try {
                    ...
                    if (o === 2)
                        await T(Re.data);
                    else if (o === 3 || o === 4 || o === 5 || o === 6 || o === 7 || o === 8 || o === 9)
                        await we(Re.data);
                    else
  ...
  , B2 = ({setError: n, setRunParticle: t})=>{
    const s = g()
            ...
            try {
                ...
                y.status === 200 && ((x = y == null ? void 0 : y.data) == null ? void 0 : x.ok) === !0 && window.Telegram.WebApp.openInvoice(y.data.result, C=>{
                    ...
                    if (C === "paid") {
                        ...
                        p(!0),
                        (be = (we = window.Telegram.WebApp) == null ? void 0 : we.HapticFeedback) == null || be.notificationOccurred("error"),
                        t(!0)
                    } else
                        n("Error, try again.")
                }
...
null)
  ...
  , R2 = ()=>{
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx(k2, {}), e.jsx(C2, {}), e.jsx(D2, {}), e.jsx(P2, {
            runParticle: s,
            setRunParticle: a
        }), n && e.jsx("div", {
            className: q.error,
  ...
  , O2 = "_container_1rmx4_1"
  , M2 = "_max_value_1rmx4_9"
  , Io = {
    container: O2,
    max_value: M2
}
...
const Q2 = ()=>{
    const n = g()
      ...
      , [i,r] = m.useState([s])
      , [c,d] = m.useState(Rt(s).max)
      , [p,A] = m.useState(Rt(s).min)
      , [h,_] = m.useState(Rt(s).step)
      , w = c === 5e3 ? "5000" : `${c}+`
      , x = C=>{
        const T = C[0];
        n(zs(To(T, h))),
    ...
    return o ? null : e.jsxs("div", {
        ...
        children: [e.jsx(fa.Range, {
            ...
            onChange: x,
            onFinalChange: y,
            renderTrack: ({props: C, children: T})=>e.jsx("div", {
            ...
            renderThumb: ({props: C, isDragged: T})=>m.createElement("div", {
                ...C,
                key: C.key,
                style: {
                    ...C.style,
  ...
  , F2 = ()=>e.jsxs("div", {
    ...
    ,
    children: [e.jsx(g2, {}), e.jsxs("div", {
        className: q.content_container,
        children: [e.jsx(_2, {}), e.jsx(U2, {}), e.jsx(Q2, {})]
    }), e.jsx(R2, {})]
})
  , z2 = ()=>{
    ...
    return Ze.createPortal(e.jsx(ut, {
        ...
        children: e.jsxs("div", {
            ...
            children: [e.jsx(h2, {}), e.jsx(F2, {})]
        })
    }), document.body)
}
  , H2 = "_layout_9sf1k_1"
  , q2 = "_container_9sf1k_13"
  , L2 = "_header_9sf1k_20"
  , V2 = "_title_9sf1k_30"
  , G2 = "_body_9sf1k_35"
  , X2 = "_image_container_9sf1k_47"
  , J2 = "_image_9sf1k_47"
  , Y2 = "_shake_9sf1k_1"
  , W2 = "_description_container_9sf1k_60"
  , K2 = "_buyer_info_9sf1k_70"
  , Z2 = "_avatar_9sf1k_78"
  , $2 = "_name_9sf1k_84"
  , eS = "_squad_info_9sf1k_88"
  , tS = "_squad_avatar_9sf1k_94"
  , nS = "_text_container_9sf1k_100"
  , sS = "_text_9sf1k_100"
  , aS = "_thanos_snap_container_9sf1k_110"
  , oS = "_thanos_snap_text_9sf1k_119"
  , iS = "_button_container_9sf1k_126"
  , rS = "_button_9sf1k_126"
  , le = {
    layout: H2,
    container: q2,
    header: L2,
...
async function AS(n, t, s) {
    const a = cS
      , o = lS
      , i = Eo(n, a, n.VERTEX_SHADER)
      , r = Eo(n, o, n.FRAGMENT_SHADER)
      , c = n.createProgram();
    return n.attachShader(c, i),
    n.attachShader(c, r),
    n.linkProgram(c),
...
function gS(n) {
    ...
    v.texImage2D(v.TEXTURE_2D, 0, v.RGBA, v.RGBA, v.UNSIGNED_BYTE, t);
    const a = v.getUniformLocation(xe, "u_Texture");
    v.uniform1i(a, 0)
}
function _S() {
    const n = new ImageData(I.width,I.height);
    return n.data.set(b.mainImage.imageData.slice(0)),
    n
}
function fS(n) {
...
function xS(n) {
    const {viewportWidth: t, viewportHeight: s, textureWidth: a, textureHeight: o, textureLeft: i, textureTop: r, min: c} = fS(n);
    Ps = c * c,
    Je(v, xe, "u_AnimationDuration", lr),
    Je(v, xe, "u_ParticleSize", dS),
    Je(v, xe, "u_ViewportWidth", t),
    Je(v, xe, "u_ViewportHeight", s),
    Je(v, xe, "u_TextureWidth", a),
    Je(v, xe, "u_TextureHeight", o),
    Je(v, xe, "u_TextureLeft", i),
    Je(v, xe, "u_TextureTop", r);
    const d = new Array(Ps);
    for (let h = 0; h < Ps; h++)
        d[h] = h;
    const p = v.createBuffer();
    v.bindBuffer(v.ARRAY_BUFFER, p),
    v.bufferData(v.ARRAY_BUFFER, new Float32Array(d), v.STATIC_DRAW);
    const A = v.getAttribLocation(xe, "a_ParticleIndex");
    v.enableVertexAttribArray(A),
    v.vertexAttribPointer(A, 1, v.FLOAT, !1, 0, 0)
}
function dr() {
    requestAnimationFrame(yS)
}
function yS(n) {
    ...
    Je(v, xe, "u_ElapsedTime", s),
    v.drawArrays(v.POINTS, 0, Ps),
    dr()
}
function Je(n, t, s, a) {
...
const vS = ()=>{
    ...
    if (m.useEffect(()=>{
        s && a && (async()=>{
            ...
            try {
                ...
                console.error(p, "cannot run pixanos")
            }
            n.push("/"),
            b.mainImage.pixanosRepaint(a.info.seed, I.width, a.info.percentage, a.info.color),
            (d = (c = window.Telegram.WebApp) == null ? void 0 : c.HapticFeedback) == null || d.notificationOccurred("error")
        }
        )()
    }
  ...
  , wS = "_container_11ui8_1"
  , bS = "_header_11ui8_13"
  , jS = "_close_container_11ui8_23"
  , PS = "_close_11ui8_23"
  , CS = "_title_11ui8_48"
  , NS = "_frens_count_11ui8_53"
  , SS = "_body_11ui8_58"
  , IS = "_content_11ui8_68"
  , TS = "_image_container_11ui8_75"
  , ES = "_image_11ui8_75"
  , BS = "_image_container_charges_11ui8_84"
  , DS = "_image_charges_11ui8_89"
  , kS = "_description_container_11ui8_94"
  , RS = "_bold_11ui8_102"
  , US = "_gray_11ui8_107"
  , OS = "_center_11ui8_111"
  , MS = "_benefits_container_11ui8_115"
  , QS = "_benefits_item_11ui8_123"
  ...
  , te = {
    ...
    image_container: TS,
    image: ES,
    image_container_charges: BS,
    image_charges: DS,
    description_container: kS,
    bold: RS,
    gray: US,
    center: OS,
    benefits_container: MS,
    benefits_item: QS,
  ...
  , LS = ()=>{
    ...
    return n && n.squad && n.squad.id !== null && (o += `_s${n.squad.id}`),
    e.jsx(ut, {
        show: s,
        onPointerUp: ()=>t(ua()),
        children: e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx(en, {
                    ...
                    onPointerUp: c=>{
                        c.stopPropagation(),
                        window.Telegram.WebApp.openLink(`https://t.me/share/url?url=${o}`),
                        t(ua())
                    }
                    ,
                    children: "Share"
  ...
  , WS = ()=>{
    ...
    return Ze.createPortal(e.jsx("div", {
        className: ur.layout,
        children: e.jsx(Ta, {
            children: n.map(t=>e.jsx(YS, {
                item: t
            }, t.id))
        })
    }), document.body)
}
  , KS = ({isPopupContent: n=!0})=>{
    ...
    return e.jsx(ut, {
        ...
        children: e.jsxs("div", {
            ...
            children: [t.dataSource === Ie.userFromPixelInfo && e.jsx(Na, {
                ...
                isPopupContent: s
            }), t.dataSource === Ie.squadFromData && e.jsx(KS, {})]
        })
    })
}
  , $S = "_overlay_1mqco_1"
  , eI = "_top_container_1mqco_10"
  , tI = "_bottom_container_1mqco_15"
  , nI = "_side_menu_1mqco_20"
  , sI = "_menu_safe_area_inset_1mqco_36"
  , aI = "_menu_header_1mqco_40"
  , oI = "_close_button_1mqco_53"
  , iI = "_menu_list_1mqco_58"
  , rI = "_icon_1mqco_79"
  , cI = "_icon_not_pixel_1mqco_87"
  , lI = "_gold_pixel_1mqco_97"
  , dI = "_menu_list_li_1mqco_103"
  , uI = "_menu_list_text_1mqco_109"
  , pI = "_menu_list_new_item_1mqco_113"
  , mI = "_button_wrapper_1mqco_136"
  , AI = "_button_content_1mqco_148"
  , hI = "_footer_1mqco_155"
  , gI = "_avatar_1mqco_161"
  , _I = "_ratings_image_container_1mqco_168"
  , fI = "_ratings_image_1mqco_168"
  , J = {
    overlay: $S,
    top_container: eI,
    bottom_container: tI,
    side_menu: nI,
    menu_safe_area_inset: sI,
    menu_header: aI,
    close_button: oI,
    menu_list: iI,
    icon: rI,
    ...
    menu_list_li: dI,
    menu_list_text: uI,
    menu_list_new_item: pI,
    button_wrapper: mI,
    button_content: AI,
    footer: hI,
    avatar: gI,
    ratings_image_container: _I,
    ratings_image: fI
}
  , Bo = [.215, .61, .355, 1]
  , xI = {
  ...
  , EI = "_layout_eiymv_1"
  , BI = "_container_eiymv_7"
  , ko = {
    layout: EI,
    container: BI
}
  , DI = ({values: n, setValues: t})=>e.jsx("div", {
    className: ko.layout,
    children: e.jsx("div", {
  ...
  , kI = ()=>localStorage.getItem("canvasFps") ? [Number(localStorage.getItem("canvasFps"))] : [60]
  , RI = ()=>{
    const [n,t] = ae.useState(kI());
    return m.useEffect(()=>{
        localStorage.setItem("canvasFps", String(n[0])),
        b.ticker.setFps(n[0])
    }
    , [n]),
    e.jsxs(e.Fragment, {
  ...
  , UI = "_layout_pdc5v_1"
  , OI = "_container_pdc5v_7"
  , MI = "_title_container_pdc5v_13"
  , QI = "_title_pdc5v_13"
  , FI = "_change_pdc5v_23"
  , zI = "_wallet_container_pdc5v_28"
  , HI = "_ton_icon_pdc5v_35"
  , qI = "_verificated_wallet_pdc5v_40"
  , st = {
    layout: UI,
    container: OI,
    title_container: MI,
    ...
    wallet_container: zI,
    ton_icon: HI,
    verificated_wallet: qI
}
  , LI = ()=>{
    const {handleConnect: n, formattedVerificatedWalletUQ: t} = Ya()
      , s = t && t !== ""
      , a = l(o=>o.mining.tasks.checkCaptcha);
    return e.jsx("div", {
        className: st.layout,
        children: e.jsxs("div", {
            ...
            children: s && e.jsxs(e.Fragment, {
                children: [e.jsx(yn.div, {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx(RI, {}), e.jsx(LI, {}), e.jsx("div", {
  ...
  , GI = "_layout_1vlcp_1"
  , XI = "_container_1vlcp_13"
  , JI = "_close_button_1vlcp_21"
  , YI = "_body_1vlcp_29"
  , WI = "_image_container_1vlcp_40"
  , KI = "_image_1vlcp_40"
  , ZI = "_shake_1vlcp_1"
  , $I = "_description_container_1vlcp_54"
  , eT = "_buyer_info_1vlcp_64"
  , tT = "_avatar_1vlcp_72"
  , nT = "_name_1vlcp_78"
  , sT = "_squad_info_1vlcp_82"
  , aT = "_squad_avatar_1vlcp_88"
  , oT = "_text_container_1vlcp_94"
  , iT = "_text_1vlcp_94"
  , rT = "_thanos_snap_container_1vlcp_105"
  , cT = "_thanos_snap_text_1vlcp_114"
  , lT = "_prev_snaps_container_1vlcp_121"
  , dT = "_prev_snaps_text_1vlcp_128"
  , uT = "_prev_snaps_list_container_1vlcp_134"
  , pT = "_prev_snaps_list_item_1vlcp_142"
  , mT = "_button_container_1vlcp_148"
  , AT = "_button_1vlcp_148"
  , hT = "_button_text_1vlcp_163"
  , Y = {
    layout: GI,
    container: XI,
    close_button: JI,
    ...
    text_container: oT,
    text: iT,
    thanos_snap_container: rT,
    thanos_snap_text: cT,
    prev_snaps_container: lT,
    prev_snaps_text: dT,
    prev_snaps_list_container: uT,
    prev_snaps_list_item: pT,
    button_container: mT,
    button: AT,
    button_text: hT
}
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx("img", {
                            ...
                            children: [e.jsx("span", {
                                ...
                                children: _T(new Date(o.info.datetime))
                            })]
                        })]
                    }), e.jsx("div", {
  ...
  , xT = "_layout_1i63b_1"
  , yT = "_container_1i63b_18"
  , vT = "_image_container_1i63b_25"
  , wT = "_title_1i63b_30"
  , bT = "_text_container_1i63b_37"
  , jT = "_support_container_1i63b_46"
  , Ot = {
    layout: xT,
    container: yT,
    image_container: vT,
  ...
  , NT = ()=>e.jsxs("div", {
    className: un.layout,
    children: [e.jsx(FN, {}), e.jsx(UN, {}), e.jsx(RA, {}), e.jsx(oN, {}), e.jsx(ON, {}), e.jsx(VS, {}), e.jsx(ZS, {}), e.jsx(LS, {}), e.jsx(CT, {}), e.jsx(z2, {}), e.jsx(vS, {}), e.jsx(fT, {}), e.jsx(WS, {}), e.jsx(VI, {})]
})
  , ST = ()=>{
    var o, i;
    const n = g()
...
null)
  , TT = "_layout_ieygs_1"
  , ET = "_container_ieygs_8"
  , BT = "_logo_container_ieygs_17"
  , DT = "_logo_ieygs_17"
  , kT = "_animate_ieygs_1"
  , RT = "_center_ieygs_37"
  , UT = "_title_ieygs_51"
  , OT = "_description_ieygs_58"
  , MT = "_button_container_ieygs_63"
  , QT = "_button_ieygs_63"
  , FT = "_b_ieygs_63"
  , _e = {
    layout: TT,
  ...
  , HT = "/assets/loading-D8SQALTR.gif"
  , qT = ()=>e.jsxs("div", {
    className: un.loading_container,
    children: [e.jsx("div", {
        className: un.image_container,
        children: e.jsx("img", {
            alt: "img",
            src: HT,
            className: un.image
        ...
        const t = (s,a)=>{
            Yt.get(s, (o,i)=>{
                if (o === null && i !== "")
                    ...
                    o !== null && console.error(`Ошибка при получении данных ${s}:`, o)
            }
            )
        }
        ;
        t("colors", s=>{
            Array.isArray(s) && s.length > 0 ? (n(Ac(s)),
            n(ka(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
        }
        ),
        t("boosts1", s=>{
            n(eu(s))
    ...
    const n = g()
      ...
      , s = async()=>{
        try {
            ...
            return console.error("Ошибка при получении данных пользователя:", A),
            !1
        }
    }
      , a = async()=>{
      ...
      , p = async()=>{
        ...
        A && (await Promise.all([o(), c(), i(A), a(), r()]),
        d())
    }
    ;
    m.useEffect(()=>{
  ...
  , GT = ()=>{
    const n = K();
    m.useEffect(()=>{
        Qo() ? localStorage.getItem("skipIntro") || (n.push("/welcome"),
        localStorage.setItem("skipIntro", "true")) : Yt.get("skipIntro", (t,s)=>{
            t === null && s !== "" || (t !== null && console.error("Ошибка при получении skipIntro:", t),
            n.push("/welcome"))
        }
        )
    }
  ...
  , KT = ()=>{
    ...
    m.useEffect(()=>{
        if (b) {
            ...
            b.app.renderer.resize(a, o),
            b.viewport.viewport.resize(a, o)
        }
    }
    , [s]),
    null
...
;
function Ge(n, t) {
    const [s,a=""] = n.toString().split(".")
      , o = a.slice(0, t);
    return +`${s}.${o.padEnd(t, "0")}`
}
const pn = window.Telegram.WebApp.Accelerometer
  , mn = window.Telegram.WebApp.DeviceOrientation
...
const nE = ()=>{
  ...
  , sE = ({children: n})=>{
    ...
    const t = l(c=>c.main.timeLimit)
      ...
      , i = t;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(sc) && IT(),
    LT(),
    VT(),
    GT(),
    a || i ? e.jsx(zT, {}) : o ? e.jsx(qT, {}) : e.jsx(e.Fragment, {
        children: n
    })
}
  , aE = ()=>{
...
function oE() {
    ...
    window.Telegram.WebApp.isVersionAtLeast("8.0") || window.Telegram.WebApp.version === "6.0" && window.Telegram.WebApp.platform === "unknown" ? e.jsx(sE, {
        children: e.jsx(NT, {})
    }) : e.jsx(aE, {})
}
const iE = {
...
ic(kn);
xp(kn);
const dE = yr.createRoot(document.getElementById("root"));
dE.render(e.jsx(ae.StrictMode, {
    children: e.jsx(br, {
        store: kn,
        children: e.jsx(Br, {
            children: e.jsx(Cr, {
