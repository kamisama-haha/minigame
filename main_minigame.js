...
const nt = {}
  ...
  , je = (e,t)=>Sv.call(e, t)
  , fe = Array.isArray
  , ai = e=>Co(e) === "[object Map]"
  , Jh = e=>Co(e) === "[object Set]"
  , Av = e=>Co(e) === "[object RegExp]"
  , ye = e=>typeof e == "function"
  , it = e=>typeof e == "string"
  , Li = e=>typeof e == "symbol"
  , tt = e=>e !== null && typeof e == "object"
  , Oc = e=>(tt(e) || ye(e)) && ye(e.then) && ye(e.catch)
  , zh = Object.prototype.toString
  , Co = e=>zh.call(e)
  , kv = e=>Co(e).slice(8, -1)
  , Qh = e=>Co(e) === "[object Object]"
...
function Iv(e) {
    const t = {};
    return e.replace(Rv, "").split(Cv).forEach(n=>{
        if (n) {
            const r = n.split(Ov);
...
function Wc(e, t, n, r, i, o, s, a, l, c, u=!1) {
    ...
    const p = e.props ? Xh(e.props.timeout) : void 0
      ...
      , T = {
        ...
        effects: [],
        resolve(A=!1, L=!1) {
            const {vnode: C, activeBranch: O, pendingBranch: D, pendingId: x, effects: U, parentComponent: Z, container: W} = T;
            let K = !1;
            T.isHydrating ? T.isHydrating = !1 : A || (K = O && D.transition && D.transition.mode === "out-in",
            K && (O.transition.afterLeave = ()=>{
                x === T.pendingId && (d(D, W, o === y ? _(O) : o, 0),
                gl(U))
            }
            ),
        ...
        fallback(A) {
            if (!T.pendingBranch)
                return;
            const {vnode: L, activeBranch: C, parentComponent: O, container: D, namespace: x} = T;
            uo(L, "onFallback");
            const U = _(C)
              , Z = ()=>{
                T.isInFallback && (f(null, A, D, U, O, null, x, a, l),
                di(T, A))
            }
        ...
        registerDep(A, L) {
            ...
            A.asyncDep.catch(D=>{
                ...
                L(A, x, b(O || A.subTree.el), O ? null : _(A.subTree), T, s, l),
                U && S(U),
                jc(A, x.el),
...
function Gc(e, t, {immediate: n, deep: r, flush: i, once: o, onTrack: s, onTrigger: a}=nt) {
    ...
    const g = ()=>{
        if (!(!p.active || !p.dirty))
            if (t) {
                const A = p.run();
                (r || f || (d ? A.some((L,C)=>_r(L, S[C])) : _r(A, S))) && (m && m(),
...
function _l(e, t, n, r) {
    const {appear: i, mode: o, persisted: s=!1, onBeforeEnter: a, onEnter: l, onAfterEnter: c, onEnterCancelled: u, onBeforeLeave: f, onLeave: d, onAfterLeave: m, onLeaveCancelled: _, onBeforeAppear: b, onAppear: S, onAfterAppear: g, onAppearCancelled: E} = t
      ...
      , A = (C,O)=>{
        const D = O[1];
        T(C, O),
        fe(C) ? C.every(x=>x.length <= 1) && D() : C.length <= 1 && D()
    }
      , L = {
        mode: o,
        persisted: s,
  ...
  , N0 = {
    ...
    setup(e, {slots: t}) {
        ...
        ()=>{
            ...
            let y = Ia(p);
            const T = y.type
              , A = Ol(Hr(y) ? y.type.__asyncResolved || {} : T)
              , {include: L, exclude: C, max: O} = e;
            if (L && (!A || !Fi(L, A)) || C && A && Fi(C, A))
                return s = y,
                p;
...
function J0(e) {
    ...
    const {data: i, computed: o, methods: s, watch: a, provide: l, inject: c, created: u, beforeMount: f, mounted: d, beforeUpdate: m, updated: _, activated: b, deactivated: S, beforeDestroy: g, beforeUnmount: E, destroyed: p, unmounted: y, render: T, renderTracked: A, renderTriggered: L, errorCaptured: C, serverPrefetch: O, expose: D, inheritAttrs: x, components: U, directives: Z, filters: W} = t;
    if (c && z0(c, r, null),
    s)
        for (const Y in s) {
            const B = s[Y];
...
function l_(e) {
    const {mt: t, p: n, o: {patchProp: r, createText: i, nextSibling: o, parentNode: s, remove: a, insert: l, createComment: c}} = e
      ...
      , f = (p,y,T,A,L,C=!1)=>{
        ...
        default:
            if (Z & 1)
                ...
                y.slotScopeIds = L;
                const Y = s(p);
                if (O ? N = S(p) : es(p) && p.data === "teleport start" ? N = S(p, p.data, "teleport end") : N = o(p),
                t(y, Y, null, T, A, $o(Y), C),
                Hr(y)) {
                    let B;
                    O ? (B = Ze(pt),
                ...
                Z & 64 ? K !== 8 ? N = D() : N = y.type.hydrate(p, y, T, A, L, C, e, m) : Z & 128 && (N = y.type.hydrate(p, y, T, A, $o(s(p)), L, C, e, f))
        }
      ...
      , d = (p,y,T,A,L,C)=>{
        ...
        const {type: O, props: D, patchFlag: x, shapeFlag: U, dirs: Z, transition: W} = y
          , K = O === "input" || O === "option";
        if (K || x !== -1) {
...
function Kp(e, t) {
    ...
    const {insert: r, remove: i, patchProp: o, createElement: s, createText: a, createComment: l, setText: c, setElementText: u, parentNode: f, nextSibling: d, setScopeId: m=$t, insertStaticContent: _} = e
      ...
      , T = (h,v,w,R,V,q,X,z,ee)=>{
        ...
        h == null ? A(v, w, R, V, q, X, z, ee) : O(h, v, V, q, X, z, ee)
    }
      , A = (h,v,w,R,V,q,X,z)=>{
        let ee, J;
        const {props: oe, shapeFlag: ie, transition: I, dirs: F} = h;
        if (ee = h.el = s(h.type, q, oe && oe.is, oe),
        ie & 8 ? u(ee, h.children) : ie & 16 && C(h.children, ee, null, R, V, Ma(h, q), X, z),
      ...
      , U = (h,v,w,R,V,q,X,z,ee)=>{
        ...
        h == null ? (r(J, w, R),
        r(oe, w, R),
        C(v.children || [], w, oe, V, q, X, z, ee)) : ie > 0 && ie & 64 && I && h.dynamicChildren ? (D(h.dynamicChildren, I, w, V, q, X, z),
      ...
      , ae = (h,v,w,R,V,q,X,z,ee)=>{
        ...
        J > oe ? $e(h, V, q, !0, !1, ie) : C(v, w, R, V, q, X, z, ee, ie)
    }
  ...
  , h_ = {
    ...
    process(e, t, n, r, i, o, s, a, l, c) {
        ...
        if (e == null) {
            ...
            Zc(e, t, !0)) : l || f(e, t, O, D, i, o, s, a, !1),
            g)
                C ? t.props && e.props && t.props.to !== e.props.to && (t.props.to = e.props.to) : ts(t, n, T, c, 1);
...
const Ob = /"(?:_|\\u0{2}5[Ff]){2}(?:p|\\u0{2}70)(?:r|\\u0{2}72)(?:o|\\u0{2}6[Ff])(?:t|\\u0{2}74)(?:o|\\u0{2}6[Ff])(?:_|\\u0{2}5[Ff]){2}"\s*:/
...
const wE = (e,t,n={})=>{
  ...
  , OE = e=>!!e && typeof e == "object" && Tm in e
  , aa = e=>{
    const t = Bl(e);
...
const Om = ["og:image", "og:video", "og:audio", "twitter:image"];
function Rm(e) {
    const t = {};
...
const LT = {
    nuxt: {
        buildId: "6000dfc1-84c5-42e9-b419-81d1f61ef6a7"
    }
}
  , CT = bE(LT);
function OT() {
    const e = re();
    return e._appConfig || (e._appConfig = Tt(CT)),
    e._appConfig
}
const RT = !1
  , Kl = !1
...
function DT() {
    var t;
    const e = (t = OT().nuxt) == null ? void 0 : t.buildId;
...
function jS(e) {
    ...
    function D(H, te) {
        ...
        Q = Ya(Be, "beforeRouteEnter", H, te, O),
        Q.push(h),
        $e(Q))).then(()=>{
            Q = [];
...
const Ee = null
  ...
  , dd = [{
    ...
    component: ()=>k(()=>import("./airdrop.ODic_RnQ.js"), __vite__mapDeps([0, 1, 2, 3]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./boost.CUvSUlxc.js"), __vite__mapDeps([4, 5, 6, 2]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./earn.CSTmc60O.js"), __vite__mapDeps([7, 6, 3, 2, 8]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./friends.DbRWYU2g.js"), __vite__mapDeps([9, 2, 6]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./index.D51qYaH5.js"), __vite__mapDeps([10, 6, 2, 11, 12, 13, 14, 15, 16, 17, 3, 18, 5]), import.meta.url).then(e=>e.default || e)
}, {
    name: "clicker___en",
    path: "/clicker",
    meta: {},
    ...
    component: ()=>k(()=>import("./index.YhAz25xN.js"), __vite__mapDeps([19, 17, 2, 16, 6, 12, 13]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./mine.BMw31tFD.js"), __vite__mapDeps([20, 15, 16, 6, 17, 5, 2]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./playground.CkG9tSMa.js"), __vite__mapDeps([21, 2, 11, 12, 13, 14]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./bingx.B57SJj91.js"), __vite__mapDeps([22, 2, 16, 6]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./exchange.rgOSPsLo.js"), __vite__mapDeps([23, 16]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./index.C17DRiAg.js"), __vite__mapDeps([24, 2]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./language.81GcDxr8.js"), __vite__mapDeps([]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./avatar.S1UYyjDe.js"), __vite__mapDeps([]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./index.NXOnfeMP.js"), __vite__mapDeps([25, 6, 2]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./index.Da7j1wTB.js"), __vite__mapDeps([26, 27, 17, 16]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>k(()=>import("./privacy-policy.DlI4e5-F.js"), __vite__mapDeps([28, 27]), import.meta.url).then(e=>e.default || e)
}, {
  ...
  , VM = Ue({
    ...
    setup(e) {
        ...
        function K(j) {
            ...
            !(!_.isPressed || _.isClearing) && (ur(j) && L(j) ? O() : D(C(j)),
            A(),
            S({
                startX: 0,
                currentX: 0,
  ...
  , BM = Ue({
    ...
    setup(e) {
        ...
        vt(Po, {
            ...
            default: on(()=>[typeof n.value == "object" ? (pe(),
            vt(yl(n.value), {
                key: 0,
                class: Ot(G(Fn).ICON),
                "aria-hidden": "true"
        ...
        We("h3", {
            ...
            class: Ot(G(Fn).MESSAGE),
            textContent: zt(G(i.item.message))
        }, null, 10, bk)], 10, vk), !t.hideClose && G(r) && i.item.type !== "promise" ? (pe(),
        We("button", {
            key: 1,
            class: Ot(G(Fn).CLOSE),
...
function fg(e, t, n={}, r, i, o) {
    ...
    const y = {
      ...
      , T = Tt(y);
    r._s.set(e, T);
    const L = (r._a && r._a.runWithContext || kk)(()=>r._e.run(()=>(s = Oo()).run(t)));
    for (const C in L) {
        const O = L[C];
        if (at(O) && !Ck(O) || mr(O))
            o || (_ && Lk(O) && (at(O) ? O.value = _[C] : Ql(O, _[C])),
            r.state.value[e][C] = O);
...
function Vn(e, t, n) {
    ...
    function s(a, l) {
        ...
        a && Bo(a),
        a = lg,
        a._s.has(r) || (o ? fg(r, t, i, a) : Ok(r, i, a)),
        a._s.get(r)
    }
    return s.$id = r,
    s
  ...
  , jn = Vn("auth", {
    ...
    actions: {
        ...
        logout(e=!0) {
            ...
            localStorage.removeItem(me.HAMSTER_YOUTUBE_EASY_START_S1E29),
...
function aw(e, t={}) {
    ...
    function b(h) {
        let v = "";
        for (; h.currentPeek() === xn || h.currentPeek() === Ct; )
            v += h.currentPeek(),
            h.peek();
        return v
    }
    ...
    function O(h, v) {
        ...
        const R = ()=>{
            ...
            return q === "{" ? g(h.peek()) : q === "@" || q === "%" || q === "|" || q === ":" || q === "." || q === xn || !q ? !1 : q === Ct ? (h.peek(),
            R()) : g(q)
        }
          , V = R();
        return h.resetPeek(),
    ...
    function U(h, v=!0) {
        const w = (V=!1,q="",X=!1)=>{
            ...
            w(V, "%", !0)) : z === "|" ? q === "%" || X ? !0 : !(q === xn || q === Ct) : z === xn ? (h.peek(),
            w(!0, xn, X)) : z === Ct ? (h.peek(),
            w(!0, Ct, X)) : !0
        }
          , R = w();
    ...
    function _e(h) {
        ...
        for (; v = Z(h, R); )
            v === "\\" ? w += Ye(h) : w += v;
        const V = h.currentChar();
        return V === Ct || V === er ? (f(Ge.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, o(), 0),
        V === Ct && (h.next(),
        _(h, "'")),
        w) : (_(h, "'"),
        w)
    ...
    function H(h) {
        const v = (w=!1,R)=>{
            const V = h.currentChar();
            return V === "{" || V === "%" || V === "@" || V === "|" || V === "(" || V === ")" || !V || V === xn ? R : V === Ct || V === ow ? (R += V,
            h.next(),
            v(w, R)) : (R += V,
            h.next(),
            v(!0, R))
    ...
    function $(h, v) {
        ...
        let R = null;
        const V = h.currentChar();
        switch ((w === 8 || w === 9 || w === 12 || w === 10) && (V === Ct || V === xn) && f(Ge.INVALID_LINKED_FORMAT, o(), 0),
        V) {
        case "@":
            return h.next(),
            R = d(v, 8, "@"),
...
function fw(e={}) {
    ...
    function m(g) {
        ...
        do {
            ...
            O.type) {
            case 0:
                O.value == null && r(g, Ge.UNEXPECTED_LEXICAL_ANALYSIS, E.lastStartLoc, 0, En(O)),
...
const Kw = {
  ...
  , Ln = {
    INVALID_ARGUMENT: mg,
    INVALID_DATE_ARGUMENT: Or(),
    INVALID_ISO_DATE_ARGUMENT: Or(),
    NOT_SUPPORT_NON_STRING_MESSAGE: Or(),
    NOT_SUPPORT_LOCALE_PROMISE_VALUE: Or(),
    NOT_SUPPORT_LOCALE_ASYNC_FUNCTION: Or(),
    NOT_SUPPORT_LOCALE_TYPE: Or(),
    __EXTEND_POINT__: Or()
};
function Kn(e) {
...
function tL(e={}) {
    const t = Xe(e.onWarn) ? e.onWarn : Zk
      ...
      , T = Xe(e.messageResolver) ? e.messageResolver : vg || Ow
      , A = Xe(e.localeFallbacker) ? e.localeFallbacker : _g || Yw
      , L = Ve(e.fallbackContext) ? e.fallbackContext : void 0
      , C = e
      , O = Ve(C.__datetimeFormatters) ? C.__datetimeFormatters : new Map
      , D = Ve(C.__numberFormatters) ? C.__numberFormatters : new Map
      , x = Ve(C.__meta) ? C.__meta : {};
    Md++;
    const U = {
        version: n,
        cid: Md,
...
function Rg(e={}, t) {
    ...
    const j = (I,F,se,he,qe,ot)=>{
        ...
        try {
            ...
            i || (C.fallbackContext = n ? eL() : void 0),
            yt = I(C)
        } finally {
            __INTLIFY_PROD_DEVTOOLS__,
    ...
    function h(I) {
        let F = null;
        const se = gg(C, c.value, l.value);
        for (let he = 0; he < se.length; he++) {
            const qe = u.value[se[he]] || {}
              , ot = C.messageResolver(qe, I);
            if (ot != null) {
                F = ot;
                break
            }
...
const Jr = ["de", "en", "es", "fr", "hi", "id", "pt", "ru", "th", "tl", "tr", "uz", "vi"]
  , ac = {
    de: [{
        key: "../locales/de.json",
        load: ()=>k(()=>import("./de.CmeF7_Nj.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    en: [{
        key: "../locales/en.json",
        load: ()=>k(()=>import("./en.DithF6_5.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    es: [{
        key: "../locales/es.json",
        load: ()=>k(()=>import("./es.CQ9-2Pnk.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    fr: [{
        key: "../locales/fr.json",
        load: ()=>k(()=>import("./fr.B3E94O04.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    hi: [{
        key: "../locales/hi.json",
        load: ()=>k(()=>import("./hi.GT7cCtuS.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    id: [{
        key: "../locales/id.json",
        load: ()=>k(()=>import("./id.D4iIFegZ.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    pt: [{
        key: "../locales/pt.json",
        load: ()=>k(()=>import("./pt.CZzMK13z.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    ru: [{
        key: "../locales/ru.json",
        load: ()=>k(()=>import("./ru.B26BQ3ij.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    th: [{
        key: "../locales/th.json",
        load: ()=>k(()=>import("./th.CwfxImp_.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    tl: [{
        key: "../locales/tl.json",
        load: ()=>k(()=>import("./tl.BYeeWGdW.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    tr: [{
        key: "../locales/tr.json",
        load: ()=>k(()=>import("./tr.Ce-i6Opj.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    uz: [{
        key: "../locales/uz.json",
        load: ()=>k(()=>import("./uz.DHBn-4Rv.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    vi: [{
        key: "../locales/vi.json",
        load: ()=>k(()=>import("./vi.DAYgY0oz.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }]
}
  , HL = [()=>k(()=>import("./i18n.config.Da3zEwKd.js"), __vite__mapDeps([]), import.meta.url)]
  , mt = {
    experimental: {
        localeDetector: ""
    },
...
const tC = eC;
function nC(e, t, {matcher: n=$L, comparer: r=tC}={}) {
    const i = [];
    for (const s of e) {
        const {code: a} = s
          , l = s.iso || a;
...
async function oC(e, {key: t, load: n}) {
    let r = null;
    try {
...
async function cc(e, t, n) {
    ...
    for (const o of r) {
        let s = null;
        Qi && Qi.has(o.key) && o.cache ? s = Qi.get(o.key) : s = await oC(e, o),
        s != null && Kr(s, i)
    }
    n(e, i)
}
...
function lC({router: e}, t, n, r) {
    var c, u;
    if (n !== "prefix")
        return e.resolve(t);
    const [i,o] = sC(t.path, 1)
      , s = `${i}${r}${o === "" ? o : `/${o}`}`
...
const cC = new Set(["prefix_and_default", "prefix_except_default"]);
function uC(e) {
    const {currentLocale: t, defaultLocale: n, strategy: r} = e;
    return !(t === n && cC.has(r)) && r !== "no_prefix"
}
const fC = uC;
function Ai(e) {
...
function Ug(e, {addDirAttribute: t=!1, addSeoAttributes: n=!0, identifierAttribute: r="hid"}) {
    ...
    s.link.push(...mC(e, G(l), r), ...gC(e, r, n)),
    s.meta.push(...yC(e, r, n), ...vC(c, u, r), ..._C(G(l), u, r))),
    s
}
function Su() {
    const e = Si(re().$i18n);
...
async function rh(e, t, n=!1) {
    ...
    const u = RC(t, "fallbackLocale");
    {
        const f = (d,m)=>TC(t, d, m);
        if (u) {
            const d = Vg(u, [e]);
...
function ih(e, t, n, r, i) {
    ...
    if ((g === "navigator_or_header" || g === "cookie" || g === "fallback") && _)
        return _;
    let E = _;
    return E || (a ? E = NC(Eu) : o !== "no_prefix" ? E = t(e) : l || (E = c)),
...
function LC() {
    return e=>fC(e) && !mt.differentDomains
}
function CC() {
    return (e,t)=>hC(e)
}
...
function xg() {
    let e;
    return navigator.languages && (e = nC(Eu, navigator.languages)),
    e
}
function IC() {
...
const Za = ()=>({
  ...
  , xM = Ue({
    ...
    setup(e, {emit: t}) {
        const n = e
          , r = t
          , {showBackButton: i, onBackButtonClicked: o, hideBackButton: s} = WC();
  ...
  , {initData: UC, initDataUnsafe: BC, version: FC, platform: xC, isVersionAtLeast: HC, sendData: jC, close: KC} = Telegram.WebApp
  , Yg = le(!1)
  , YC = (...e)=>{
  ...
  , Wg = qg("unknown")
  , qC = !Wg && Telegram.WebApp.initData === "";
function Gg() {
    return {
        initData: UC,
        initDataUnsafe: BC,
...
const {impactOccurred: GC, notificationOccurred: JC, selectionChanged: zC} = Telegram.WebApp.HapticFeedback;
function QC() {
    return {
        impactOccurred: GC,
        notificationOccurred: JC,
        selectionChanged: zC
    }
}
...
const Rn = Vn("ui", {
    ...
    actions: {
        ...
        useHapticFeedback(e="medium") {
            VC().settings.haptic && QC().impactOccurred(e)
        },
        isRu(e) {
    ...
    actions: {
        ...
        async postBuyUpgrade(e) {
            return await et.post("/clicker/buy-upgrade", {
                ...
                t != null && t.boostsForBuy && ZC().setBoostsForBuy(t.boostsForBuy),
  ...
  , Bt = Vn("clicker", {
    ...
    actions: {
        ...
        checkLevelUp() {
            ...
            Rn().notificationLevelUp = On.promise({
        ...
        storageSyncTapsAdd(e) {
            ...
            localStorage.setItem(me.SYNC_TIMESTAMP_TAPS, String(Je().getNowTimestamp()))
        },
        storageSyncTapsGet() {
...
const rO = Pt({
    ...
    async setup(e) {
        ...
        let s;
        const a = nO(r, window.location, e.payload.path)
          , l = jS({
            ...Ht,
        ...
        return l.beforeEach(async(g,E)=>{
            ...
            {
                const y = new Set([...tO, ...e._middleware.global]);
                ...
                for (const T of y) {
                    const A = typeof T == "string" ? e._middleware.named[T] || await ((p = Xi[T]) == null ? void 0 : p.call(Xi).then(C=>C.default || C)) : T;
                    if (!A)
                    ...
                    if (!e.payload.serverRendered && e.isHydrating && (L === !1 || L instanceof Error)) {
                        ...
                        return await e.runWithContext(()=>oi(C)),
                        !1
                    }
                    if (L !== !0 && (L || L === !1))
                        return L
  ...
  , iO = globalThis.cancelIdleCallback || (e=>{
    clearTimeout(e)
}
)
  , ku = e=>{
...
function Xg(e) {
    ...
    return Ue({
        ...
        setup(r, {slots: i}) {
            ...
            ;
            if (r.prefetch !== !1 && r.noPrefetch !== !0 && r.target !== "_blank" && !uO()) {
                const b = re();
                let S, g = null;
                It(()=>{
                    const E = cO();
            ...
            return ()=>{
                ...
                const _ = typeof a.value == "object" ? ((g = o.resolve(a.value)) == null ? void 0 : g.href) ?? null : a.value && !r.external && !l.value ? n(Ri(s.app.baseURL, a.value), o.resolve) : a.value || null
                  , b = r.target || null
                  , S = lO(r.noRel ? "" : r.rel, e.externalRelAttribute, l.value || c.value ? "noopener noreferrer" : "") || null;
                if (r.custom) {
                    if (!i.default)
                        return null;
                    const p = ()=>Vo(_, {
...
const fO = Pt(e=>{
  ...
  , dr = {
    default: ()=>k(()=>import("./default.dkRdzCPi.js"), __vite__mapDeps([29, 16, 2, 8, 3, 18, 1, 6]), import.meta.url).then(e=>e.default || e),
    main: ()=>k(()=>import("./main.DwAOr2Ob.js"), __vite__mapDeps([]), import.meta.url).then(e=>e.default || e)
}
  , hO = Pt({
    name: "nuxt:prefetch",
    setup(e) {
        ...
        return function(i, o, s) {
            ...
            s.tz = function(d, m, _) {
                ...
                var E = function(A, L, C) {
                    ...
                    if (L === D)
                        return [O, L];
                    var x = c(O -= 60 * (D - L) * 1e3, C);
                    return D === x ? [O, D] : [A - 60 * Math.min(D, x) * 1e3, Math.max(D, x)]
...
Un.updateLocale("en");
Un.locale("en");
const NO = Pt(async e=>e.provide("dayjs", Un))
  , VO = ["top", "right", "bottom", "left"]
  , fh = ["start", "end"]
  , dh = VO.reduce((e,t)=>e.concat(t, t + "-" + fh[0], t + "-" + fh[1]), [])
  , bo = Math.min
  , Nr = Math.max
  , UO = {
    left: "right",
    ...
    return e === void 0 && (e = {}),
    {
        ...
        async fn(t) {
            ...
            const {rects: o, middlewareData: s, placement: a, platform: l, elements: c} = t
              ...
              , b = f !== void 0 || d === dh ? qO(f || null, m, d) : d
              , S = await va(t, _)
            ...
            const L = T.map(D=>{
              ...
              , O = ((i = L.filter(D=>D[2].slice(0, dn(D[0]) ? 2 : 3).every(x=>x <= 0))[0]) == null ? void 0 : i[0]) || L[0][0];
            return O !== a ? {
                data: {
                    index: g + 1,
                    overflows: T
            ...
            !L.every(U=>U <= 0)) {
                ...
                if (!W)
                    ...
                    case "bestFit":
                        {
                            var x;
                            const K = (x = C.map(N=>[N.placement, N.overflows.filter(Y=>Y > 0).reduce((Y,B)=>Y + B, 0)]).sort((N,Y)=>N[1] - Y[1])[0]) == null ? void 0 : x[0];
                            K && (W = K);
                            break
                        }
        ...
        async fn(t) {
            ...
            if (E && !u) {
                const A = Nr(l.left, 0)
                  ...
                  , C = Nr(l.top, 0)
                  , O = Nr(l.bottom, 0);
                f ? y = d - 2 * (A !== 0 || L !== 0 ? A + L : Nr(l.left, l.right)) : p = m - 2 * (C !== 0 || O !== 0 ? C + O : Nr(l.top, l.bottom))
            }
            await s({
                ...t,
                availableWidth: y,
...
function py(e) {
    const t = To(e);
    return Cu(t) ? t.ownerDocument.body : Pn(t) && _a(t) ? t : py(t)
}
function Hs(e, t) {
    var n;
    t === void 0 && (t = []);
...
function vh(e) {
    const t = tn(e);
    let n = yh(e);
    for (; n && ZO(n) && In(n).position === "static"; )
        n = yh(n);
  ...
  , vy = ()=>Ue({
    ...
    methods: {
        ...
        async $_computePosition() {
            ...
            this.preventOverflow && (this.shift && e.middleware.push(QO({
...
function v1(e, t, n, r, i, o) {
    ...
    We("div", {
        id: e.popperId,
        ref: "popover",
        class: Ot(["v-popper__popper", [e.themeClass, e.classes.popperClass, {
    ...
    }, [ge("div", p1, [e.mounted ? (pe(),
    We(pt, {
        key: 0
    }, [ge("div", null, [br(e.$slots, "default")]), e.handleResize ? (pe(),
    vt(s, {
        key: 0,
...
function I1() {
    ...
    rl = im({
        ...
        render() {
            return this.directives.map(t=>ut(C1, {
                ...t.options,
...
const B1 = Pt(({vueApp: e})=>{
    ...
    const t = ((i = Gn().public) == null ? void 0 : i.notivue) || {}
      , n = Oy(JSON.parse(JSON.stringify(t)));
    delete n.addPlugin;
    const r = SA(n);
    e.use(r)
}
...
const Y1 = Pt({
    ...
    async setup(e) {
        ...
        a.messages = ([t,n] = wn(()=>iC(a.messages, ac, {
            localeCodes: Jr,
            initialLocale: f,
            lazy: s.lazy,
        ...
        F1(d, {
            ...
            hooks: {
                onExtendComposer(p) {
                    ...
                    p.getLocaleCookie = ()=>PC(u),
                    p.setLocaleCookie = y=>MC(u, y),
...
function zM(e, t={}) {
    const n = J1(e)
      ...
      , y = L=>{
        ...
        const x = L.buttons === 0
          , U = L.buttons === 1;
        return (D = (O = (C = t.pointerTypes) == null ? void 0 : C.includes(L.pointerType)) != null ? O : x || U) != null ? D : !0
    }
...
function sv(e) {
    ...
    const C = eI(b);
    !((n = (t = C).needsInterpolation) === null || n === void 0) && n.call(t, r, S) && (L = Zy([0, 100], [r, S], {
        clamp: !1
    }),
    r = 0,
    S = 100);
...
function OI({ease: e, times: t, delay: n, ...r}) {
    const i = {
        ...r
    };
    return t && (i.offset = t),
...
const FP = Pt(()=>{
  ...
  , xP = [FT, HT, rO, oO, sO, fO, dO, hO, NO, U1, B1, Y1, VP, UP, FP]
  , HP = Ue({
    props: {
        vnode: {
            type: Object,
    ...
    async setup(e) {
        ...
        const r = e
          , i = Object.fromEntries(Object.entries(Object.assign({
            "/assets/svg/icons/alarm-clock-glow.svg": ()=>k(()=>import("./alarm-clock-glow.aC8bZIm6.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/alarm.svg": ()=>k(()=>import("./alarm.DhXSImdX.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/app-bar-boost.svg": ()=>k(()=>import("./app-bar-boost.CCdq5ioD.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/app-bar-earn.svg": ()=>k(()=>import("./app-bar-earn.Bb212ucL.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/app-bar-friends.svg": ()=>k(()=>import("./app-bar-friends.CTyi4Yjj.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/app-bar-mine.svg": ()=>k(()=>import("./app-bar-mine.BkoJ97Sz.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/app-bar-playground.svg": ()=>k(()=>import("./app-bar-playground.acdgU1sm.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/arrow-onboarding-new.svg": ()=>k(()=>import("./arrow-onboarding-new.BEtKb0Zx.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/arrow-onboarding.svg": ()=>k(()=>import("./arrow-onboarding.BJzvMlow.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/caret-right.svg": ()=>k(()=>import("./caret-right.Be5C5AdH.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/check.svg": ()=>k(()=>import("./check.DpGtnzuV.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/clock.svg": ()=>k(()=>import("./clock.BeWcAb1-.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/close-simple.svg": ()=>k(()=>import("./close-simple.BHIZU7ZI.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/close.svg": ()=>k(()=>import("./close.KB0mydBa.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/complete.svg": ()=>k(()=>import("./complete.lDxhBE40.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/copy.svg": ()=>k(()=>import("./copy.CjcTersn.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/energy.svg": ()=>k(()=>import("./energy.DhIj__pU.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/eyes.svg": ()=>k(()=>import("./eyes.DfHV8DJi.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/friends.svg": ()=>k(()=>import("./friends.D9yHF85E.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/gift.svg": ()=>k(()=>import("./gift.D56pTUEE.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/glow.svg": ()=>k(()=>import("./glow.DR87XU47.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/gr.svg": ()=>k(()=>import("./gr.CE-S70jU.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/heart.svg": ()=>k(()=>import("./heart.uEUhPDEu.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/info.svg": ()=>k(()=>import("./info.CwbDISi0.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/key.svg": ()=>k(()=>import("./key.CBMDGpK3.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/ln-arrow.svg": ()=>k(()=>import("./ln-arrow.C4l_4b2T.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/ln-discord.svg": ()=>k(()=>import("./ln-discord.DNbmOmlO.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/ln-medium.svg": ()=>k(()=>import("./ln-medium.BrOe8wIZ.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/ln-telegram.svg": ()=>k(()=>import("./ln-telegram.cBOmGQCr.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/ln-x.svg": ()=>k(()=>import("./ln-x.CdWKHoAz.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/ln-youtube.svg": ()=>k(()=>import("./ln-youtube.q1Uak5_E.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/loading-background.svg": ()=>k(()=>import("./loading-background.DLKaIbsv.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/loading-image.svg": ()=>k(()=>import("./loading-image.DD2lTtqq.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/loading-yellow.svg": ()=>k(()=>import("./loading-yellow.BmzMALSJ.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/loading.svg": ()=>k(()=>import("./loading.D5-YfgbB.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/lock.svg": ()=>k(()=>import("./lock.FuE0uKjd.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/markets.svg": ()=>k(()=>import("./markets.Bq8f52NT.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/not-support-phone-glow.svg": ()=>k(()=>import("./not-support-phone-glow.BSB35vgE.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/refresh.svg": ()=>k(()=>import("./refresh.BvInaMMK.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/robots.svg": ()=>k(()=>import("./robots.BmOab4DB.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/settings.svg": ()=>k(()=>import("./settings.CezmlWen.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/ticket.svg": ()=>k(()=>import("./ticket.DQ5Qpq-5.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default),
            "/assets/svg/icons/wallet.svg": ()=>k(()=>import("./wallet.3o12uypq.js"), __vite__mapDeps([]), import.meta.url).then(s=>s.default)
    ...
    setup(e) {
        ...
        (a,l)=>{
            ...
            We("main", aM, [ge("div", lM, [ge("div", cM, [ge("div", uM, [ge("a", {
                ...
                class: "is-ln-arrow",
                name: "ln-arrow"
            }), _M])])]), ge("div", bM, [ge("h1", null, zt(e.error.statusCode ?? 500), 1), (d = e.error) != null && d.statusMessage ? (pe(),
            We("p", EM, "Status: " + zt(((m = e.error) == null ? void 0 : m.statusMessage) ?? ""), 1)) : Kt("", !0), ge("p", TM, zt((_ = e.error) == null ? void 0 : _.toJSON()), 1), G(r) ? (pe(),
            We("p", SM, "User Agent: " + zt(G(r)), 1)) : Kt("", !0), G(o) ? (pe(),
...
export {Uk as $, Hk as A, RM as B, Ot as C, K0 as D, iM as E, pt as F, ZC as G, Kg as H, XC as I, Ut as J, Vo as K, Vk as L, HM as M, zP as N, xk as O, WM as P, VC as Q, oM as R, me as S, sM as T, Fo as U, Jt as V, PM as W, Pk as X, jM as Y, KM as Z, eM as _, We as a, Vn as a0, et as a1, fc as a2, jn as a3, Qp as a4, dg as a5, YM as a6, qM as a7, Cn as a8, on as a9, kT as aA, Im as aB, Oi as aC, zM as aD, br as aE, Po as aF, yl as aG, vi as aH, oa as aI, UM as aJ, UL as aK, jP as aL, NM as aM, xM as aN, BM as aO, VM as aP, MM as aa, at as ab, DM as ac, el as ad, $a as ae, Bk as af, Fk as ag, k as ah, Nk as ai, G0 as aj, Dk as ak, Mk as al, jk as am, qr as an, Tt as ao, jr as ap, Jc as aq, He as ar, Yt as as, ut as at, F0 as au, Kk as av, FM as aw, Xl as ax, Gn as ay, IM as az, G as b, ue as c, Ue as d, ge as e, At as f, Pi as g, JM as h, Bt as i, ha as j, Ze as k, vt as l, re as m, On as n, pe as o, Rn as p, It as q, le as r, yn as s, zt as t, Je as u, dt as v, Kt as w, GM as x, an as y, OM as z};
function __vite__mapDeps(indexes) {
    if (!__vite__mapDeps.viteFileDeps) {
        __vite__mapDeps.viteFileDeps = ["./airdrop.ODic_RnQ.js", "./airdrop.jz5ClsdI.js", "./Preloader.vue.EL_BqhER.js", "./earn.DGl--UTU.js", "./boost.CUvSUlxc.js", "./BalanceLarge.vue.CUoPNMix.js", "./Price.vue.Cny252bW.js", "./earn.CSTmc60O.js", "./attraction.Ci4Xgvhd.js", "./friends.DbRWYU2g.js", "./index.D51qYaH5.js", "./navigation.BDVBLgCJ.js", "./effect-fade.aa3pNKSS.js", "./effect-fade.vkSr05gD.css", "./navigation.Bw5XmvsK.css", "./Earn.vue.BvwXnsf7.js", "./image.vue.z4uqTG5J.js", "./Hamster.vue.o-XLjD0K.js", "./MiniGameLose.vue.BfjL6Z8P.js", "./index.YhAz25xN.js", "./mine.BMw31tFD.js", "./playground.CkG9tSMa.js", "./bingx.B57SJj91.js", "./exchange.rgOSPsLo.js", "./index.C17DRiAg.js", "./index.NXOnfeMP.js", "./index.Da7j1wTB.js", "./LandingHeader.vue.n2OOLA7Q.js", "./privacy-policy.DlI4e5-F.js", "./default.dkRdzCPi.js"]
    }
