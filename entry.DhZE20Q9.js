...
class l0 {
    ...
    set value(t) {
        const n = this.__v_isShallow || Ss(t) || qr(t);
        t = n ? t : Ve(t),
...
function Ra(e) {
    ...
    if (g && b !== !1) {
        const y = Object.keys(g)
          , {shapeFlag: T} = p;
        y.length && T & 7 && (s && y.some(Oc) && (g = S0(g, s)),
        p = Gn(p, g))
    }
...
function zc(e, t, {immediate: n, deep: r, flush: i, once: o, onTrack: s, onTrigger: a}=rt) {
    ...
    ;
    return t ? n ? g() : k = p.run() : i === "post" ? At(p.run.bind(p), l && l.suspense) : p.run(),
    b && b.push(T),
    T
}
function N0(e, t, n) {
...
function lf(e, t) {
    return e ? fe(e) && fe(t) ? [...new Set([...e, ...t])] : vt(Object.create(null), Sl(e), Sl(t ?? {})) : t
}
function n_(e, t) {
    if (!e)
        return t;
...
function ps(e, t, n) {
    ...
    t.startsWith("--"))
        ...
        const r = B_(e, t);
        Sf.test(n) ? e.setProperty(Qr(r), n.replace(Sf, ""), "important") : e[r] = n
    }
}
...
const IT = {
    nuxt: {
        buildId: "561432b1-65e4-46df-b298-b0787413d284"
    }
}
  , PT = kE(IT);
function MT() {
...
const Ji = ()=>{}
  ...
  , tS = /%20/g;
function cu(e) {
    return encodeURI("" + e).replace(eS, "|").replace(XT, "[").replace(ZT, "]")
}
function nS(e) {
    return cu(e).replace(Wm, "{").replace(Jm, "}").replace(Gm, "^")
}
function Gl(e) {
    return cu(e).replace(qm, "%2B").replace(tS, "+").replace(Ym, "%23").replace(WT, "%26").replace($T, "`").replace(Wm, "{").replace(Jm, "}").replace(Gm, "^")
}
function rS(e) {
...
function oS(e) {
    return e == null ? "" : iS(e).replace(JT, "%2F")
}
function go(e) {
    try {
        return decodeURIComponent("" + e)
...
function Xm(e) {
    e = dS(e);
    const t = ES(e)
      , n = bS(e, t.state, t.location, t.replace);
    function r(o, s=!0) {
        s || n.pauseListeners(),
        history.go(o)
    }
...
function MS(e, t) {
    ...
    function l(c) {
        let f = 0;
        for (; f < n.length && CS(c, n[f]) >= 0 && (c.record.path !== n[f].record.path || !eg(c, n[f])); )
            f++;
        n.splice(f, 0, c),
    ...
    return ()=>new Promise((a,l)=>{
        const u = d=>{
            d === !1 ? l(Ei(4, {
                from: n,
                to: t
            })) : d instanceof Error ? l(d) : SS(d) ? l(Ei(2, {
                from: t,
                to: d
...
function ud(e) {
    const t = kt(uu)
      ...
      , o = ue(()=>i.value > -1 && YS(n.params, r.value.params))
      , s = ue(()=>i.value > -1 && i.value === n.matched.length - 1 && zm(n.params, r.value.params));
    function a(l={}) {
        return KS(l) ? t[W(e.replace) ? "replace" : "push"](W(e.to)).catch(Ji) : Promise.resolve()
    }
    return {
        route: r,
...
function GS(e) {
    ...
    function G() {
        Z || (Z = i.listen((H,te,Q)=>{
            ...
            u = $;
            const Ue = l.value;
            ri && yS(ed(Ue.fullPath, Q.delta), fa()),
    ...
    function ce(H, te, Q, $) {
        ...
        if (!ri || !ye)
            return Promise.resolve();
        const Ue = !Q && vS(ed(H.fullPath, 0)) || ($ || !Q) && history.state && history.state.scroll || null;
        return Jt().then(()=>ye(H, te, Ue)).then(h=>h && gS(h)).catch(h=>x(h, H, te))
    }
    const ve = H=>i.go(H);
    let Ge;
    const Qe = new Set
...
const zS = (e,t)=>t.path.replace(/(:\w+)\([^)]+\)/g, "$1").replace(/(:\w+)[?+*]/g, "$1").replace(/:\w+/g, n=>{
    var r;
  ...
  , zl = (e,t)=>{
    const n = e.route.matched.find(i=>{
      ...
      , r = t ?? (n == null ? void 0 : n.meta.key) ?? (n && zS(e.route, n));
...
const be = null
  ...
  , pd = [{
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/airdrop.nQ3d07Eo.js"), __vite__mapDeps([0, 1, 2, 3]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/boost.CMmSkbhZ.js"), __vite__mapDeps([4, 5, 6, 3]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/earn.CNkxqet2.js"), __vite__mapDeps([7, 1, 6, 3, 8]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/friends.COiKQuCn.js"), __vite__mapDeps([9, 3, 6]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/index.W-s_g2hx.js"), __vite__mapDeps([10, 6, 3, 11, 12, 13, 14, 15, 16, 17, 18, 5]), import.meta.url).then(e=>e.default || e)
}, {
    name: "clicker___en",
    path: "/clicker",
    meta: {},
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/index.Z5fssE4L.js"), __vite__mapDeps([19, 13, 3, 12, 6, 15, 16]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/mine.TzrnkDsK.js"), __vite__mapDeps([20, 11, 12, 6, 13, 5, 3]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/playground.Cy46FWD0.js"), __vite__mapDeps([21, 1, 3, 14, 15, 16, 17]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/bingx.CVGFnSIX.js"), __vite__mapDeps([22, 3, 12, 6]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/exchange.BbYNOonl.js"), __vite__mapDeps([23, 12]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/index.DhC74WeN.js"), __vite__mapDeps([24, 3]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/language.B0nYcxFx.js"), __vite__mapDeps([]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/achievements.CGJoi4aX.js"), __vite__mapDeps([25, 1, 26, 27]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/avatar.CYmkgV1V.js"), __vite__mapDeps([]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/index.DsKfnV9u.js"), __vite__mapDeps([28, 1, 26, 27, 6, 3]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/index.CEocregE.js"), __vite__mapDeps([29, 30, 13, 12]), import.meta.url).then(e=>e.default || e)
}, {
    ...
    component: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/privacy-policy.BYp_Ail6.js"), __vite__mapDeps([31, 30]), import.meta.url).then(e=>e.default || e)
}, {
...
var tk = Object.defineProperty
  ...
  , de = (e,t)=>{
    for (var n in t || (t = {}))
        ik.call(t, n) && vd(e, n, t[n]);
    if (yd)
        for (var n of yd(t))
            ok.call(t, n) && vd(e, n, t[n]);
    return e
}
  , it = (e,t)=>nk(e, rk(t));
const pn = "Notivue__"
...
function hu(e, t) {
    const n = de({}, e);
    for (const r in t)
        t.hasOwnProperty(r) && (gk(t[r]) ? n[r] = hu(e[r], t[r]) : n[r] = t[r]);
    return n
}
function mk(e, t) {
...
const _k = ["timeout", "resumedAt", "remaining", "animationAttrs", "positionStyles"];
function og(e) {
    return Object.fromEntries(Object.entries(e).filter(([t])=>!_k.includes(t)))
}
function sg(e) {
...
function Ak({config: e, items: t, queue: n, animations: r, timeouts: i}) {
    return {
        destroyAll() {
            t.clear()
        },
...
function Dk() {
    const {isTopAlign: e, position: t} = Ck()
      , n = ue(()=>{
        const i = e.value
...
function Fk() {
    ...
    Nk(()=>t.updatePositions({
        isImmediate: !0
    })),
    Vk(e.items.value, ()=>t.updatePositions())
}
function xk() {
...
const Bk = ["data-notivue-align", "aria-label"]
  , Hk = ["data-notivue-id", "aria-setsize", "aria-posinset"]
  , jk = ["aria-label", "tabindex", "data-notivue-container"]
  , Kk = xe({
    __name: "NotivueImpl",
    props: ra({
        class: {},
        ...
        (l,u)=>{
            ...
            Je(gt, null, W0(W(r).entries.value, (f,d)=>{
                ...
                Je("div", _i({
                    ...
                    ref_for: !0,
                    ref: W(i).containers,
                    style: de(de({}, W(o).itemContainer), (k = t.styles) == null ? void 0 : k.itemContainer)
                }), [Er(l.$slots, "default", cn(zt(W(og)(f))))], 16, jk))], 12, Hk)
            }
            ), 128))], 16, Bk)) : Gt("", !0)], 8, ["to", "disabled"])
        }
    }
})
  , jM = xe({
  ...
  , KM = xe({
    ...
    setup(e) {
        ...
        function w() {
            g({
                transition: i.isReducedMotion.value ? "none" : `${qk}ms cubic-bezier(0.76, 0, 0.24, 1)`,
...
const YM = it(de({}, Uo), {
  ...
  , qM = xe({
    ...
    setup(e) {
        ...
        }, null, 10, Sw)) : Gt("", !0), me("p", {
            class: Dt(W(Hn).MESSAGE),
            textContent: en(W(i.item.message))
        }, null, 10, kw)], 10, Tw), !t.hideClose && W(r) && i.item.type !== "promise" ? (pe(),
        Je("button", {
            key: 1,
            class: Dt(W(Hn).CLOSE),
...
const SA = kA("function:translate");
function kA(e) {
...
const Si = e=>Fe(e) && (e.t === 0 || e.type === 0) && ("b"in e || "body"in e);
function BA(e, t={}) {
    let n = !1;
...
function Vd(e, ...t) {
    const {fallbackFormat: n, postTranslation: r, unresolving: i, messageCompiler: o, fallbackLocale: s, messages: a} = e
      ...
      , k = bu(e, u);
    d && jA(u);
    let[g,E,p] = m ? [l, k, a[k] || {}] : bg(e, l, k, s, f, c)
      , y = g
      , T = l;
    if (!m && !(re(y) || Si(y) || nn(y)) && b && (y = _,
    T = y),
    !m && (!(re(y) || Si(y) || nn(y)) || !re(E)))
        return i ? pa : l;
    let w = !1;
    const L = ()=>{
        w = !0
...
function $l(...e) {
    const [t,n,r] = e
      , i = {};
    if (!re(t) && !St(t) && !nn(t) && !Si(t))
        throw Yn(Pn.INVALID_ARGUMENT);
    const o = St(t) ? String(t) : (nn(t),
    t);
    return St(n) ? i.plural = n : re(n) ? i.default = n : He(n) && !da(n) ? i.named = n : ut(n) && (i.list = n),
    St(r) ? i.plural = r : re(r) ? i.default = r : He(r) && dt(i, r),
    [o, i]
}
...
const nc = kr("__translateVNode")
  , rc = kr("__datetimeParts")
  , ic = kr("__numberParts")
  , JA = kr("__setPluralRules")
  , zA = kr("__injectWithOption")
  , oc = kr("__dispose");
function bo(e) {
    if (!Fe(e))
        return e;
...
function Cg(e={}, t) {
    ...
    const j = (I,U,se,he,We,st)=>{
        ...
        if (se !== "translate exists" && St(bt) && bt === pa || se === "translate exists" && !bt) {
            const [zn,La] = U();
    ...
    function ct(I) {
        return I.map(U=>re(U) || St(U) || at(U) ? Hd(String(U)) : U)
    }
    const H = {
        normalize: ct,
        interpolate: I=>I,
...
function dn(e, t, n) {
    ...
    function s(a, l) {
        ...
        a && Bo(a),
        a = Ig,
        a._s.has(r) || (o ? Dg(r, t, i, a) : kL(r, i, a)),
        a._s.get(r)
    }
    return s.$id = r,
    s
...
const zr = ["de", "en", "es", "fr", "hi", "id", "pt", "ru", "th", "tl", "tr", "uz", "vi"]
  , uc = {
    de: [{
        key: "../locales/de.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/de.BZjVjVee.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    en: [{
        key: "../locales/en.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/en.JLtQ8Pf-.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    es: [{
        key: "../locales/es.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/es.DLxMzbp0.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    fr: [{
        key: "../locales/fr.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/fr.CQqUr-iQ.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    hi: [{
        key: "../locales/hi.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/hi.IPpKwaCN.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    id: [{
        key: "../locales/id.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/id.g-YWbepl.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    pt: [{
        key: "../locales/pt.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/pt.ChkTAl0E.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    ru: [{
        key: "../locales/ru.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/ru.DwoVjlkb.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    th: [{
        key: "../locales/th.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/th.BzX-17qZ.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    tl: [{
        key: "../locales/tl.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/tl.Delhj4Xu.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    tr: [{
        key: "../locales/tr.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/tr.CK0S7LOu.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    uz: [{
        key: "../locales/uz.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/uz.u7ZEHs7t.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }],
    vi: [{
        key: "../locales/vi.json",
        load: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/vi.gV36J30A.js"), __vite__mapDeps([]), import.meta.url),
        cache: !0
    }]
}
  , GL = [()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/i18n.config.Da3zEwKd.js"), __vite__mapDeps([]), import.meta.url)]
  , yt = {
    experimental: {
        localeDetector: ""
    },
...
function Bg(e, {addDirAttribute: t=!1, addSeoAttributes: n=!0, identifierAttribute: r="hid"}) {
    ...
    s.meta.push(...TC(e, r, n), ...SC(u, c, r), ...kC(W(l), c, r))),
    s
}
function wu() {
    const e = ki(ne().$i18n);
...
function oh(e, t, n, r, i) {
    const {strategy: o, defaultLocale: s, differentDomains: a, detectBrowserLanguage: l} = yt
      ...
      , {locale: _, stat: b, reason: k, from: g} = l ? qg(e, n, i, u) : Yg;
    if (k === "detect_ignore_on_ssg")
        return u;
    if ((g === "navigator_or_header" || g === "cookie" || g === "fallback") && _)
        return _;
    let E = _;
    return E || (a ? E = BC(Su) : o !== "no_prefix" ? E = t(e) : l || (E = u)),
...
function Kg() {
    let e;
    return navigator.languages && (e = aC(Su, navigator.languages)),
    e
}
function VC() {
...
const Wt = dn("ui", {
    ...
    actions: {
        ...
        isGeoRU() {
            return ["RU"].indexOf(mt().location.country_code ?? "") > -1
        },
        isYP() {
...
const l1 = Ft({
    ...
    async setup(e) {
        ...
        const i = ((b = Yt.history) == null ? void 0 : b.call(Yt, r)) ?? (Yt.hashMode ? TS(r) : Xm(r))
        ...
        setup(r, {slots: i}) {
            ...
            return ()=>{
                ...
                const _ = typeof a.value == "object" ? ((g = o.resolve(a.value)) == null ? void 0 : g.href) ?? null : a.value && !r.external && !l.value ? n(Ii(s.app.baseURL, a.value), o.resolve) : a.value || null
                  , b = r.target || null
                  , k = h1(r.noRel ? "" : r.rel, e.externalRelAttribute, l.value || u.value ? "noopener noreferrer" : "") || null;
                if (r.custom) {
                    if (!i.default)
                        return null;
                    const p = ()=>xo(_, {
...
const g1 = Ft(e=>{
  ...
  , hr = {
    default: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/default.m-3W9CPr.js"), __vite__mapDeps([32, 12, 3, 8, 18, 1, 27, 2, 6]), import.meta.url).then(e=>e.default || e),
    main: ()=>S(()=>import("https://hamsterkombatgame.io/_nuxt/main.D4ATooDb.js"), __vite__mapDeps([]), import.meta.url).then(e=>e.default || e)
}
  , v1 = Ft({
    name: "nuxt:prefetch",
    setup(e) {
...
function yy(e) {
    return So(_r(e)).left + Ta(e).scrollLeft
}
function ko(e) {
    if (Tr(e) === "html")
        return e;
...
Et("div", yO)));
ka.render = vO;
ka.__scopeId = "data-v-b329ee4c";
ka.__file = "src/components/ResizeObserver.vue";
const ky = (e="theme")=>({
    computed: {
        themeClass() {
            return cO(this[e])
        ...
        GO(d, {
            ...
            hooks: {
                onExtendComposer(p) {
                    ...
                    p.localeProperties = ue(()=>Su.find(y=>y.code === p.locale.value) || {
                        code: p.locale.value
                    }),
                    p.setLocale = async y=>{
                        const T = _(y)
...
const Go = {
  ...
  , Vu = (e,t)=>n=>!!(qo(n) && SR.test(n) && n.startsWith(e) || t && Object.prototype.hasOwnProperty.call(n, t))
  , qy = (e,t,n)=>r=>{
    if (!qo(r))
        return r;
...
function uv(e) {
    ...
    const C = aI(b);
    !((n = (t = C).needsInterpolation) === null || n === void 0) && n.call(t, r, k) && (L = nv([0, 100], [r, k], {
        clamp: !1
    }),
    r = 0,
    k = 100);
...
function nP(e, t) {
    ...
    return ju(e, s=>{
        ...
        for (const a of Object.keys(yv))
            s.style[a] === null || s.style[a] === "" || Ku(a) || Sv(a) || (i[a] = s.style[a]);
        ...
        ()=>ft(tg, {
            ...
            default: c=>{
                ...
                const _ = !!(e.transition ?? c.route.meta.pageTransition ?? ql)
                  ...
                  , k = e.keepalive ?? c.route.meta.keepalive ?? NT;
                return l = ng(Do, _ && b, QS(k, ft(Wc, {
                    suspensible: !0,
  ...
  , NM = xe({
    ...
    setup(e) {
        ...
        (a,l)=>{
            ...
            }, null, 8, bM)])]), me("div", EM, [me("div", TM, [$e(c)]), me("p", null, en(W($t).GAME_NAME), 1)]), me("div", SM, [me("button", kM, [me("p", {
...
export {JM as $, NL as A, Ot as B, VM as C, FM as D, xL as E, gt as F, W0 as G, UM as H, wL as I, fM as J, UL as K, AL as L, Gg as M, Lt as N, xo as O, IL as P, GM as Q, nM as R, cc as S, HC as T, Ho as U, dM as V, hM as W, $t as X, LL as Y, WM as Z, aM as _, Je as a, PL as a0, dn as a1, Ye as a2, Eo as a3, mt as a4, $p as a5, Ng as a6, zM as a7, QM as a8, Mn as a9, lc as aA, Jn as aB, xM as aC, OT as aD, Dm as aE, Ri as aF, et as aG, nD as aH, Do as aI, _l as aJ, _i as aK, wv as aL, aa as aM, YM as aN, jL as aO, zP as aP, jM as aQ, $M as aR, qM as aS, KM as aT, XM as aU, un as aa, ch as ab, BM as ac, lt as ad, HM as ae, nl as af, tl as ag, ML as ah, DL as ai, S as aj, RL as ak, X0 as al, OL as am, CL as an, VL as ao, Gr as ap, wt as aq, Kr as ar, Qc as as, je as at, Jt as au, ft as av, K0 as aw, FL as ax, ZM as ay, Er as az, me as b, ue as c, xe as d, Et as e, W as f, $e as g, Ne as h, _t as i, Mi as j, tD as k, $g as l, Ct as m, Dt as n, pe as o, yn as p, ne as q, le as r, Wt as s, Vt as t, ma as u, Sn as v, en as w, ht as x, Gt as y, eD as z};
function __vite__mapDeps(indexes) {
    if (!__vite__mapDeps.viteFileDeps) {
        __vite__mapDeps.viteFileDeps = ["https://hamsterkombatgame.io/_nuxt/airdrop.nQ3d07Eo.js", "https://hamsterkombatgame.io/_nuxt/Image.vue.B3ol-6Ux.js", "https://hamsterkombatgame.io/_nuxt/airdrop.BJHtW8vm.js", "https://hamsterkombatgame.io/_nuxt/Preloader.vue.DUIBSyAz.js", "https://hamsterkombatgame.io/_nuxt/boost.CMmSkbhZ.js", "https://hamsterkombatgame.io/_nuxt/BalanceLarge.vue.BkLDL29w.js", "https://hamsterkombatgame.io/_nuxt/Price.vue.CYIsA3jE.js", "https://hamsterkombatgame.io/_nuxt/earn.CNkxqet2.js", "https://hamsterkombatgame.io/_nuxt/attraction.BCk690Wv.js", "https://hamsterkombatgame.io/_nuxt/friends.COiKQuCn.js", "https://hamsterkombatgame.io/_nuxt/index.W-s_g2hx.js", "https://hamsterkombatgame.io/_nuxt/Earn.vue.DxKbjbZJ.js", "https://hamsterkombatgame.io/_nuxt/image.vue.B6hInDfv.js", "https://hamsterkombatgame.io/_nuxt/Hamster.vue.afipZXXD.js", "https://hamsterkombatgame.io/_nuxt/navigation.CNdX5YNp.js", "https://hamsterkombatgame.io/_nuxt/effect-fade.Ds6N6kB3.js", "https://hamsterkombatgame.io/_nuxt/effect-fade.vkSr05gD.css", "https://hamsterkombatgame.io/_nuxt/navigation.Bw5XmvsK.css", "https://hamsterkombatgame.io/_nuxt/MiniGameLose.vue.pa1L-5yp.js", "https://hamsterkombatgame.io/_nuxt/index.Z5fssE4L.js", "https://hamsterkombatgame.io/_nuxt/mine.TzrnkDsK.js", "https://hamsterkombatgame.io/_nuxt/playground.Cy46FWD0.js", "https://hamsterkombatgame.io/_nuxt/bingx.CVGFnSIX.js", "https://hamsterkombatgame.io/_nuxt/exchange.BbYNOonl.js", "https://hamsterkombatgame.io/_nuxt/index.DhC74WeN.js", "https://hamsterkombatgame.io/_nuxt/achievements.CGJoi4aX.js", "https://hamsterkombatgame.io/_nuxt/AchievementStat.vue.CDgNYHVS.js", "https://hamsterkombatgame.io/_nuxt/Circles.vue.CIJ8ZfSR.js", "https://hamsterkombatgame.io/_nuxt/index.DsKfnV9u.js", "https://hamsterkombatgame.io/_nuxt/index.CEocregE.js", "https://hamsterkombatgame.io/_nuxt/LandingHeader.vue.Bjj3dBNT.js", "https://hamsterkombatgame.io/_nuxt/privacy-policy.BYp_Ail6.js", "https://hamsterkombatgame.io/_nuxt/default.m-3W9CPr.js"]
    }
