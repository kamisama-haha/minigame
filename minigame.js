...
const On = Nn("ui", {
  ...
  , $a = Nn({
    ...
    actions: {
        ...
        startGame() {
            var e, t;
            const levelConfig_fake = "a - - c d d.a b - c e -.a b 0 0 e f.s s s - e f.- - x - g g.- - x - h h";
            if (this.dailyKeysMiniGame != null) {
                const r = document.getElementById(this.$id).contentWindow;
                const i = new Date((e = this.dailyKeysMiniGame) == null ? void 0 : e.startDate).getTime() / 1e3;
                const o = levelConfig_fake; 
