        ...
        return await O.post("/clicker/get-promos", {}).then((l) => {
          try {
            if (l) {
              ...
              this.setPromos(e), this.setStates(C);
            }
          } catch (e) {
            console.log(e);
          }
...
function V(l) {
  ...
  function B(a, t) {
    ...
    a &&
      ...
      a && (a.classList.add(`${s}-${t}`), (a = a[`${t === "prev" ? "previous" : "next"}ElementSibling`]), a && a.classList.add(`${s}-${t}-${t}`)));
  }
  function z(a) {
  ...
  function v() {
    ...
    if (
      (e.params.loop
        ? ((f = e.previousRealIndex || 0), (i = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex))
        : typeof e.snapIndex < "u"
        ? ((i = e.snapIndex), (f = e.previousSnapIndex))
        : ((f = e.previousIndex || 0), (i = e.activeIndex || 0)),
      ...
      if (
        (t.dynamicBullets &&
          ((b = K(n[0], e.isHorizontal() ? "width" : "height", !0)),
          s.forEach((r) => {
            r.style[e.isHorizontal() ? "width" : "height"] = `${b * (t.dynamicMainBullets + 4)}px`;
          }),
          t.dynamicMainBullets > 1 &&
            f !== void 0 &&
            ((h += i - (f || 0)), h > t.dynamicMainBullets - 1 ? (h = t.dynamicMainBullets - 1) : h < 0 && (h = 0)),
          (g = Math.max(i - h, 0)),
          (m = g + (Math.min(n.length, t.dynamicMainBullets) - 1)),
          (k = (m + g) / 2)),
        n.forEach((r) => {
          const c = [...["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((p) => `${t.bulletActiveClass}${p}`)]
            .map((p) => (typeof p == "string" && p.includes(" ") ? p.split(" ") : p))
            .flat();
        ...
        n.forEach((r) => {
          ...
          c === i ? r.classList.add(...t.bulletActiveClass.split(" ")) : e.isElement && r.setAttribute("part", "bullet"),
            t.dynamicBullets &&
              (c >= g && c <= m && r.classList.add(...`${t.bulletActiveClass}-main`.split(" ")), c === g && B(r, "prev"), c === m && B(r, "next"));
        });
      else {
        const r = n[i];
        if (
          (r && r.classList.add(...t.bulletActiveClass.split(" ")),
          e.isElement &&
            n.forEach((c, p) => {
          ...
          const c = n[g],
            p = n[m];
          for (let x = g; x <= m; x += 1) n[x] && n[x].classList.add(...`${t.bulletActiveClass}-main`.split(" "));
          B(c, "prev"), B(p, "next");
        }
      }
      if (t.dynamicBullets) {
    ...
    s.forEach((n, g) => {
      if (
        (t.type === "fraction" &&
          (n.querySelectorAll(S(t.currentClass)).forEach((m) => {
        ...
        m === "horizontal" ? (r = k) : (c = k),
          n.querySelectorAll(S(t.progressbarFillClass)).forEach((p) => {
            (p.style.transform = `translate3d(0,0,0) scaleX(${r}) scaleY(${c})`), (p.style.transitionDuration = `${e.params.speed}ms`);
          });
      }
      t.type === "custom" && t.renderCustom
        ? ((n.innerHTML = t.renderCustom(e, i + 1, P)), g === 0 && u("paginationRender", n))
        : (g === 0 && u("paginationRender", n), u("paginationUpdate", n)),
  ...
  function A() {
    ...
    a.type === "fraction" &&
      (a.renderFraction ? (i = a.renderFraction.call(e, a.currentClass, a.totalClass)) : (i = `<span class="${a.currentClass}"></span> / <span class="${a.totalClass}"></span>`)),
      ...
      s.forEach((f) => {
        a.type !== "custom" && (f.innerHTML = i || ""), a.type === "bullets" && e.pagination.bullets.push(...f.querySelectorAll(S(a.bulletClass)));
      }),
    ...
    typeof a.el == "string" && e.isElement && (t = e.el.querySelector(a.el)),
      ...
      !(!t || t.length === 0) &&
        (e.params.uniqueNavElements &&
          ...
          Array.isArray(t) &&
          t.length > 1 &&
          ((t = [...e.el.querySelectorAll(a.el)]), t.length > 1 && (t = t.filter((s) => N(s, ".swiper")[0] === e.el)[0])),
        ...
        t.forEach((s) => {
          a.type === "bullets" && a.clickable && s.classList.add(...(a.clickableClass || "").split(" ")),
            ...
            a.type === "bullets" &&
              a.dynamicBullets &&
              (s.classList.add(`${a.modifierClass}${a.type}-dynamic`), (h = 0), a.dynamicMainBullets < 1 && (a.dynamicMainBullets = 1)),
    ...
    t &&
      ...
      t.forEach((s) => {
        s.classList.remove(a.hiddenClass),
          ...
          a.clickable && (s.classList.remove(...(a.clickableClass || "").split(" ")), s.removeEventListener("click", z));
      })),
  ...
  d("changeDirection", () => {
    ...
    d("init", () => {
      e.params.pagination.enabled === !1 ? T() : (I(), A(), v());
    }),
    d("activeIndexChange", () => {
    ...
    d("enable disable", () => {
      ...
      a && ((a = y(a)), a.forEach((t) => t.classList[e.enabled ? "remove" : "add"](e.params.pagination.lockClass)));
    }),
    d("lock unlock", () => {
      v();
    }),
    d("click", (a, t) => {
      ...
      if (e.params.pagination.el && e.params.pagination.hideOnClick && i && i.length > 0 && !s.classList.contains(e.params.pagination.bulletClass)) {
        ...
        u(f === !0 ? "paginationShow" : "paginationHide"), i.forEach(($) => $.classList.toggle(e.params.pagination.hiddenClass));
      }
    });
  const w = () => {
      e.el.classList.remove(e.params.pagination.paginationDisabledClass);
      let { el: a } = e.pagination;
      a && ((a = y(a)), a.forEach((t) => t.classList.remove(e.params.pagination.paginationDisabledClass))), I(), A(), v();
    },
    T = () => {
      e.el.classList.add(e.params.pagination.paginationDisabledClass);
      let { el: a } = e.pagination;
      a && ((a = y(a)), a.forEach((t) => t.classList.add(e.params.pagination.paginationDisabledClass))), M();
    };
  Object.assign(e.pagination, {
    enable: w,
    disable: T,
